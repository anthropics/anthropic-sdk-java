...
public final class BetaStructuredOutputsStreamingExample {
    ...
    private BetaStructuredOutputsStreamingExample() {}
    ...
    public static void main(String[] args) {
        ...
        try (var streamResponse = client.beta().messages().createStreaming(createParams)) {
