...
class McpEmitter : ProtocolEmitter {
    ...
    private fun buildMcpServer(pkg: String, name: String, spec: ParsedSpec): String = buildString {
        ...
        appendLine()
        appendLine("import io.modelcontextprotocol.kotlin.sdk.Implementation")
        appendLine("import io.modelcontextprotocol.kotlin.sdk.ServerCapabilities")
        appendLine("import io.modelcontextprotocol.kotlin.sdk.Tool")
        appendLine("import io.modelcontextprotocol.kotlin.sdk.TextContent")
        appendLine("import io.modelcontextprotocol.kotlin.sdk.CallToolResult")
        ...
        spec.paths.values.filter { it.method in setOf("POST", "PUT", "PATCH") }.forEach { op ->
            ...
            appendLine("            inputSchema = Tool.Input(")
            appendLine("                properties = buildJsonObject { },")
            appendLine("                required = emptyList(),")
            appendLine("            ),")
            appendLine("        ) { request ->")
