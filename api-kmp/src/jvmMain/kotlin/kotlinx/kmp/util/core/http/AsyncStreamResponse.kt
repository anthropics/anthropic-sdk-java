...
import kotlinx.kmp.util.core.http.AsyncStreamResponse.Handler
...
fun <T> StreamResponse<T>.toAsync(streamHandlerExecutor: Executor) =
    CompletableFuture.completedFuture(this).toAsync(streamHandlerExecutor)

fun <T> CompletableFuture<StreamResponse<T>>.toAsync(streamHandlerExecutor: Executor) =
