...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(serverToolCaller: ServerToolCaller) = apply {
            toolId = serverToolCaller.toolId
            type = serverToolCaller.type
            additionalProperties = serverToolCaller.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): ServerToolCaller = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ServerToolCaller &&
            toolId == other.toolId &&
            type == other.type &&
    ...
    override fun toString() =
        "ServerToolCaller{toolId=$toolId, type=$type, additionalProperties=$additionalProperties}"
}
