...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(webFetchToolResultBlock: WebFetchToolResultBlock) = apply {
    ...
    private constructor(
        ...
        override fun hashCode(): Int = contentHash(webFetchToolResultErrorBlock, webFetchBlock)
        ...
        companion object {
            ...
            @JvmStatic fun ofWebFetchToolResultErrorBlock(
                webFetchToolResultErrorBlock: WebFetchToolResultErrorBlock
            ) = Content(webFetchToolResultErrorBlock = webFetchToolResultErrorBlock)

            @JvmStatic fun ofWebFetchBlock(webFetchBlock: WebFetchBlock) =
