...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(
            ...
            oldStart = textEditorCodeExecutionStrReplaceResultBlockParam.oldStart
            additionalProperties =
                textEditorCodeExecutionStrReplaceResultBlockParam.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): TextEditorCodeExecutionStrReplaceResultBlockParam =
            TextEditorCodeExecutionStrReplaceResultBlockParam(
                type,
    ...
    fun validate(): TextEditorCodeExecutionStrReplaceResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TextEditorCodeExecutionStrReplaceResultBlockParam &&
            type == other.type &&
            lines == other.lines &&
    ...
    override fun toString() =
        "TextEditorCodeExecutionStrReplaceResultBlockParam{type=$type, lines=$lines, newLines=$newLines, newStart=$newStart, oldLines=$oldLines, oldStart=$oldStart, additionalProperties=$additionalProperties}"
}
