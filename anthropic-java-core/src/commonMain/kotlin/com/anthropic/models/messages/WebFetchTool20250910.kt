...
private constructor(
    ...
    /** A builder for [WebFetchTool20250910]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(webFetchTool20250910: WebFetchTool20250910) = apply {
            name = webFetchTool20250910.name
            type = webFetchTool20250910.type
            allowedCallers = webFetchTool20250910.allowedCallers.map { it.toMutableList() }
            allowedDomains = webFetchTool20250910.allowedDomains.map { it.toMutableList() }
            blockedDomains = webFetchTool20250910.blockedDomains.map { it.toMutableList() }
            cacheControl = webFetchTool20250910.cacheControl
            citations = webFetchTool20250910.citations
            deferLoading = webFetchTool20250910.deferLoading
            maxContentTokens = webFetchTool20250910.maxContentTokens
            maxUses = webFetchTool20250910.maxUses
            strict = webFetchTool20250910.strict
            additionalProperties = webFetchTool20250910.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): WebFetchTool20250910 =
    ...
    fun validate(): WebFetchTool20250910 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebFetchTool20250910 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "WebFetchTool20250910{name=$name, type=$type, allowedCallers=$allowedCallers, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, cacheControl=$cacheControl, citations=$citations, deferLoading=$deferLoading, maxContentTokens=$maxContentTokens, maxUses=$maxUses, strict=$strict, additionalProperties=$additionalProperties}"
}
