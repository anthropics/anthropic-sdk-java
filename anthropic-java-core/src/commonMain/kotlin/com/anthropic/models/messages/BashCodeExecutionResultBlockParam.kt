...
private constructor(
    private val content: JsonField<List<BashCodeExecutionOutputBlockParam>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        content: JsonField<List<BashCodeExecutionOutputBlockParam>> = JsonMissing.of(),
    ...
    @JsonProperty("content")
    @ExcludeMissing
    fun _content(): JsonField<List<BashCodeExecutionOutputBlockParam>> = content
    ...
    class Builder internal constructor() {
        ...
        private var content: JsonField<MutableList<BashCodeExecutionOutputBlockParam>>? = null
        ...
        @JvmSynthetic internal fun from(bashCodeExecutionResultBlockParam: BashCodeExecutionResultBlockParam) =
            apply {
                content = bashCodeExecutionResultBlockParam.content.map { it.toMutableList() }
                returnCode = bashCodeExecutionResultBlockParam.returnCode
                stderr = bashCodeExecutionResultBlockParam.stderr
                stdout = bashCodeExecutionResultBlockParam.stdout
                type = bashCodeExecutionResultBlockParam.type
                additionalProperties =
                    bashCodeExecutionResultBlockParam.additionalProperties.toMutableMap()
            }

        fun content(content: List<BashCodeExecutionOutputBlockParam>) =
         ...
         * `List<BashCodeExecutionOutputBlockParam>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun content(content: JsonField<List<BashCodeExecutionOutputBlockParam>>) = apply {
            this.content = content.map { it.toMutableList() }
        }

        /**
         * Adds a single [BashCodeExecutionOutputBlockParam] to [Builder.content].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addContent(content: BashCodeExecutionOutputBlockParam) = apply {
            this.content =
        ...
        fun addContent(content: BashCodeExecutionOutputBlock) = addContent(content.toParam())
         ...
         */
        fun build(): BashCodeExecutionResultBlockParam =
            BashCodeExecutionResultBlockParam(
    ...
    fun validate(): BashCodeExecutionResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BashCodeExecutionResultBlockParam &&
    ...
    override fun toString() =
        "BashCodeExecutionResultBlockParam{content=$content, returnCode=$returnCode, stderr=$stderr, stdout=$stdout, type=$type, additionalProperties=$additionalProperties}"
}
