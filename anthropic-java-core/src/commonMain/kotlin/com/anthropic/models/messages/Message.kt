...
private constructor(
     ...
     */
    @JsonProperty("container") @ExcludeMissing fun _container(): JsonField<Container> = container
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(message: Message) = apply {
            id = message.id
         ...
         */
        fun addContent(webFetchToolResult: WebFetchToolResultBlock) =
            addContent(ContentBlock.ofWebFetchToolResult(webFetchToolResult))

        /**
         * Alias for calling [addContent] with
         * `ContentBlock.ofCodeExecutionToolResult(codeExecutionToolResult)`.
         */
        fun addContent(codeExecutionToolResult: CodeExecutionToolResultBlock) =
            addContent(ContentBlock.ofCodeExecutionToolResult(codeExecutionToolResult))

        /**
         * Alias for calling [addContent] with
         * `ContentBlock.ofBashCodeExecutionToolResult(bashCodeExecutionToolResult)`.
         */
        fun addContent(bashCodeExecutionToolResult: BashCodeExecutionToolResultBlock) =
            addContent(ContentBlock.ofBashCodeExecutionToolResult(bashCodeExecutionToolResult))
         ...
         */
        fun addContent(toolSearchToolResult: ToolSearchToolResultBlock) =
            addContent(ContentBlock.ofToolSearchToolResult(toolSearchToolResult))

        /**
         * Alias for calling [addContent] with `ContentBlock.ofContainerUpload(containerUpload)`.
         */
        fun addContent(containerUpload: ContainerUploadBlock) =
            addContent(ContentBlock.ofContainerUpload(containerUpload))
