...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(toolTextEditor20250728: ToolTextEditor20250728) = apply {
            name = toolTextEditor20250728.name
            type = toolTextEditor20250728.type
            allowedCallers = toolTextEditor20250728.allowedCallers.map { it.toMutableList() }
            cacheControl = toolTextEditor20250728.cacheControl
            deferLoading = toolTextEditor20250728.deferLoading
            inputExamples = toolTextEditor20250728.inputExamples.map { it.toMutableList() }
            maxCharacters = toolTextEditor20250728.maxCharacters
            strict = toolTextEditor20250728.strict
    ...
    internal fun validity(): Int =
        name.let { if (it == JsonValue.from("str_replace_based_edit_tool")) 1 else 0 } +
            ...
            (if (maxCharacters.asKnown() != null) 1 else 0) +
    ...
    override fun toString() =
        "ToolTextEditor20250728{name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, inputExamples=$inputExamples, maxCharacters=$maxCharacters, strict=$strict, additionalProperties=$additionalProperties}"
}
