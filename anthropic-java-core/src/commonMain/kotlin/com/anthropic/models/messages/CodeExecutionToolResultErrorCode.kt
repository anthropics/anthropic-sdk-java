...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        fun of(value: String) = CodeExecutionToolResultErrorCode(JsonField.of(value))
    }

    /** An enum containing [CodeExecutionToolResultErrorCode]'s known values. */
    enum class Known {
        INVALID_TOOL_INPUT,
        UNAVAILABLE,
        TOO_MANY_REQUESTS,
    ...
    /**
     * An enum containing [CodeExecutionToolResultErrorCode]'s known values, as well as an
     * [_UNKNOWN] member.
     *
     * An instance of [CodeExecutionToolResultErrorCode] can contain an unknown value in a couple of
     * cases:
    ...
    enum class Value {
        ...
        EXECUTION_TIME_EXCEEDED,
        /**
         * An enum member indicating that [CodeExecutionToolResultErrorCode] was instantiated with
         * an unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun validate(): CodeExecutionToolResultErrorCode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CodeExecutionToolResultErrorCode && value == other.value
    }
