...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(webSearchToolResultBlockParam: WebSearchToolResultBlockParam) = apply {
            ...
            caller = webSearchToolResultBlockParam.caller
    ...
    override fun toString() =
        "WebSearchToolResultBlockParam{content=$content, toolUseId=$toolUseId, type=$type, cacheControl=$cacheControl, caller=$caller, additionalProperties=$additionalProperties}"
}
