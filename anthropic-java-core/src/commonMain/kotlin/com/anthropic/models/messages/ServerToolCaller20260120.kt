...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(serverToolCaller20260120: ServerToolCaller20260120) = apply {
            toolId = serverToolCaller20260120.toolId
            type = serverToolCaller20260120.type
            additionalProperties = serverToolCaller20260120.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ServerToolCaller20260120 =
    ...
    fun validate(): ServerToolCaller20260120 = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (toolId.asKnown() != null) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ServerToolCaller20260120 &&
            toolId == other.toolId &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { contentHash(toolId, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ServerToolCaller20260120{toolId=$toolId, type=$type, additionalProperties=$additionalProperties}"
}
