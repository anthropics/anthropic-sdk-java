...
private constructor(
    ...
    /** A builder for [CodeExecutionTool20250825]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(codeExecutionTool20250825: CodeExecutionTool20250825) = apply {
            name = codeExecutionTool20250825.name
            type = codeExecutionTool20250825.type
            allowedCallers = codeExecutionTool20250825.allowedCallers.map { it.toMutableList() }
            cacheControl = codeExecutionTool20250825.cacheControl
            deferLoading = codeExecutionTool20250825.deferLoading
            strict = codeExecutionTool20250825.strict
            additionalProperties = codeExecutionTool20250825.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): CodeExecutionTool20250825 =
    ...
    fun validate(): CodeExecutionTool20250825 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CodeExecutionTool20250825 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "CodeExecutionTool20250825{name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, strict=$strict, additionalProperties=$additionalProperties}"
}
