...
private constructor(
    ...
    fun toParam(): CodeExecutionResultBlockParam =
    ...
    /** A builder for [CodeExecutionResultBlock]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(codeExecutionResultBlock: CodeExecutionResultBlock) = apply {
            content = codeExecutionResultBlock.content.map { it.toMutableList() }
            returnCode = codeExecutionResultBlock.returnCode
            stderr = codeExecutionResultBlock.stderr
            stdout = codeExecutionResultBlock.stdout
            type = codeExecutionResultBlock.type
            additionalProperties = codeExecutionResultBlock.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): CodeExecutionResultBlock =
    ...
    fun validate(): CodeExecutionResultBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CodeExecutionResultBlock &&
    ...
    override fun toString() =
        "CodeExecutionResultBlock{content=$content, returnCode=$returnCode, stderr=$stderr, stdout=$stdout, type=$type, additionalProperties=$additionalProperties}"
}
