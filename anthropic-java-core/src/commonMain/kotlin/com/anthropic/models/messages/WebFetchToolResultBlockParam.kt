...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(webFetchToolResultBlockParam: WebFetchToolResultBlockParam) = apply {
    ...
    private constructor(
        ...
        override fun hashCode(): Int =
            contentHash(webFetchToolResultErrorBlockParam, webFetchBlockParam)
        ...
        companion object {
            ...
            @JvmStatic fun ofWebFetchToolResultErrorBlockParam(
                webFetchToolResultErrorBlockParam: WebFetchToolResultErrorBlockParam
            ) = Content(webFetchToolResultErrorBlockParam = webFetchToolResultErrorBlockParam)

            @JvmStatic fun ofWebFetchBlockParam(webFetchBlockParam: WebFetchBlockParam) =
