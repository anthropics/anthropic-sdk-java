...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(toolTextEditor20250429: ToolTextEditor20250429) = apply {
            name = toolTextEditor20250429.name
            type = toolTextEditor20250429.type
            allowedCallers = toolTextEditor20250429.allowedCallers.map { it.toMutableList() }
            cacheControl = toolTextEditor20250429.cacheControl
            deferLoading = toolTextEditor20250429.deferLoading
            inputExamples = toolTextEditor20250429.inputExamples.map { it.toMutableList() }
    ...
    override fun toString() =
        "ToolTextEditor20250429{name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, inputExamples=$inputExamples, strict=$strict, additionalProperties=$additionalProperties}"
}
