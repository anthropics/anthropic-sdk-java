...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(
            ...
            fileType = textEditorCodeExecutionViewResultBlockParam.fileType
            type = textEditorCodeExecutionViewResultBlockParam.type
            numLines = textEditorCodeExecutionViewResultBlockParam.numLines
            startLine = textEditorCodeExecutionViewResultBlockParam.startLine
            totalLines = textEditorCodeExecutionViewResultBlockParam.totalLines
            additionalProperties =
                textEditorCodeExecutionViewResultBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): TextEditorCodeExecutionViewResultBlockParam =
            TextEditorCodeExecutionViewResultBlockParam(
    ...
    fun validate(): TextEditorCodeExecutionViewResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TextEditorCodeExecutionViewResultBlockParam &&
    ...
    override fun toString() =
        "TextEditorCodeExecutionViewResultBlockParam{content=$content, fileType=$fileType, type=$type, numLines=$numLines, startLine=$startLine, totalLines=$totalLines, additionalProperties=$additionalProperties}"
}
