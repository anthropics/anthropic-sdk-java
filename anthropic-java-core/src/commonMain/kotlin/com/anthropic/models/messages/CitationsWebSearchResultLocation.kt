...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(citationsWebSearchResultLocation: CitationsWebSearchResultLocation) =
            apply {
    ...
    internal fun validity(): Int =
        (if (citedText.asKnown() != null) 1 else 0) +
            (if (encryptedIndex.asKnown() != null) 1 else 0) +
    ...
    private val hashCode: Int by lazy {
        contentHash(citedText, encryptedIndex, title, type, url, additionalProperties)
    }
