...
private constructor(
        ...
        WebSearchToolResultBlockParam.builder()
            ...
            .caller(
                _caller().map {
                    it.accept(
                        object :
                            WebSearchToolResultBlock.Caller.Visitor<
                                WebSearchToolResultBlockParam.Caller
                            > {
                            override fun visitDirect(
                                direct: DirectCaller
                            ): WebSearchToolResultBlockParam.Caller =
                                WebSearchToolResultBlockParam.Caller.ofDirect(direct)
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(webSearchToolResultBlock: WebSearchToolResultBlock) = apply {
            caller = webSearchToolResultBlock.caller
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Tool invocation generated by a server-side tool. */
            @JvmStatic fun ofCodeExecution20250825(codeExecution20250825: ServerToolCaller) =
                Caller(codeExecution20250825 = codeExecution20250825)

            @JvmStatic fun ofCodeExecution20260120(codeExecution20260120: ServerToolCaller20260120) =
                Caller(codeExecution20260120 = codeExecution20260120)
        }
    ...
    private val hashCode: Int by lazy {
        contentHash(caller, content, toolUseId, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "WebSearchToolResultBlock{caller=$caller, content=$content, toolUseId=$toolUseId, type=$type, additionalProperties=$additionalProperties}"
}
