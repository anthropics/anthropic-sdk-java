...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(serverToolUseBlockParam: ServerToolUseBlockParam) = apply {
            ...
            caller = serverToolUseBlockParam.caller
    ...
    override fun toString() =
        "ServerToolUseBlockParam{id=$id, input=$input, name=$name, type=$type, cacheControl=$cacheControl, caller=$caller, additionalProperties=$additionalProperties}"
}
