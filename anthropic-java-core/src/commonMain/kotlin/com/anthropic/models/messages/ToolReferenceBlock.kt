...
private constructor(
    ...
    fun toParam(): ToolReferenceBlockParam =
        ToolReferenceBlockParam.builder().toolName(_toolName()).build()
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(toolReferenceBlock: ToolReferenceBlock) = apply {
            toolName = toolReferenceBlock.toolName
            type = toolReferenceBlock.type
            additionalProperties = toolReferenceBlock.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): ToolReferenceBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolReferenceBlock &&
            toolName == other.toolName &&
            type == other.type &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy { contentHash(toolName, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ToolReferenceBlock{toolName=$toolName, type=$type, additionalProperties=$additionalProperties}"
}
