...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(toolSearchToolBm25_20251119: ToolSearchToolBm25_20251119) = apply {
            ...
            additionalProperties = toolSearchToolBm25_20251119.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ToolSearchToolBm25_20251119 =
    ...
    fun validate(): ToolSearchToolBm25_20251119 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolSearchToolBm25_20251119 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "ToolSearchToolBm25_20251119{name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, strict=$strict, additionalProperties=$additionalProperties}"
}
