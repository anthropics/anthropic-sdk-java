...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(citationSearchResultLocationParam: CitationSearchResultLocationParam) =
            apply {
    ...
    internal fun validity(): Int =
        (if (citedText.asKnown() != null) 1 else 0) +
            (if (endBlockIndex.asKnown() != null) 1 else 0) +
            (if (searchResultIndex.asKnown() != null) 1 else 0) +
            (if (source.asKnown() != null) 1 else 0) +
            (if (startBlockIndex.asKnown() != null) 1 else 0) +
