...
private constructor(
    ...
    fun toParam(): ToolUseBlockParam =
        ToolUseBlockParam.builder()
            ...
            .caller(
                _caller().map {
                    it.accept(
                        object : ToolUseBlock.Caller.Visitor<ToolUseBlockParam.Caller> {
                            override fun visitDirect(
                                direct: DirectCaller
                            ): ToolUseBlockParam.Caller = ToolUseBlockParam.Caller.ofDirect(direct)
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(toolUseBlock: ToolUseBlock) = apply {
            id = toolUseBlock.id
            caller = toolUseBlock.caller
    ...
    private val hashCode: Int by lazy {
        contentHash(id, caller, input, name, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ToolUseBlock{id=$id, caller=$caller, input=$input, name=$name, type=$type, additionalProperties=$additionalProperties}"
}
