...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(messageBatchErroredResult: MessageBatchErroredResult) = apply {
    ...
    private val hashCode: Int by lazy { contentHash(error, type, additionalProperties) }
