...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaUserLocation: BetaUserLocation) = apply {
            type = betaUserLocation.type
            city = betaUserLocation.city
            country = betaUserLocation.country
            region = betaUserLocation.region
            timezone = betaUserLocation.timezone
            additionalProperties = betaUserLocation.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): BetaUserLocation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaUserLocation &&
            type == other.type &&
            city == other.city &&
    ...
    override fun toString() =
        "BetaUserLocation{type=$type, city=$city, country=$country, region=$region, timezone=$timezone, additionalProperties=$additionalProperties}"
}
