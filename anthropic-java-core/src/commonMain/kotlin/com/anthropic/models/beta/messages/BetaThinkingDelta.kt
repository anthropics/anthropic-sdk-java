...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaThinkingDelta: BetaThinkingDelta) = apply {
    ...
    private val hashCode: Int by lazy { contentHash(thinking, type, additionalProperties) }
