...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaCitationCharLocationParam: BetaCitationCharLocationParam) = apply {
    ...
    internal fun validity(): Int =
        (if (citedText.asKnown() != null) 1 else 0) +
            ...
            (if (endCharIndex.asKnown() != null) 1 else 0) +
            (if (startCharIndex.asKnown() != null) 1 else 0) +
