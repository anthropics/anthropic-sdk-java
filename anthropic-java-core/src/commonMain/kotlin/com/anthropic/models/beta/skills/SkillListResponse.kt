...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(skillListResponse: SkillListResponse) = apply {
            id = skillListResponse.id
            createdAt = skillListResponse.createdAt
            displayTitle = skillListResponse.displayTitle
            latestVersion = skillListResponse.latestVersion
            source = skillListResponse.source
            type = skillListResponse.type
            updatedAt = skillListResponse.updatedAt
            additionalProperties = skillListResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): SkillListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SkillListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SkillListResponse{id=$id, createdAt=$createdAt, displayTitle=$displayTitle, latestVersion=$latestVersion, source=$source, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
