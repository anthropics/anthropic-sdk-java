...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaWebFetchToolResultBlockParam: BetaWebFetchToolResultBlockParam) =
            apply {
                ...
                caller = betaWebFetchToolResultBlockParam.caller
    ...
    private constructor(
        ...
        override fun hashCode(): Int =
            contentHash(betaWebFetchToolResultErrorBlockParam, betaWebFetchBlockParam)
        ...
        companion object {
            ...
            @JvmStatic fun ofBetaWebFetchToolResultErrorBlockParam(
                betaWebFetchToolResultErrorBlockParam: BetaWebFetchToolResultErrorBlockParam
            ) =
                Content(
                    betaWebFetchToolResultErrorBlockParam = betaWebFetchToolResultErrorBlockParam
            ...
            @JvmStatic fun ofBetaWebFetchBlockParam(betaWebFetchBlockParam: BetaWebFetchBlockParam) =
                Content(betaWebFetchBlockParam = betaWebFetchBlockParam)
        }
    ...
    private constructor(
        ...
        companion object {
            ...
            /** Tool invocation generated by a server-side tool. */
            @JvmStatic fun ofCodeExecution20250825(codeExecution20250825: BetaServerToolCaller) =
                Caller(codeExecution20250825 = codeExecution20250825)

            @JvmStatic fun ofCodeExecution20260120(codeExecution20260120: BetaServerToolCaller20260120) =
                Caller(codeExecution20260120 = codeExecution20260120)
        }
    ...
    private val hashCode: Int by lazy {
        contentHash(content, toolUseId, type, cacheControl, caller, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaWebFetchToolResultBlockParam{content=$content, toolUseId=$toolUseId, type=$type, cacheControl=$cacheControl, caller=$caller, additionalProperties=$additionalProperties}"
}
