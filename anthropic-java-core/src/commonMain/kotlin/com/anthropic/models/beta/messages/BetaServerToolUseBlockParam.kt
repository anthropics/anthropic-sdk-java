...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaServerToolUseBlockParam: BetaServerToolUseBlockParam) = apply {
            ...
            caller = betaServerToolUseBlockParam.caller
    ...
    override fun toString() =
        "BetaServerToolUseBlockParam{id=$id, input=$input, name=$name, type=$type, cacheControl=$cacheControl, caller=$caller, additionalProperties=$additionalProperties}"
}
