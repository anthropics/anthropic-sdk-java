...
private constructor(
    ...
    /** A builder for [VersionCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(versionCreateResponse: VersionCreateResponse) = apply {
            id = versionCreateResponse.id
            createdAt = versionCreateResponse.createdAt
            description = versionCreateResponse.description
            directory = versionCreateResponse.directory
            name = versionCreateResponse.name
            skillId = versionCreateResponse.skillId
            type = versionCreateResponse.type
            version = versionCreateResponse.version
            additionalProperties = versionCreateResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): VersionCreateResponse =
    ...
    fun validate(): VersionCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VersionCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "VersionCreateResponse{id=$id, createdAt=$createdAt, description=$description, directory=$directory, name=$name, skillId=$skillId, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
