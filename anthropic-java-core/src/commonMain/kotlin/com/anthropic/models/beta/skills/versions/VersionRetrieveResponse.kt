...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(versionRetrieveResponse: VersionRetrieveResponse) = apply {
            id = versionRetrieveResponse.id
            createdAt = versionRetrieveResponse.createdAt
            description = versionRetrieveResponse.description
            directory = versionRetrieveResponse.directory
            name = versionRetrieveResponse.name
            skillId = versionRetrieveResponse.skillId
            type = versionRetrieveResponse.type
    ...
    override fun toString() =
        "VersionRetrieveResponse{id=$id, createdAt=$createdAt, description=$description, directory=$directory, name=$name, skillId=$skillId, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
