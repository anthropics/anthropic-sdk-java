...
private constructor(
     ...
     */
    internal fun validity(): Int = (if (originalInputTokens.asKnown() != null) 1 else 0)
    ...
    private val hashCode: Int by lazy { contentHash(originalInputTokens, additionalProperties) }
