...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaServerToolUseBlock: BetaServerToolUseBlock) = apply {
    ...
    private val hashCode: Int by lazy {
        contentHash(id, input, name, type, caller, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaServerToolUseBlock{id=$id, input=$input, name=$name, type=$type, caller=$caller, additionalProperties=$additionalProperties}"
}
