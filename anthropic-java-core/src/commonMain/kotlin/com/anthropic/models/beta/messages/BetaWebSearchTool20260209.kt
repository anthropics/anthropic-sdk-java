...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaWebSearchTool20260209: BetaWebSearchTool20260209) = apply {
            ...
            strict = betaWebSearchTool20260209.strict
            userLocation = betaWebSearchTool20260209.userLocation
            additionalProperties = betaWebSearchTool20260209.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebSearchTool20260209 =
    ...
    fun validate(): BetaWebSearchTool20260209 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebSearchTool20260209 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaWebSearchTool20260209{name=$name, type=$type, allowedCallers=$allowedCallers, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, cacheControl=$cacheControl, deferLoading=$deferLoading, maxUses=$maxUses, strict=$strict, userLocation=$userLocation, additionalProperties=$additionalProperties}"
}
