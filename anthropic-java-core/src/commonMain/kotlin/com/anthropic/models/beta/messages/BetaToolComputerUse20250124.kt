...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaToolComputerUse20250124: BetaToolComputerUse20250124) = apply {
            ...
            allowedCallers = betaToolComputerUse20250124.allowedCallers.map { it.toMutableList() }
            cacheControl = betaToolComputerUse20250124.cacheControl
            deferLoading = betaToolComputerUse20250124.deferLoading
            displayNumber = betaToolComputerUse20250124.displayNumber
            inputExamples = betaToolComputerUse20250124.inputExamples.map { it.toMutableList() }
    ...
    override fun toString() =
        "BetaToolComputerUse20250124{displayHeightPx=$displayHeightPx, displayWidthPx=$displayWidthPx, name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, displayNumber=$displayNumber, inputExamples=$inputExamples, strict=$strict, additionalProperties=$additionalProperties}"
}
