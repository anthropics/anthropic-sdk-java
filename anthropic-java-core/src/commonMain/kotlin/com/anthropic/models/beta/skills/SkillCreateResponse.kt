...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(skillCreateResponse: SkillCreateResponse) = apply {
            id = skillCreateResponse.id
            createdAt = skillCreateResponse.createdAt
            displayTitle = skillCreateResponse.displayTitle
            latestVersion = skillCreateResponse.latestVersion
            source = skillCreateResponse.source
            type = skillCreateResponse.type
            updatedAt = skillCreateResponse.updatedAt
    ...
    override fun toString() =
        "SkillCreateResponse{id=$id, createdAt=$createdAt, displayTitle=$displayTitle, latestVersion=$latestVersion, source=$source, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
