...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaToolComputerUse20241022: BetaToolComputerUse20241022) = apply {
            ...
            allowedCallers = betaToolComputerUse20241022.allowedCallers.map { it.toMutableList() }
            cacheControl = betaToolComputerUse20241022.cacheControl
            deferLoading = betaToolComputerUse20241022.deferLoading
            displayNumber = betaToolComputerUse20241022.displayNumber
            inputExamples = betaToolComputerUse20241022.inputExamples.map { it.toMutableList() }
            strict = betaToolComputerUse20241022.strict
    ...
    override fun toString() =
        "BetaToolComputerUse20241022{displayHeightPx=$displayHeightPx, displayWidthPx=$displayWidthPx, name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, displayNumber=$displayNumber, inputExamples=$inputExamples, strict=$strict, additionalProperties=$additionalProperties}"
}
