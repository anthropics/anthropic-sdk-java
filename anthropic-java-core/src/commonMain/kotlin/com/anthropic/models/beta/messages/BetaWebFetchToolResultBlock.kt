...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic internal fun from(betaWebFetchToolResultBlock: BetaWebFetchToolResultBlock) = apply {
    ...
    private constructor(
        ...
        override fun hashCode(): Int =
            contentHash(betaWebFetchToolResultErrorBlock, betaWebFetchBlock)
        ...
        companion object {
            ...
            @JvmStatic fun ofBetaWebFetchToolResultErrorBlock(
                betaWebFetchToolResultErrorBlock: BetaWebFetchToolResultErrorBlock
            ) = Content(betaWebFetchToolResultErrorBlock = betaWebFetchToolResultErrorBlock)

            @JvmStatic fun ofBetaWebFetchBlock(betaWebFetchBlock: BetaWebFetchBlock) =
    ...
    private val hashCode: Int by lazy {
        contentHash(content, toolUseId, type, caller, additionalProperties)
    }
