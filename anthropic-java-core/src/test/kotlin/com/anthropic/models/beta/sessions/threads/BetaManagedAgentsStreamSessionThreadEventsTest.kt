...
import com.anthropic.models.beta.sessions.events.BetaManagedAgentsAgentToolEvaluationAlwaysAllow
...
internal class BetaManagedAgentsStreamSessionThreadEventsTest {
    ...
    fun ofEventStart() {
        ...
        val betaManagedAgentsStreamSessionThreadEvents =
            BetaManagedAgentsStreamSessionThreadEvents.ofEventStart(eventStart)
        ...
        assertThat(betaManagedAgentsStreamSessionThreadEvents.sessionThreadStatusRescheduled())
            .isEmpty
        assertThat(betaManagedAgentsStreamSessionThreadEvents.sessionUpdated()).isEmpty
        assertThat(betaManagedAgentsStreamSessionThreadEvents.eventStart()).contains(eventStart)
        assertThat(betaManagedAgentsStreamSessionThreadEvents.eventDelta()).isEmpty
        assertThat(betaManagedAgentsStreamSessionThreadEvents.systemMessage()).isEmpty
        assertThat(betaManagedAgentsStreamSessionThreadEvents.sessionUsage()).isEmpty
    }
    ...
    fun ofEventStartRoundtrip() {
        val jsonMapper = jsonMapper()
        val betaManagedAgentsStreamSessionThreadEvents =
            BetaManagedAgentsStreamSessionThreadEvents.ofEventStart(
                BetaManagedAgentsStartEvent.builder()
                    .agentMessageEvent("id")
                    .type(BetaManagedAgentsStartEvent.Type.EVENT_START)
                    .build()
    ...
    fun ofEventDelta() {
        ...
        val betaManagedAgentsStreamSessionThreadEvents =
            BetaManagedAgentsStreamSessionThreadEvents.ofEventDelta(eventDelta)
    ...
    fun ofEventDeltaRoundtrip() {
        val jsonMapper = jsonMapper()
        val betaManagedAgentsStreamSessionThreadEvents =
            BetaManagedAgentsStreamSessionThreadEvents.ofEventDelta(
                BetaManagedAgentsDeltaEvent.builder()
                    .delta(
                        BetaManagedAgentsDeltaContent.builder()
                            .content(
    ...
    fun ofSystemMessage() {
        ...
        val betaManagedAgentsStreamSessionThreadEvents =
            BetaManagedAgentsStreamSessionThreadEvents.ofSystemMessage(systemMessage)
    ...
    fun ofSystemMessageRoundtrip() {
        val jsonMapper = jsonMapper()
        val betaManagedAgentsStreamSessionThreadEvents =
            BetaManagedAgentsStreamSessionThreadEvents.ofSystemMessage(
                BetaManagedAgentsSystemMessageEvent.builder()
                    .id("id")
                    .addTextContent("Where is my order #1234?")
                    .type(BetaManagedAgentsSystemMessageEvent.Type.SYSTEM_MESSAGE)
    ...
    fun ofSessionUsage() {
        ...
        val betaManagedAgentsStreamSessionThreadEvents =
            BetaManagedAgentsStreamSessionThreadEvents.ofSessionUsage(sessionUsage)
    ...
    fun ofSessionUsageRoundtrip() {
        val jsonMapper = jsonMapper()
        val betaManagedAgentsStreamSessionThreadEvents =
            BetaManagedAgentsStreamSessionThreadEvents.ofSessionUsage(
                BetaManagedAgentsSessionUsageEvent.builder()
                    .id("id")
                    .processedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .type(BetaManagedAgentsSessionUsageEvent.Type.SESSION_USAGE)
    ...
    fun unknownVariantCommonProperties() {
        ...
        assertThat(mismatchedBetaManagedAgentsStreamSessionThreadEvents.id()).isEmpty
        assertThat(mismatchedBetaManagedAgentsStreamSessionThreadEvents.processedAt()).isEmpty
        assertThat(mismatchedBetaManagedAgentsStreamSessionThreadEvents.sessionThreadId()).isEmpty
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
        ...
        assertThat(betaManagedAgentsStreamSessionThreadEvents.id()).isEmpty
        assertThat(betaManagedAgentsStreamSessionThreadEvents.processedAt()).isEmpty
        assertThat(betaManagedAgentsStreamSessionThreadEvents.sessionThreadId()).isEmpty
