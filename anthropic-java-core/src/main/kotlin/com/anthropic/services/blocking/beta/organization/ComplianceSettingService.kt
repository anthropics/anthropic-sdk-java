...
interface ComplianceSettingService {
     ...
     * configuration.
     */
    fun retrieve(): BetaComplianceSettings = retrieve(ComplianceSettingRetrieveParams.none())
    ...
    fun retrieve(
        params: ComplianceSettingRetrieveParams = ComplianceSettingRetrieveParams.none()
    ): BetaComplianceSettings = retrieve(params, RequestOptions.none())

    /** @see retrieve */
    fun retrieve(requestOptions: RequestOptions): BetaComplianceSettings =
     ...
     */
    fun update(params: ComplianceSettingUpdateParams): BetaComplianceSettings =
    ...
    interface WithRawResponse {
         ...
         * but is otherwise the same as [ComplianceSettingService.retrieve].
         */
        @MustBeClosed
        fun retrieve(): HttpResponseFor<BetaComplianceSettings> =
        ...
        fun retrieve(
            params: ComplianceSettingRetrieveParams = ComplianceSettingRetrieveParams.none()
        ): HttpResponseFor<BetaComplianceSettings> = retrieve(params, RequestOptions.none())

        /** @see retrieve */
        @MustBeClosed
        fun retrieve(requestOptions: RequestOptions): HttpResponseFor<BetaComplianceSettings> =
            retrieve(ComplianceSettingRetrieveParams.none(), requestOptions)

        /**
         * Returns a raw HTTP response for `post /v1/organizations/compliance_settings?beta=true`,
         * but is otherwise the same as [ComplianceSettingService.update].
         */
        @MustBeClosed
        fun update(params: ComplianceSettingUpdateParams): HttpResponseFor<BetaComplianceSettings> =
            update(params, RequestOptions.none())
