...
interface RuleService {
     ...
     */
    fun create(params: RuleCreateParams): BetaFederationRule = create(params, RequestOptions.none())
     ...
     */
    fun retrieve(federationRuleId: String): BetaFederationRule =
    ...
    fun retrieve(
        federationRuleId: String,
        params: RuleRetrieveParams = RuleRetrieveParams.none(),
    ): BetaFederationRule = retrieve(federationRuleId, params, RequestOptions.none())
    ...
    /** @see retrieve */
    fun retrieve(params: RuleRetrieveParams): BetaFederationRule =
        retrieve(params, RequestOptions.none())

    /** @see retrieve */
    fun retrieve(federationRuleId: String, requestOptions: RequestOptions): BetaFederationRule =
     ...
     * Console session.
     */
    fun update(federationRuleId: String): BetaFederationRule =
    ...
    fun update(
        federationRuleId: String,
        params: RuleUpdateParams = RuleUpdateParams.none(),
    ): BetaFederationRule = update(federationRuleId, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: RuleUpdateParams): BetaFederationRule = update(params, RequestOptions.none())

    /** @see update */
    fun update(federationRuleId: String, requestOptions: RequestOptions): BetaFederationRule =
     ...
     * `workspace:developer` or `workspace:inference`; other scopes require a Console session.
     */
    fun archive(federationRuleId: String): BetaFederationRule =
    ...
    fun archive(
        federationRuleId: String,
        params: RuleArchiveParams = RuleArchiveParams.none(),
    ): BetaFederationRule = archive(federationRuleId, params, RequestOptions.none())
    ...
    /** @see archive */
    fun archive(params: RuleArchiveParams): BetaFederationRule =
        archive(params, RequestOptions.none())

    /** @see archive */
    fun archive(federationRuleId: String, requestOptions: RequestOptions): BetaFederationRule =
    ...
    interface WithRawResponse {
         ...
         * is otherwise the same as [RuleService.create].
         */
        @MustBeClosed
        fun create(params: RuleCreateParams): HttpResponseFor<BetaFederationRule> =
         ...
         * same as [RuleService.retrieve].
         */
        @MustBeClosed
        fun retrieve(federationRuleId: String): HttpResponseFor<BetaFederationRule> =
            retrieve(federationRuleId, RuleRetrieveParams.none())
        ...
        /** @see retrieve */
        @MustBeClosed
        fun retrieve(params: RuleRetrieveParams): HttpResponseFor<BetaFederationRule> =
            retrieve(params, RequestOptions.none())
         ...
         * /v1/organizations/federation_rules/{federation_rule_id}?beta=true`, but is otherwise the
         * same as [RuleService.update].
         */
        @MustBeClosed
        fun update(federationRuleId: String): HttpResponseFor<BetaFederationRule> =
            update(federationRuleId, RuleUpdateParams.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: RuleUpdateParams): HttpResponseFor<BetaFederationRule> =
         ...
         * is otherwise the same as [RuleService.list].
         */
         ...
         * otherwise the same as [RuleService.archive].
         */
        @MustBeClosed
        fun archive(federationRuleId: String): HttpResponseFor<BetaFederationRule> =
            archive(federationRuleId, RuleArchiveParams.none())
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: RuleArchiveParams): HttpResponseFor<BetaFederationRule> =
            archive(params, RequestOptions.none())
