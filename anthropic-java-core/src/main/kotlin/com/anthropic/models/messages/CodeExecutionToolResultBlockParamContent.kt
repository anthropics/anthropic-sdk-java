...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = codeExecutionToolResultBlockParamContent.accept(new CodeExecutionToolResultBlockParamContent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitErrorParam(CodeExecutionToolResultErrorParam errorParam) {
