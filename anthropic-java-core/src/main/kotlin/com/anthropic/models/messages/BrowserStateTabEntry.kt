...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrowserStateTabEntry].
         *
    ...
    /** A builder for [BrowserStateTabEntry]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserStateTabEntry: BrowserStateTabEntry) = apply {
            tabId = browserStateTabEntry.tabId
            title = browserStateTabEntry.title
            url = browserStateTabEntry.url
            active = browserStateTabEntry.active
            additionalProperties = browserStateTabEntry.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserStateTabEntry].
         *
         ...
         */
        fun build(): BrowserStateTabEntry =
     ...
     *   expected type.
     */
    fun validate(): BrowserStateTabEntry = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserStateTabEntry &&
            tabId == other.tabId &&
            title == other.title &&
            url == other.url &&
            active == other.active &&
    ...
    override fun toString() =
        "BrowserStateTabEntry{tabId=$tabId, title=$title, url=$url, active=$active, additionalProperties=$additionalProperties}"
}
