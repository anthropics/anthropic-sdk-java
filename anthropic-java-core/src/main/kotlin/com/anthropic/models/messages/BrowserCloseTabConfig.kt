...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserCloseTabConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserCloseTabConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserCloseTabConfig: BrowserCloseTabConfig) = apply {
            deferLoading = browserCloseTabConfig.deferLoading
            enabled = browserCloseTabConfig.enabled
            additionalProperties = browserCloseTabConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserCloseTabConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserCloseTabConfig =
            BrowserCloseTabConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserCloseTabConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserCloseTabConfig &&
    ...
    override fun toString() =
        "BrowserCloseTabConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
