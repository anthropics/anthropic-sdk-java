...
private constructor(
    ...
    /** A builder for [BrowserStateChangeDownloadFailed]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserStateChangeDownloadFailed: BrowserStateChangeDownloadFailed) =
            apply {
                downloadId = browserStateChangeDownloadFailed.downloadId
                type = browserStateChangeDownloadFailed.type
                url = browserStateChangeDownloadFailed.url
                error = browserStateChangeDownloadFailed.error
                additionalProperties =
                    browserStateChangeDownloadFailed.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BrowserStateChangeDownloadFailed].
         *
         ...
         */
        fun build(): BrowserStateChangeDownloadFailed =
            BrowserStateChangeDownloadFailed(
     ...
     *   expected type.
     */
    fun validate(): BrowserStateChangeDownloadFailed = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserStateChangeDownloadFailed &&
    ...
    override fun toString() =
        "BrowserStateChangeDownloadFailed{downloadId=$downloadId, type=$type, url=$url, error=$error, additionalProperties=$additionalProperties}"
}
