...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserHoverConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserHoverConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserHoverConfig: BrowserHoverConfig) = apply {
            deferLoading = browserHoverConfig.deferLoading
            enabled = browserHoverConfig.enabled
            additionalProperties = browserHoverConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserHoverConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserHoverConfig =
            BrowserHoverConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserHoverConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserHoverConfig &&
    ...
    override fun toString() =
        "BrowserHoverConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
