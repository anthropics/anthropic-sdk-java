...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserNavigateConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserNavigateConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserNavigateConfig: BrowserNavigateConfig) = apply {
            deferLoading = browserNavigateConfig.deferLoading
            enabled = browserNavigateConfig.enabled
            additionalProperties = browserNavigateConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserNavigateConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserNavigateConfig =
            BrowserNavigateConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserNavigateConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserNavigateConfig &&
    ...
    override fun toString() =
        "BrowserNavigateConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
