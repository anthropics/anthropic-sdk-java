...
private constructor(
    ...
    /** A builder for [BrowserStateChangeDownloadStarted]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserStateChangeDownloadStarted: BrowserStateChangeDownloadStarted) =
            apply {
                downloadId = browserStateChangeDownloadStarted.downloadId
                type = browserStateChangeDownloadStarted.type
                url = browserStateChangeDownloadStarted.url
                additionalProperties =
                    browserStateChangeDownloadStarted.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BrowserStateChangeDownloadStarted].
         *
         ...
         */
        fun build(): BrowserStateChangeDownloadStarted =
            BrowserStateChangeDownloadStarted(
     ...
     *   expected type.
     */
    fun validate(): BrowserStateChangeDownloadStarted = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserStateChangeDownloadStarted &&
    ...
    override fun toString() =
        "BrowserStateChangeDownloadStarted{downloadId=$downloadId, type=$type, url=$url, additionalProperties=$additionalProperties}"
}
