...
private constructor(
    ...
    fun validate(): MemoryTool20250818 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MemoryTool20250818 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "MemoryTool20250818{name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, inputExamples=$inputExamples, strict=$strict, additionalProperties=$additionalProperties}"
}
