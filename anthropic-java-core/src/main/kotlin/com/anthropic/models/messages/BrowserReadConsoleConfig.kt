...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserReadConsoleConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserReadConsoleConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserReadConsoleConfig: BrowserReadConsoleConfig) = apply {
            deferLoading = browserReadConsoleConfig.deferLoading
            enabled = browserReadConsoleConfig.enabled
            additionalProperties = browserReadConsoleConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserReadConsoleConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserReadConsoleConfig =
            BrowserReadConsoleConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserReadConsoleConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserReadConsoleConfig &&
    ...
    override fun toString() =
        "BrowserReadConsoleConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
