...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrowserLeftClickDragConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserLeftClickDragConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserLeftClickDragConfig: BrowserLeftClickDragConfig) = apply {
            deferLoading = browserLeftClickDragConfig.deferLoading
            enabled = browserLeftClickDragConfig.enabled
            additionalProperties = browserLeftClickDragConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserLeftClickDragConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserLeftClickDragConfig =
            BrowserLeftClickDragConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserLeftClickDragConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserLeftClickDragConfig &&
    ...
    override fun toString() =
        "BrowserLeftClickDragConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
