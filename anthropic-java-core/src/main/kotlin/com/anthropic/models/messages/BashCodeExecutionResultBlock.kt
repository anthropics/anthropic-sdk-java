...
private constructor(
    private val content: JsonField<List<BashCodeExecutionOutputBlock>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        content: JsonField<List<BashCodeExecutionOutputBlock>> = JsonMissing.of(),
    ...
    fun toParam(): BashCodeExecutionResultBlockParam =
     ...
     */
    fun content(): List<BashCodeExecutionOutputBlock> = content.getRequired("content")
    ...
    @JsonProperty("content")
    @ExcludeMissing
    fun _content(): JsonField<List<BashCodeExecutionOutputBlock>> = content
    ...
    class Builder internal constructor() {
        ...
        private var content: JsonField<MutableList<BashCodeExecutionOutputBlock>>? = null
        ...
        internal fun from(bashCodeExecutionResultBlock: BashCodeExecutionResultBlock) = apply {
            ...
            type = bashCodeExecutionResultBlock.type
            additionalProperties = bashCodeExecutionResultBlock.additionalProperties.toMutableMap()
        }

        fun content(content: List<BashCodeExecutionOutputBlock>) = content(JsonField.of(content))

        /**
         * Sets [Builder.content] to an arbitrary JSON value.
         *
         * You should usually call [Builder.content] with a well-typed
         * `List<BashCodeExecutionOutputBlock>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun content(content: JsonField<List<BashCodeExecutionOutputBlock>>) = apply {
         ...
         */
        fun addContent(content: BashCodeExecutionOutputBlock) = apply {
            this.content =
         ...
         */
        fun build(): BashCodeExecutionResultBlock =
    ...
    fun validate(): BashCodeExecutionResultBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BashCodeExecutionResultBlock &&
    ...
    override fun toString() =
        "BashCodeExecutionResultBlock{content=$content, returnCode=$returnCode, stderr=$stderr, stdout=$stdout, type=$type, additionalProperties=$additionalProperties}"
}
