...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [ContainerUploadBlockParam] with the required [fileId]
         * set to the given value.
         */
        @JvmStatic fun of(fileId: String) = builder().fileId(fileId).build()
    }

    /** A builder for [ContainerUploadBlockParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(containerUploadBlockParam: ContainerUploadBlockParam) = apply {
            fileId = containerUploadBlockParam.fileId
            type = containerUploadBlockParam.type
            cacheControl = containerUploadBlockParam.cacheControl
            additionalProperties = containerUploadBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ContainerUploadBlockParam =
     ...
     *   expected type.
     */
    fun validate(): ContainerUploadBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContainerUploadBlockParam &&
            fileId == other.fileId &&
            type == other.type &&
    ...
    override fun toString() =
        "ContainerUploadBlockParam{fileId=$fileId, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
