...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ComputerLeftMouseUpConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerLeftMouseUpConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerLeftMouseUpConfig: ComputerLeftMouseUpConfig) = apply {
            deferLoading = computerLeftMouseUpConfig.deferLoading
            enabled = computerLeftMouseUpConfig.enabled
            additionalProperties = computerLeftMouseUpConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerLeftMouseUpConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerLeftMouseUpConfig =
            ComputerLeftMouseUpConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerLeftMouseUpConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerLeftMouseUpConfig &&
    ...
    override fun toString() =
        "ComputerLeftMouseUpConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
