...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ComputerCursorPositionConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerCursorPositionConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerCursorPositionConfig: ComputerCursorPositionConfig) = apply {
            deferLoading = computerCursorPositionConfig.deferLoading
            enabled = computerCursorPositionConfig.enabled
            additionalProperties = computerCursorPositionConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerCursorPositionConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerCursorPositionConfig =
            ComputerCursorPositionConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerCursorPositionConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerCursorPositionConfig &&
    ...
    override fun toString() =
        "ComputerCursorPositionConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
