...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webFetchTool20260209: WebFetchTool20260209) = apply {
            ...
            urlSources = webFetchTool20260209.urlSources
    ...
    override fun toString() =
        "WebFetchTool20260209{name=$name, type=$type, allowedCallers=$allowedCallers, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, cacheControl=$cacheControl, citations=$citations, deferLoading=$deferLoading, maxContentTokens=$maxContentTokens, maxUses=$maxUses, strict=$strict, urlSources=$urlSources, additionalProperties=$additionalProperties}"
}
