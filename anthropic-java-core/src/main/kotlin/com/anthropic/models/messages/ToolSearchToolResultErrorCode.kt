...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [ToolSearchToolResultErrorCode]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [ToolSearchToolResultErrorCode] can contain an unknown value in a couple of
     * cases:
    ...
    enum class Value {
        ...
        EXECUTION_TIME_EXCEEDED,
        /**
         * An enum member indicating that [ToolSearchToolResultErrorCode] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            EXECUTION_TIME_EXCEEDED -> Known.EXECUTION_TIME_EXCEEDED
                ...
                throw AnthropicInvalidDataException("Unknown ToolSearchToolResultErrorCode: $value")
        }
    ...
    fun validate(): ToolSearchToolResultErrorCode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolSearchToolResultErrorCode && value == other.value
    }
