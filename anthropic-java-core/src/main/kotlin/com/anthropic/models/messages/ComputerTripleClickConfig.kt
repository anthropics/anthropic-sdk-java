...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ComputerTripleClickConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerTripleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerTripleClickConfig: ComputerTripleClickConfig) = apply {
            deferLoading = computerTripleClickConfig.deferLoading
            enabled = computerTripleClickConfig.enabled
            additionalProperties = computerTripleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerTripleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerTripleClickConfig =
            ComputerTripleClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerTripleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerTripleClickConfig &&
    ...
    override fun toString() =
        "ComputerTripleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
