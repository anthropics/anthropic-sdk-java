...
private constructor(
    ...
    private val configs: JsonField<BrowserToolsetConfigs>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        configs: JsonField<BrowserToolsetConfigs> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun configs(): Optional<BrowserToolsetConfigs> = configs.getOptional("configs")
    ...
    @JsonProperty("configs")
    @ExcludeMissing
    fun _configs(): JsonField<BrowserToolsetConfigs> = configs
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserToolset20260801]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserToolset20260801]. */
    class Builder internal constructor() {

        private var type: JsonValue = JsonValue.from("browser_toolset_20260801")
        private var cacheControl: JsonField<CacheControlEphemeral> = JsonMissing.of()
        private var configs: JsonField<BrowserToolsetConfigs> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(browserToolset20260801: BrowserToolset20260801) = apply {
            type = browserToolset20260801.type
            cacheControl = browserToolset20260801.cacheControl
            configs = browserToolset20260801.configs
            additionalProperties = browserToolset20260801.additionalProperties.toMutableMap()
        }
        ...
        fun configs(configs: Optional<BrowserToolsetConfigs>) = configs(configs.getOrNull())

        /**
         * Sets [Builder.configs] to an arbitrary JSON value.
         *
         * You should usually call [Builder.configs] with a well-typed [BrowserToolsetConfigs] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun configs(configs: JsonField<BrowserToolsetConfigs>) = apply { this.configs = configs }
        ...
        /**
         * Returns an immutable instance of [BrowserToolset20260801].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserToolset20260801 =
            BrowserToolset20260801(type, cacheControl, configs, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserToolset20260801 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserToolset20260801 &&
            type == other.type &&
    ...
    override fun toString() =
        "BrowserToolset20260801{type=$type, cacheControl=$cacheControl, configs=$configs, additionalProperties=$additionalProperties}"
}
