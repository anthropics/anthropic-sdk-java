...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserRightClickConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserRightClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserRightClickConfig: BrowserRightClickConfig) = apply {
            deferLoading = browserRightClickConfig.deferLoading
            enabled = browserRightClickConfig.enabled
            additionalProperties = browserRightClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserRightClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserRightClickConfig =
            BrowserRightClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserRightClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserRightClickConfig &&
    ...
    override fun toString() =
        "BrowserRightClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
