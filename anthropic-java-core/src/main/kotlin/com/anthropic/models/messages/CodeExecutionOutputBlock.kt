...
private constructor(
    ...
    fun toParam(): CodeExecutionOutputBlockParam =
        CodeExecutionOutputBlockParam.builder().fileId(_fileId()).build()
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [CodeExecutionOutputBlock] with the required [fileId]
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): CodeExecutionOutputBlock =
     ...
     *   expected type.
     */
    fun validate(): CodeExecutionOutputBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CodeExecutionOutputBlock &&
            fileId == other.fileId &&
            type == other.type &&
    ...
    override fun toString() =
        "CodeExecutionOutputBlock{fileId=$fileId, type=$type, additionalProperties=$additionalProperties}"
}
