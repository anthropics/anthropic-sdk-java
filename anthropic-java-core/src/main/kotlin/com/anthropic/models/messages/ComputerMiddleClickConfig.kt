...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ComputerMiddleClickConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerMiddleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerMiddleClickConfig: ComputerMiddleClickConfig) = apply {
            deferLoading = computerMiddleClickConfig.deferLoading
            enabled = computerMiddleClickConfig.enabled
            additionalProperties = computerMiddleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerMiddleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerMiddleClickConfig =
            ComputerMiddleClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerMiddleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerMiddleClickConfig &&
    ...
    override fun toString() =
        "ComputerMiddleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
