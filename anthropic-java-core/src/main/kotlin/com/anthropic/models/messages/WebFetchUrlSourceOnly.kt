...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WebFetchUrlSourceOnly].
         *
        ...
        /**
         * Returns an immutable instance of [WebFetchUrlSourceOnly] with the required [tools] set to
         * the given value.
         */
        @JvmStatic
    ...
    /** A builder for [WebFetchUrlSourceOnly]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webFetchUrlSourceOnly: WebFetchUrlSourceOnly) = apply {
            tools =
                webFetchUrlSourceOnly.tools.map { it.toMutableList() }.takeUnless { it.isMissing() }
            type = webFetchUrlSourceOnly.type
            additionalProperties = webFetchUrlSourceOnly.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WebFetchUrlSourceOnly].
         *
         ...
         */
        fun build(): WebFetchUrlSourceOnly =
     ...
     *   expected type.
     */
    fun validate(): WebFetchUrlSourceOnly = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebFetchUrlSourceOnly &&
            tools == other.tools &&
            type == other.type &&
    ...
    override fun toString() =
        "WebFetchUrlSourceOnly{tools=$tools, type=$type, additionalProperties=$additionalProperties}"
}
