...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrowserLeftMouseDownConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserLeftMouseDownConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserLeftMouseDownConfig: BrowserLeftMouseDownConfig) = apply {
            deferLoading = browserLeftMouseDownConfig.deferLoading
            enabled = browserLeftMouseDownConfig.enabled
            additionalProperties = browserLeftMouseDownConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserLeftMouseDownConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserLeftMouseDownConfig =
            BrowserLeftMouseDownConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserLeftMouseDownConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserLeftMouseDownConfig &&
    ...
    override fun toString() =
        "BrowserLeftMouseDownConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
