...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WebSearchTool20260318]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WebSearchTool20260318]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webSearchTool20260318: WebSearchTool20260318) = apply {
            name = webSearchTool20260318.name
            type = webSearchTool20260318.type
            allowedCallers =
                webSearchTool20260318.allowedCallers
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            allowedDomains =
                webSearchTool20260318.allowedDomains
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            blockedDomains =
                webSearchTool20260318.blockedDomains
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            cacheControl = webSearchTool20260318.cacheControl
            deferLoading = webSearchTool20260318.deferLoading
            maxUses = webSearchTool20260318.maxUses
            responseInclusion = webSearchTool20260318.responseInclusion
            strict = webSearchTool20260318.strict
            userLocation = webSearchTool20260318.userLocation
            additionalProperties = webSearchTool20260318.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WebSearchTool20260318].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebSearchTool20260318 =
     ...
     *   expected type.
     */
    fun validate(): WebSearchTool20260318 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebSearchTool20260318 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "WebSearchTool20260318{name=$name, type=$type, allowedCallers=$allowedCallers, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, cacheControl=$cacheControl, deferLoading=$deferLoading, maxUses=$maxUses, responseInclusion=$responseInclusion, strict=$strict, userLocation=$userLocation, additionalProperties=$additionalProperties}"
}
