...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ImageTransformationsParam].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ImageTransformationsParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(imageTransformationsParam: ImageTransformationsParam) = apply {
            oversizedImage = imageTransformationsParam.oversizedImage
            additionalProperties = imageTransformationsParam.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ImageTransformationsParam].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ImageTransformationsParam =
            ImageTransformationsParam(oversizedImage, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ImageTransformationsParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ImageTransformationsParam &&
    ...
    override fun toString() =
        "ImageTransformationsParam{oversizedImage=$oversizedImage, additionalProperties=$additionalProperties}"
}
