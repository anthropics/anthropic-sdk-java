...
private constructor(
    ...
    fun toParam(): CodeExecutionToolResultErrorParam =
        CodeExecutionToolResultErrorParam.builder().errorCode(_errorCode()).build()
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [CodeExecutionToolResultError] with the required
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): CodeExecutionToolResultError =
     ...
     *   expected type.
     */
    fun validate(): CodeExecutionToolResultError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CodeExecutionToolResultError &&
    ...
    override fun toString() =
        "CodeExecutionToolResultError{errorCode=$errorCode, type=$type, additionalProperties=$additionalProperties}"
}
