...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerLeftClickConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerLeftClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerLeftClickConfig: ComputerLeftClickConfig) = apply {
            deferLoading = computerLeftClickConfig.deferLoading
            enabled = computerLeftClickConfig.enabled
            additionalProperties = computerLeftClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerLeftClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerLeftClickConfig =
            ComputerLeftClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerLeftClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerLeftClickConfig &&
    ...
    override fun toString() =
        "ComputerLeftClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
