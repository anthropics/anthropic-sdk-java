...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrowserJavascriptExecConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserJavascriptExecConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserJavascriptExecConfig: BrowserJavascriptExecConfig) = apply {
            deferLoading = browserJavascriptExecConfig.deferLoading
            enabled = browserJavascriptExecConfig.enabled
            additionalProperties = browserJavascriptExecConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserJavascriptExecConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserJavascriptExecConfig =
            BrowserJavascriptExecConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserJavascriptExecConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserJavascriptExecConfig &&
    ...
    override fun toString() =
        "BrowserJavascriptExecConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
