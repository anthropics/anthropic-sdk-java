...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerZoomConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerZoomConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerZoomConfig: ComputerZoomConfig) = apply {
            deferLoading = computerZoomConfig.deferLoading
            enabled = computerZoomConfig.enabled
            additionalProperties = computerZoomConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerZoomConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerZoomConfig =
            ComputerZoomConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerZoomConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerZoomConfig &&
    ...
    override fun toString() =
        "ComputerZoomConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
