...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [WebSearchToolResultErrorCode]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [WebSearchToolResultErrorCode] can contain an unknown value in a couple of
     * cases:
    ...
    enum class Value {
        ...
        REQUEST_TOO_LARGE,
        /**
         * An enum member indicating that [WebSearchToolResultErrorCode] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            REQUEST_TOO_LARGE -> Known.REQUEST_TOO_LARGE
                ...
                throw AnthropicInvalidDataException("Unknown WebSearchToolResultErrorCode: $value")
        }
    ...
    fun validate(): WebSearchToolResultErrorCode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebSearchToolResultErrorCode && value == other.value
    }
