...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [WebFetchTool20260318]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [WebFetchTool20260318]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webFetchTool20260318: WebFetchTool20260318) = apply {
            name = webFetchTool20260318.name
            type = webFetchTool20260318.type
            allowedCallers =
                webFetchTool20260318.allowedCallers
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            allowedDomains =
                webFetchTool20260318.allowedDomains
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            blockedDomains =
                webFetchTool20260318.blockedDomains
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            cacheControl = webFetchTool20260318.cacheControl
            citations = webFetchTool20260318.citations
            deferLoading = webFetchTool20260318.deferLoading
            maxContentTokens = webFetchTool20260318.maxContentTokens
            maxUses = webFetchTool20260318.maxUses
            responseInclusion = webFetchTool20260318.responseInclusion
            strict = webFetchTool20260318.strict
            urlSources = webFetchTool20260318.urlSources
            useCache = webFetchTool20260318.useCache
            additionalProperties = webFetchTool20260318.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [WebFetchTool20260318].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): WebFetchTool20260318 =
     ...
     *   expected type.
     */
    fun validate(): WebFetchTool20260318 = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebFetchTool20260318 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "WebFetchTool20260318{name=$name, type=$type, allowedCallers=$allowedCallers, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, cacheControl=$cacheControl, citations=$citations, deferLoading=$deferLoading, maxContentTokens=$maxContentTokens, maxUses=$maxUses, responseInclusion=$responseInclusion, strict=$strict, urlSources=$urlSources, useCache=$useCache, additionalProperties=$additionalProperties}"
}
