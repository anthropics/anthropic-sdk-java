...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ComputerDoubleClickConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerDoubleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerDoubleClickConfig: ComputerDoubleClickConfig) = apply {
            deferLoading = computerDoubleClickConfig.deferLoading
            enabled = computerDoubleClickConfig.enabled
            additionalProperties = computerDoubleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerDoubleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerDoubleClickConfig =
            ComputerDoubleClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerDoubleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerDoubleClickConfig &&
    ...
    override fun toString() =
        "ComputerDoubleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
