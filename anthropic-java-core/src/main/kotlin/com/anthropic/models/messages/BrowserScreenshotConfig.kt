...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserScreenshotConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserScreenshotConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserScreenshotConfig: BrowserScreenshotConfig) = apply {
            deferLoading = browserScreenshotConfig.deferLoading
            enabled = browserScreenshotConfig.enabled
            additionalProperties = browserScreenshotConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserScreenshotConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserScreenshotConfig =
            BrowserScreenshotConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserScreenshotConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserScreenshotConfig &&
    ...
    override fun toString() =
        "BrowserScreenshotConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
