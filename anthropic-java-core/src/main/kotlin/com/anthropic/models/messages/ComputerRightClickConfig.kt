...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerRightClickConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerRightClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerRightClickConfig: ComputerRightClickConfig) = apply {
            deferLoading = computerRightClickConfig.deferLoading
            enabled = computerRightClickConfig.enabled
            additionalProperties = computerRightClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerRightClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerRightClickConfig =
            ComputerRightClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerRightClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerRightClickConfig &&
    ...
    override fun toString() =
        "ComputerRightClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
