...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserWaitConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserWaitConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserWaitConfig: BrowserWaitConfig) = apply {
            deferLoading = browserWaitConfig.deferLoading
            enabled = browserWaitConfig.enabled
            additionalProperties = browserWaitConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserWaitConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserWaitConfig =
            BrowserWaitConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserWaitConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserWaitConfig &&
    ...
    override fun toString() =
        "BrowserWaitConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
