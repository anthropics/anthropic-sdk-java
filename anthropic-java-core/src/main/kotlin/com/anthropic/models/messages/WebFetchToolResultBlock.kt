...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitWebFetchToolResultErrorBlock(WebFetchToolResultErrorBlock webFetchToolResultErrorBlock) {
         *         return Optional.of(webFetchToolResultErrorBlock.toString());
         *     }
         *
         *     // ...
         *
        ...
        companion object {
            ...
            /**
             * Returns an immutable instance of [Content] whose [ofWebFetchToolResultErrorBlock]
             * variant is built from the given required [errorCode].
             */
            @JvmStatic
            fun ofWebFetchToolResultErrorBlock(errorCode: WebFetchToolResultErrorCode) =
                ofWebFetchToolResultErrorBlock(WebFetchToolResultErrorBlock.of(errorCode))
