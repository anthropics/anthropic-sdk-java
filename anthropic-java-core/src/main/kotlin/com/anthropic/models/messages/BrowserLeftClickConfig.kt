...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserLeftClickConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserLeftClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserLeftClickConfig: BrowserLeftClickConfig) = apply {
            deferLoading = browserLeftClickConfig.deferLoading
            enabled = browserLeftClickConfig.enabled
            additionalProperties = browserLeftClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserLeftClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserLeftClickConfig =
            BrowserLeftClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserLeftClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserLeftClickConfig &&
    ...
    override fun toString() =
        "BrowserLeftClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
