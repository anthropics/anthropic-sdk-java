...
private constructor(
    ...
    fun toParam(): ToolSearchToolResultBlockParam =
    ...
    /** A builder for [ToolSearchToolResultBlock]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(toolSearchToolResultBlock: ToolSearchToolResultBlock) = apply {
            content = toolSearchToolResultBlock.content
            toolUseId = toolSearchToolResultBlock.toolUseId
            type = toolSearchToolResultBlock.type
            additionalProperties = toolSearchToolResultBlock.additionalProperties.toMutableMap()
        }
         ...
         * `Content.ofToolSearchToolResultError(toolSearchToolResultError)`.
         */
        fun content(toolSearchToolResultError: ToolSearchToolResultError) =
            content(Content.ofToolSearchToolResultError(toolSearchToolResultError))

        /**
         * Alias for calling [content] with
         * `Content.ofToolSearchToolSearchResultBlock(toolSearchToolSearchResultBlock)`.
         */
        fun content(toolSearchToolSearchResultBlock: ToolSearchToolSearchResultBlock) =
            content(Content.ofToolSearchToolSearchResultBlock(toolSearchToolSearchResultBlock))
         ...
         */
        fun build(): ToolSearchToolResultBlock =
     ...
     *   expected type.
     */
    fun validate(): ToolSearchToolResultBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    class Content
    private constructor(
        private val toolSearchToolResultError: ToolSearchToolResultError? = null,
        private val toolSearchToolSearchResultBlock: ToolSearchToolSearchResultBlock? = null,
        ...
        fun isToolSearchToolSearchResultBlock(): Boolean = toolSearchToolSearchResultBlock != null

        fun asToolSearchToolResultError(): ToolSearchToolResultError =
            toolSearchToolResultError.getOrThrow("toolSearchToolResultError")
         ...
         *     @Override
         *     public Optional<String> visitToolSearchToolResultError(ToolSearchToolResultError toolSearchToolResultError) {
         *         return Optional.of(toolSearchToolResultError.toString());
         *     }
         *
         *     // ...
         *
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                toolSearchToolResultError != null ->
                    visitor.visitToolSearchToolResultError(toolSearchToolResultError)
                toolSearchToolSearchResultBlock != null ->
                    visitor.visitToolSearchToolSearchResultBlock(toolSearchToolSearchResultBlock)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Content &&
                toolSearchToolResultError == other.toolSearchToolResultError &&
                toolSearchToolSearchResultBlock == other.toolSearchToolSearchResultBlock
        }

        override fun hashCode(): Int =
            Objects.hash(toolSearchToolResultError, toolSearchToolSearchResultBlock)

        override fun toString(): String =
            when {
                toolSearchToolResultError != null ->
                    "Content{toolSearchToolResultError=$toolSearchToolResultError}"
                toolSearchToolSearchResultBlock != null ->
        ...
        companion object {
            ...
            @JvmStatic
            fun ofToolSearchToolResultError(toolSearchToolResultError: ToolSearchToolResultError) =
                Content(toolSearchToolResultError = toolSearchToolResultError)
        ...
        interface Visitor<out T> {
            ...
            fun visitToolSearchToolResultError(
                toolSearchToolResultError: ToolSearchToolResultError
            ): T

            fun visitToolSearchToolSearchResultBlock(
                toolSearchToolSearchResultBlock: ToolSearchToolSearchResultBlock
            ): T
        ...
        internal class Deserializer : BaseDeserializer<Content>(Content::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Content {
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(node, jacksonTypeRef<ToolSearchToolResultError>())?.let {
                                Content(toolSearchToolResultError = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<ToolSearchToolSearchResultBlock>())
                                ?.let {
                                    Content(toolSearchToolSearchResultBlock = it, _json = json)
                                },
                        )
                        .filterNotNull()
        ...
        internal class Serializer : BaseSerializer<Content>(Content::class) {
            ...
            override fun serialize(
                ...
                when {
                    value.toolSearchToolResultError != null ->
                        generator.writeObject(value.toolSearchToolResultError)
                    value.toolSearchToolSearchResultBlock != null ->
                        generator.writeObject(value.toolSearchToolSearchResultBlock)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolSearchToolResultBlock &&
    ...
    override fun toString() =
        "ToolSearchToolResultBlock{content=$content, toolUseId=$toolUseId, type=$type, additionalProperties=$additionalProperties}"
}
