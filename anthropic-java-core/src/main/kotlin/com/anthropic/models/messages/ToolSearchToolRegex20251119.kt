...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [ToolSearchToolRegex20251119] with the required [type]
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolSearchToolRegex20251119: ToolSearchToolRegex20251119) = apply {
            ...
            additionalProperties = toolSearchToolRegex20251119.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ToolSearchToolRegex20251119 =
     ...
     *   expected type.
     */
    fun validate(): ToolSearchToolRegex20251119 = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val TOOL_SEARCH_TOOL_REGEX_20251119 = of("tool_search_tool_regex_20251119")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolSearchToolRegex20251119 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "ToolSearchToolRegex20251119{name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, strict=$strict, additionalProperties=$additionalProperties}"
}
