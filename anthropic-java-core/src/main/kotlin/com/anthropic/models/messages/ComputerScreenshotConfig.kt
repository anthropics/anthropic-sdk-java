...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerScreenshotConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerScreenshotConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerScreenshotConfig: ComputerScreenshotConfig) = apply {
            deferLoading = computerScreenshotConfig.deferLoading
            enabled = computerScreenshotConfig.enabled
            additionalProperties = computerScreenshotConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerScreenshotConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerScreenshotConfig =
            ComputerScreenshotConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerScreenshotConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerScreenshotConfig &&
    ...
    override fun toString() =
        "ComputerScreenshotConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
