...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ComputerLeftClickDragConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerLeftClickDragConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerLeftClickDragConfig: ComputerLeftClickDragConfig) = apply {
            deferLoading = computerLeftClickDragConfig.deferLoading
            enabled = computerLeftClickDragConfig.enabled
            additionalProperties = computerLeftClickDragConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerLeftClickDragConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerLeftClickDragConfig =
            ComputerLeftClickDragConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerLeftClickDragConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerLeftClickDragConfig &&
    ...
    override fun toString() =
        "ComputerLeftClickDragConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
