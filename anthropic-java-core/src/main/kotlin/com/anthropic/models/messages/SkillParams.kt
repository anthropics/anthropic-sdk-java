...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SkillParams].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(skillParams: SkillParams) = apply {
            skillId = skillParams.skillId
            type = skillParams.type
            version = skillParams.version
            additionalProperties = skillParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SkillParams].
         *
     ...
     *   expected type.
     */
    fun validate(): SkillParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "SkillParams{skillId=$skillId, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
