...
private constructor(
    ...
    fun toParam(): BashCodeExecutionToolResultErrorParam =
        BashCodeExecutionToolResultErrorParam.builder().errorCode(_errorCode()).build()
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BashCodeExecutionToolResultError] with the required
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bashCodeExecutionToolResultError: BashCodeExecutionToolResultError) =
            apply {
                ...
                additionalProperties =
                    bashCodeExecutionToolResultError.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BashCodeExecutionToolResultError =
            BashCodeExecutionToolResultError(
     ...
     *   expected type.
     */
    fun validate(): BashCodeExecutionToolResultError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BashCodeExecutionToolResultError &&
    ...
    override fun toString() =
        "BashCodeExecutionToolResultError{errorCode=$errorCode, type=$type, additionalProperties=$additionalProperties}"
}
