...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserScrollConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserScrollConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserScrollConfig: BrowserScrollConfig) = apply {
            deferLoading = browserScrollConfig.deferLoading
            enabled = browserScrollConfig.enabled
            additionalProperties = browserScrollConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserScrollConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserScrollConfig =
            BrowserScrollConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserScrollConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserScrollConfig &&
    ...
    override fun toString() =
        "BrowserScrollConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
