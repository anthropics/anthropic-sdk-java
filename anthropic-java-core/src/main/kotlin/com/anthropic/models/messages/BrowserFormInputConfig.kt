...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserFormInputConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserFormInputConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserFormInputConfig: BrowserFormInputConfig) = apply {
            deferLoading = browserFormInputConfig.deferLoading
            enabled = browserFormInputConfig.enabled
            additionalProperties = browserFormInputConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserFormInputConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserFormInputConfig =
            BrowserFormInputConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserFormInputConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserFormInputConfig &&
    ...
    override fun toString() =
        "BrowserFormInputConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
