...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserFileUploadConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserFileUploadConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserFileUploadConfig: BrowserFileUploadConfig) = apply {
            deferLoading = browserFileUploadConfig.deferLoading
            enabled = browserFileUploadConfig.enabled
            additionalProperties = browserFileUploadConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserFileUploadConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserFileUploadConfig =
            BrowserFileUploadConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserFileUploadConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserFileUploadConfig &&
    ...
    override fun toString() =
        "BrowserFileUploadConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
