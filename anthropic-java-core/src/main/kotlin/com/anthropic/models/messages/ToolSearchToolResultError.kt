...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolSearchToolResultError: ToolSearchToolResultError) = apply {
            ...
            additionalProperties = toolSearchToolResultError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ToolSearchToolResultError =
    ...
    fun validate(): ToolSearchToolResultError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolSearchToolResultError &&
    ...
    override fun toString() =
        "ToolSearchToolResultError{errorCode=$errorCode, errorMessage=$errorMessage, type=$type, additionalProperties=$additionalProperties}"
}
