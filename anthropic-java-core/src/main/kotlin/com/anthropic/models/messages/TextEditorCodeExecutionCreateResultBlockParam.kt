...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            isFileUpdate = textEditorCodeExecutionCreateResultBlockParam.isFileUpdate
            type = textEditorCodeExecutionCreateResultBlockParam.type
            additionalProperties =
                textEditorCodeExecutionCreateResultBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): TextEditorCodeExecutionCreateResultBlockParam =
            TextEditorCodeExecutionCreateResultBlockParam(
    ...
    fun validate(): TextEditorCodeExecutionCreateResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TextEditorCodeExecutionCreateResultBlockParam &&
    ...
    override fun toString() =
        "TextEditorCodeExecutionCreateResultBlockParam{isFileUpdate=$isFileUpdate, type=$type, additionalProperties=$additionalProperties}"
}
