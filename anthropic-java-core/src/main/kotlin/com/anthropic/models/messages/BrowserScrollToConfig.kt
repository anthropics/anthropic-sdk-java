...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserScrollToConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserScrollToConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserScrollToConfig: BrowserScrollToConfig) = apply {
            deferLoading = browserScrollToConfig.deferLoading
            enabled = browserScrollToConfig.enabled
            additionalProperties = browserScrollToConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserScrollToConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserScrollToConfig =
            BrowserScrollToConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserScrollToConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserScrollToConfig &&
    ...
    override fun toString() =
        "BrowserScrollToConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
