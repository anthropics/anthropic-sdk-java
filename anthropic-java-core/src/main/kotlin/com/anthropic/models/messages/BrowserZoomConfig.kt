...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserZoomConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserZoomConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserZoomConfig: BrowserZoomConfig) = apply {
            deferLoading = browserZoomConfig.deferLoading
            enabled = browserZoomConfig.enabled
            additionalProperties = browserZoomConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserZoomConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserZoomConfig =
            BrowserZoomConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserZoomConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserZoomConfig &&
    ...
    override fun toString() =
        "BrowserZoomConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
