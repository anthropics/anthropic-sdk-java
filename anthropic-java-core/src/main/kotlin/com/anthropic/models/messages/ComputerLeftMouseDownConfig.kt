...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ComputerLeftMouseDownConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerLeftMouseDownConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerLeftMouseDownConfig: ComputerLeftMouseDownConfig) = apply {
            deferLoading = computerLeftMouseDownConfig.deferLoading
            enabled = computerLeftMouseDownConfig.enabled
            additionalProperties = computerLeftMouseDownConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerLeftMouseDownConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerLeftMouseDownConfig =
            ComputerLeftMouseDownConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerLeftMouseDownConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerLeftMouseDownConfig &&
    ...
    override fun toString() =
        "ComputerLeftMouseDownConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
