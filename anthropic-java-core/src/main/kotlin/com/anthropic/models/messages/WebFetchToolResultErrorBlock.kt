...
private constructor(
    ...
    fun toParam(): WebFetchToolResultErrorBlockParam =
        WebFetchToolResultErrorBlockParam.builder().errorCode(_errorCode()).build()
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): WebFetchToolResultErrorBlock =
    ...
    fun validate(): WebFetchToolResultErrorBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebFetchToolResultErrorBlock &&
    ...
    override fun toString() =
        "WebFetchToolResultErrorBlock{errorCode=$errorCode, type=$type, additionalProperties=$additionalProperties}"
}
