...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitTextEditorCodeExecutionToolResultError(TextEditorCodeExecutionToolResultError textEditorCodeExecutionToolResultError) {
         *         return Optional.of(textEditorCodeExecutionToolResultError.toString());
         *     }
         *
         *     // ...
         *
