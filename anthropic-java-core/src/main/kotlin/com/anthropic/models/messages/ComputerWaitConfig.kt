...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerWaitConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerWaitConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerWaitConfig: ComputerWaitConfig) = apply {
            deferLoading = computerWaitConfig.deferLoading
            enabled = computerWaitConfig.enabled
            additionalProperties = computerWaitConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerWaitConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerWaitConfig =
            ComputerWaitConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerWaitConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerWaitConfig &&
    ...
    override fun toString() =
        "ComputerWaitConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
