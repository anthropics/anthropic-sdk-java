...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmSynthetic
        internal fun of(value: JsonField<String>): WebFetchToolResultErrorCode =
            value.asString().getOrNull()?.let { of(it) } ?: WebFetchToolResultErrorCode(value)
    }
    ...
    /**
     * An enum containing [WebFetchToolResultErrorCode]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [WebFetchToolResultErrorCode] can contain an unknown value in a couple of
     * cases:
     ...
     *   expected type.
     */
    fun validate(): WebFetchToolResultErrorCode = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebFetchToolResultErrorCode && value == other.value
    }
