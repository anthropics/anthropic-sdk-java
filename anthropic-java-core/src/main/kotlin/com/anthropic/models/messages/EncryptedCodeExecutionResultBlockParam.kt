...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = encryptedCodeExecutionResultBlockParam.type
            additionalProperties =
                encryptedCodeExecutionResultBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): EncryptedCodeExecutionResultBlockParam =
            EncryptedCodeExecutionResultBlockParam(
    ...
    fun validate(): EncryptedCodeExecutionResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EncryptedCodeExecutionResultBlockParam &&
    ...
    override fun toString() =
        "EncryptedCodeExecutionResultBlockParam{content=$content, encryptedStdout=$encryptedStdout, returnCode=$returnCode, stderr=$stderr, type=$type, additionalProperties=$additionalProperties}"
}
