...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerTypeConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerTypeConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerTypeConfig: ComputerTypeConfig) = apply {
            deferLoading = computerTypeConfig.deferLoading
            enabled = computerTypeConfig.enabled
            additionalProperties = computerTypeConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerTypeConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerTypeConfig =
            ComputerTypeConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerTypeConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerTypeConfig &&
    ...
    override fun toString() =
        "ComputerTypeConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
