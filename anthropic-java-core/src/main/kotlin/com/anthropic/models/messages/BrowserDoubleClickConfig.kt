...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserDoubleClickConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserDoubleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserDoubleClickConfig: BrowserDoubleClickConfig) = apply {
            deferLoading = browserDoubleClickConfig.deferLoading
            enabled = browserDoubleClickConfig.enabled
            additionalProperties = browserDoubleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserDoubleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserDoubleClickConfig =
            BrowserDoubleClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserDoubleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserDoubleClickConfig &&
    ...
    override fun toString() =
        "BrowserDoubleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
