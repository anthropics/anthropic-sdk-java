...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserHoldKeyConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserHoldKeyConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserHoldKeyConfig: BrowserHoldKeyConfig) = apply {
            deferLoading = browserHoldKeyConfig.deferLoading
            enabled = browserHoldKeyConfig.enabled
            additionalProperties = browserHoldKeyConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserHoldKeyConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserHoldKeyConfig =
            BrowserHoldKeyConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserHoldKeyConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserHoldKeyConfig &&
    ...
    override fun toString() =
        "BrowserHoldKeyConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
