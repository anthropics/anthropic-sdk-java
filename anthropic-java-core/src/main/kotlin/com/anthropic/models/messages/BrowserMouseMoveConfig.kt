...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserMouseMoveConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserMouseMoveConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserMouseMoveConfig: BrowserMouseMoveConfig) = apply {
            deferLoading = browserMouseMoveConfig.deferLoading
            enabled = browserMouseMoveConfig.enabled
            additionalProperties = browserMouseMoveConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserMouseMoveConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserMouseMoveConfig =
            BrowserMouseMoveConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserMouseMoveConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserMouseMoveConfig &&
    ...
    override fun toString() =
        "BrowserMouseMoveConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
