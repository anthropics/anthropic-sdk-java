...
private constructor(
    ...
    fun toParam(): ContainerUploadBlockParam =
        ContainerUploadBlockParam.builder().fileId(_fileId()).build()
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [ContainerUploadBlock] with the required [fileId] set to
         * the given value.
         */
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): ContainerUploadBlock =
     ...
     *   expected type.
     */
    fun validate(): ContainerUploadBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContainerUploadBlock &&
            fileId == other.fileId &&
            type == other.type &&
    ...
    override fun toString() =
        "ContainerUploadBlock{fileId=$fileId, type=$type, additionalProperties=$additionalProperties}"
}
