...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BrowserStateChangeTabOpened].
         *
        ...
        /**
         * Returns an immutable instance of [BrowserStateChangeTabOpened] with the required [tabId]
         * set to the given value.
         */
        @JvmStatic fun of(tabId: String) = builder().tabId(tabId).build()
    }

    /** A builder for [BrowserStateChangeTabOpened]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserStateChangeTabOpened: BrowserStateChangeTabOpened) = apply {
            tabId = browserStateChangeTabOpened.tabId
            type = browserStateChangeTabOpened.type
            additionalProperties = browserStateChangeTabOpened.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserStateChangeTabOpened].
         *
         ...
         */
        fun build(): BrowserStateChangeTabOpened =
     ...
     *   expected type.
     */
    fun validate(): BrowserStateChangeTabOpened = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserStateChangeTabOpened &&
            tabId == other.tabId &&
            type == other.type &&
    ...
    override fun toString() =
        "BrowserStateChangeTabOpened{tabId=$tabId, type=$type, additionalProperties=$additionalProperties}"
}
