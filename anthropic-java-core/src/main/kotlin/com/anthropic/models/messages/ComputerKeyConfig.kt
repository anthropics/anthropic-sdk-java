...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerKeyConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerKeyConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerKeyConfig: ComputerKeyConfig) = apply {
            deferLoading = computerKeyConfig.deferLoading
            enabled = computerKeyConfig.enabled
            additionalProperties = computerKeyConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerKeyConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerKeyConfig =
            ComputerKeyConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerKeyConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerKeyConfig &&
    ...
    override fun toString() =
        "ComputerKeyConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
