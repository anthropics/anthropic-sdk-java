...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserListTabsConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserListTabsConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserListTabsConfig: BrowserListTabsConfig) = apply {
            deferLoading = browserListTabsConfig.deferLoading
            enabled = browserListTabsConfig.enabled
            additionalProperties = browserListTabsConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserListTabsConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserListTabsConfig =
            BrowserListTabsConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserListTabsConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserListTabsConfig &&
    ...
    override fun toString() =
        "BrowserListTabsConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
