...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserSwitchTabConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserSwitchTabConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserSwitchTabConfig: BrowserSwitchTabConfig) = apply {
            deferLoading = browserSwitchTabConfig.deferLoading
            enabled = browserSwitchTabConfig.enabled
            additionalProperties = browserSwitchTabConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserSwitchTabConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserSwitchTabConfig =
            BrowserSwitchTabConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserSwitchTabConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserSwitchTabConfig &&
    ...
    override fun toString() =
        "BrowserSwitchTabConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
