...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            content = bashCodeExecutionToolResultBlockParam.content
            toolUseId = bashCodeExecutionToolResultBlockParam.toolUseId
            type = bashCodeExecutionToolResultBlockParam.type
            cacheControl = bashCodeExecutionToolResultBlockParam.cacheControl
            additionalProperties =
                bashCodeExecutionToolResultBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun content(bashCodeExecutionToolResultErrorParam: BashCodeExecutionToolResultErrorParam) =
            content(
                Content.ofBashCodeExecutionToolResultErrorParam(
                    bashCodeExecutionToolResultErrorParam
                )
            )

        /** Alias for calling [content] with `bashCodeExecutionToolResultErrorParam.toParam()`. */
        fun content(bashCodeExecutionToolResultErrorParam: BashCodeExecutionToolResultError) =
            content(bashCodeExecutionToolResultErrorParam.toParam())

        /**
         * Alias for calling [content] with
         * `Content.ofBashCodeExecutionResultBlockParam(bashCodeExecutionResultBlockParam)`.
         */
        fun content(bashCodeExecutionResultBlockParam: BashCodeExecutionResultBlockParam) =
            content(Content.ofBashCodeExecutionResultBlockParam(bashCodeExecutionResultBlockParam))

        /** Alias for calling [content] with `bashCodeExecutionResultBlockParam.toParam()`. */
        fun content(bashCodeExecutionResultBlockParam: BashCodeExecutionResultBlock) =
            content(bashCodeExecutionResultBlockParam.toParam())
         ...
         */
        fun build(): BashCodeExecutionToolResultBlockParam =
            BashCodeExecutionToolResultBlockParam(
     ...
     *   expected type.
     */
    fun validate(): BashCodeExecutionToolResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    class Content
    private constructor(
        private val bashCodeExecutionToolResultErrorParam: BashCodeExecutionToolResultErrorParam? =
            null,
        private val bashCodeExecutionResultBlockParam: BashCodeExecutionResultBlockParam? = null,
        ...
        fun isBashCodeExecutionResultBlockParam(): Boolean =
            bashCodeExecutionResultBlockParam != null

        fun asBashCodeExecutionToolResultErrorParam(): BashCodeExecutionToolResultErrorParam =
            bashCodeExecutionToolResultErrorParam.getOrThrow(
                "bashCodeExecutionToolResultErrorParam"
            )
         ...
         *     @Override
         *     public Optional<String> visitBashCodeExecutionToolResultErrorParam(BashCodeExecutionToolResultErrorParam bashCodeExecutionToolResultErrorParam) {
         *         return Optional.of(bashCodeExecutionToolResultErrorParam.toString());
         *     }
         *
         *     // ...
         *
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                bashCodeExecutionToolResultErrorParam != null ->
                    visitor.visitBashCodeExecutionToolResultErrorParam(
                        bashCodeExecutionToolResultErrorParam
                    )
                bashCodeExecutionResultBlockParam != null ->
                    visitor.visitBashCodeExecutionResultBlockParam(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Content &&
                bashCodeExecutionToolResultErrorParam ==
                    other.bashCodeExecutionToolResultErrorParam &&
                bashCodeExecutionResultBlockParam == other.bashCodeExecutionResultBlockParam
        }
        ...
        override fun toString(): String =
            when {
                bashCodeExecutionToolResultErrorParam != null ->
                    "Content{bashCodeExecutionToolResultErrorParam=$bashCodeExecutionToolResultErrorParam}"
                bashCodeExecutionResultBlockParam != null ->
                    "Content{bashCodeExecutionResultBlockParam=$bashCodeExecutionResultBlockParam}"
        ...
        interface Visitor<out T> {
            ...
            fun visitBashCodeExecutionToolResultErrorParam(
                bashCodeExecutionToolResultErrorParam: BashCodeExecutionToolResultErrorParam
            ): T

            fun visitBashCodeExecutionResultBlockParam(
                bashCodeExecutionResultBlockParam: BashCodeExecutionResultBlockParam
            ): T
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(
                                ...
                                ?.let {
                                    Content(
                                        bashCodeExecutionToolResultErrorParam = it,
                                        _json = json,
                                    )
                                },
                            tryDeserialize(
                                ...
                                ?.let {
                                    Content(bashCodeExecutionResultBlockParam = it, _json = json)
                                },
                        )
                        .filterNotNull()
        ...
        internal class Serializer : BaseSerializer<Content>(Content::class) {
            ...
            override fun serialize(
                ...
                when {
                    value.bashCodeExecutionToolResultErrorParam != null ->
                        generator.writeObject(value.bashCodeExecutionToolResultErrorParam)
                    value.bashCodeExecutionResultBlockParam != null ->
                        generator.writeObject(value.bashCodeExecutionResultBlockParam)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BashCodeExecutionToolResultBlockParam &&
    ...
    override fun toString() =
        "BashCodeExecutionToolResultBlockParam{content=$content, toolUseId=$toolUseId, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
