...
private constructor(
    ...
    fun toParam(): BashCodeExecutionOutputBlockParam =
        BashCodeExecutionOutputBlockParam.builder().fileId(_fileId()).build()
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BashCodeExecutionOutputBlock] with the required
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(bashCodeExecutionOutputBlock: BashCodeExecutionOutputBlock) = apply {
            fileId = bashCodeExecutionOutputBlock.fileId
            type = bashCodeExecutionOutputBlock.type
            additionalProperties = bashCodeExecutionOutputBlock.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BashCodeExecutionOutputBlock =
     ...
     *   expected type.
     */
    fun validate(): BashCodeExecutionOutputBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BashCodeExecutionOutputBlock &&
            fileId == other.fileId &&
            type == other.type &&
    ...
    override fun toString() =
        "BashCodeExecutionOutputBlock{fileId=$fileId, type=$type, additionalProperties=$additionalProperties}"
}
