...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserReadPageConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserReadPageConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserReadPageConfig: BrowserReadPageConfig) = apply {
            deferLoading = browserReadPageConfig.deferLoading
            enabled = browserReadPageConfig.enabled
            additionalProperties = browserReadPageConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserReadPageConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserReadPageConfig =
            BrowserReadPageConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserReadPageConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserReadPageConfig &&
    ...
    override fun toString() =
        "BrowserReadPageConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
