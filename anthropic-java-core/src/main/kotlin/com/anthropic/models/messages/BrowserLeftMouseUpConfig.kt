...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserLeftMouseUpConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserLeftMouseUpConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserLeftMouseUpConfig: BrowserLeftMouseUpConfig) = apply {
            deferLoading = browserLeftMouseUpConfig.deferLoading
            enabled = browserLeftMouseUpConfig.enabled
            additionalProperties = browserLeftMouseUpConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserLeftMouseUpConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserLeftMouseUpConfig =
            BrowserLeftMouseUpConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserLeftMouseUpConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserLeftMouseUpConfig &&
    ...
    override fun toString() =
        "BrowserLeftMouseUpConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
