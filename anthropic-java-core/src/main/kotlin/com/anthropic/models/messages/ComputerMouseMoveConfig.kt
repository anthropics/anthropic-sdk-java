...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerMouseMoveConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerMouseMoveConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerMouseMoveConfig: ComputerMouseMoveConfig) = apply {
            deferLoading = computerMouseMoveConfig.deferLoading
            enabled = computerMouseMoveConfig.enabled
            additionalProperties = computerMouseMoveConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerMouseMoveConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerMouseMoveConfig =
            ComputerMouseMoveConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerMouseMoveConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerMouseMoveConfig &&
    ...
    override fun toString() =
        "ComputerMouseMoveConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
