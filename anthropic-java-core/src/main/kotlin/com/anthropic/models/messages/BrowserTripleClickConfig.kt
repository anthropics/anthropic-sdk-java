...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserTripleClickConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserTripleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserTripleClickConfig: BrowserTripleClickConfig) = apply {
            deferLoading = browserTripleClickConfig.deferLoading
            enabled = browserTripleClickConfig.enabled
            additionalProperties = browserTripleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserTripleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserTripleClickConfig =
            BrowserTripleClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserTripleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserTripleClickConfig &&
    ...
    override fun toString() =
        "BrowserTripleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
