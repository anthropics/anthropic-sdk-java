...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserNewTabConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserNewTabConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserNewTabConfig: BrowserNewTabConfig) = apply {
            deferLoading = browserNewTabConfig.deferLoading
            enabled = browserNewTabConfig.enabled
            additionalProperties = browserNewTabConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserNewTabConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserNewTabConfig =
            BrowserNewTabConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserNewTabConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserNewTabConfig &&
    ...
    override fun toString() =
        "BrowserNewTabConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
