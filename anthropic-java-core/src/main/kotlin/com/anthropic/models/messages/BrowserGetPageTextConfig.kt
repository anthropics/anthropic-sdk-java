...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserGetPageTextConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserGetPageTextConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserGetPageTextConfig: BrowserGetPageTextConfig) = apply {
            deferLoading = browserGetPageTextConfig.deferLoading
            enabled = browserGetPageTextConfig.enabled
            additionalProperties = browserGetPageTextConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserGetPageTextConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserGetPageTextConfig =
            BrowserGetPageTextConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserGetPageTextConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserGetPageTextConfig &&
    ...
    override fun toString() =
        "BrowserGetPageTextConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
