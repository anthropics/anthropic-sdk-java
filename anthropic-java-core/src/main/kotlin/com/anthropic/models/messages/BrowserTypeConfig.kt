...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserTypeConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserTypeConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserTypeConfig: BrowserTypeConfig) = apply {
            deferLoading = browserTypeConfig.deferLoading
            enabled = browserTypeConfig.enabled
            additionalProperties = browserTypeConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserTypeConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserTypeConfig =
            BrowserTypeConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserTypeConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserTypeConfig &&
    ...
    override fun toString() =
        "BrowserTypeConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
