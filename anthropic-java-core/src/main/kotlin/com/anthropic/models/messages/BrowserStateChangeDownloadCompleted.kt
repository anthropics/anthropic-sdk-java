...
private constructor(
    ...
    /** A builder for [BrowserStateChangeDownloadCompleted]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            downloadId = browserStateChangeDownloadCompleted.downloadId
            type = browserStateChangeDownloadCompleted.type
            url = browserStateChangeDownloadCompleted.url
            path = browserStateChangeDownloadCompleted.path
            sizeBytes = browserStateChangeDownloadCompleted.sizeBytes
            additionalProperties =
                browserStateChangeDownloadCompleted.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserStateChangeDownloadCompleted].
         *
         ...
         */
        fun build(): BrowserStateChangeDownloadCompleted =
            BrowserStateChangeDownloadCompleted(
     ...
     *   expected type.
     */
    fun validate(): BrowserStateChangeDownloadCompleted = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserStateChangeDownloadCompleted &&
    ...
    override fun toString() =
        "BrowserStateChangeDownloadCompleted{downloadId=$downloadId, type=$type, url=$url, path=$path, sizeBytes=$sizeBytes, additionalProperties=$additionalProperties}"
}
