...
private constructor(
    private val content: JsonField<CodeExecutionToolResultBlockContent>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        content: JsonField<CodeExecutionToolResultBlockContent> = JsonMissing.of(),
    ...
    fun toParam(): CodeExecutionToolResultBlockParam =
     ...
     */
    fun content(): CodeExecutionToolResultBlockContent = content.getRequired("content")
    ...
    @JsonProperty("content")
    @ExcludeMissing
    fun _content(): JsonField<CodeExecutionToolResultBlockContent> = content
    ...
    class Builder internal constructor() {
        ...
        private var content: JsonField<CodeExecutionToolResultBlockContent>? = null
        ...
        internal fun from(codeExecutionToolResultBlock: CodeExecutionToolResultBlock) = apply {
            ...
            additionalProperties = codeExecutionToolResultBlock.additionalProperties.toMutableMap()
        }

        /** Code execution result with encrypted stdout for PFC + web_search results. */
        fun content(content: CodeExecutionToolResultBlockContent) = content(JsonField.of(content))

        /**
         * Sets [Builder.content] to an arbitrary JSON value.
         *
         * You should usually call [Builder.content] with a well-typed
         * [CodeExecutionToolResultBlockContent] value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun content(content: JsonField<CodeExecutionToolResultBlockContent>) = apply {
            this.content = content
        }

        /**
         * Alias for calling [content] with `CodeExecutionToolResultBlockContent.ofError(error)`.
         */
        fun content(error: CodeExecutionToolResultError) =
            content(CodeExecutionToolResultBlockContent.ofError(error))

        /**
         * Alias for calling [content] with
         * `CodeExecutionToolResultBlockContent.ofResultBlock(resultBlock)`.
         */
        fun content(resultBlock: CodeExecutionResultBlock) =
            content(CodeExecutionToolResultBlockContent.ofResultBlock(resultBlock))

        /**
         * Alias for calling [content] with
         * `CodeExecutionToolResultBlockContent.ofEncryptedCodeExecutionResultBlock(encryptedCodeExecutionResultBlock)`.
         */
        fun content(encryptedCodeExecutionResultBlock: EncryptedCodeExecutionResultBlock) =
            content(
         ...
         */
        fun build(): CodeExecutionToolResultBlock =
    ...
    fun validate(): CodeExecutionToolResultBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CodeExecutionToolResultBlock &&
    ...
    override fun toString() =
        "CodeExecutionToolResultBlock{content=$content, toolUseId=$toolUseId, type=$type, additionalProperties=$additionalProperties}"
}
