...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerScrollConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerScrollConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerScrollConfig: ComputerScrollConfig) = apply {
            deferLoading = computerScrollConfig.deferLoading
            enabled = computerScrollConfig.enabled
            additionalProperties = computerScrollConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerScrollConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerScrollConfig =
            ComputerScrollConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerScrollConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerScrollConfig &&
    ...
    override fun toString() =
        "ComputerScrollConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
