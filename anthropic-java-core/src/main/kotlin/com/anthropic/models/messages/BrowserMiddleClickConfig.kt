...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserMiddleClickConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserMiddleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserMiddleClickConfig: BrowserMiddleClickConfig) = apply {
            deferLoading = browserMiddleClickConfig.deferLoading
            enabled = browserMiddleClickConfig.enabled
            additionalProperties = browserMiddleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserMiddleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserMiddleClickConfig =
            BrowserMiddleClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserMiddleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserMiddleClickConfig &&
    ...
    override fun toString() =
        "BrowserMiddleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
