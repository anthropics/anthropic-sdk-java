...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserFindConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserFindConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserFindConfig: BrowserFindConfig) = apply {
            deferLoading = browserFindConfig.deferLoading
            enabled = browserFindConfig.enabled
            additionalProperties = browserFindConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserFindConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserFindConfig =
            BrowserFindConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserFindConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserFindConfig &&
    ...
    override fun toString() =
        "BrowserFindConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
