...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserKeyConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserKeyConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserKeyConfig: BrowserKeyConfig) = apply {
            deferLoading = browserKeyConfig.deferLoading
            enabled = browserKeyConfig.enabled
            additionalProperties = browserKeyConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserKeyConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserKeyConfig =
            BrowserKeyConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserKeyConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserKeyConfig &&
    ...
    override fun toString() =
        "BrowserKeyConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
