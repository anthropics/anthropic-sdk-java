...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BrowserReadNetworkConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BrowserReadNetworkConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(browserReadNetworkConfig: BrowserReadNetworkConfig) = apply {
            deferLoading = browserReadNetworkConfig.deferLoading
            enabled = browserReadNetworkConfig.enabled
            additionalProperties = browserReadNetworkConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BrowserReadNetworkConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BrowserReadNetworkConfig =
            BrowserReadNetworkConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BrowserReadNetworkConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BrowserReadNetworkConfig &&
    ...
    override fun toString() =
        "BrowserReadNetworkConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
