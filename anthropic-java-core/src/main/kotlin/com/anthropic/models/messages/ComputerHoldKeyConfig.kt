...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ComputerHoldKeyConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ComputerHoldKeyConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(computerHoldKeyConfig: ComputerHoldKeyConfig) = apply {
            deferLoading = computerHoldKeyConfig.deferLoading
            enabled = computerHoldKeyConfig.enabled
            additionalProperties = computerHoldKeyConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ComputerHoldKeyConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ComputerHoldKeyConfig =
            ComputerHoldKeyConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): ComputerHoldKeyConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ComputerHoldKeyConfig &&
    ...
    override fun toString() =
        "ComputerHoldKeyConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
