...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BashCodeExecutionOutputBlockParam] with the required
    ...
    class Builder internal constructor() {
        ...
        internal fun from(bashCodeExecutionOutputBlockParam: BashCodeExecutionOutputBlockParam) =
            apply {
                ...
                additionalProperties =
                    bashCodeExecutionOutputBlockParam.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BashCodeExecutionOutputBlockParam =
            BashCodeExecutionOutputBlockParam(
     ...
     *   expected type.
     */
    fun validate(): BashCodeExecutionOutputBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BashCodeExecutionOutputBlockParam &&
            fileId == other.fileId &&
            type == other.type &&
    ...
    override fun toString() =
        "BashCodeExecutionOutputBlockParam{fileId=$fileId, type=$type, additionalProperties=$additionalProperties}"
}
