...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContainerSkill].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(containerSkill: ContainerSkill) = apply {
            skillId = containerSkill.skillId
            type = containerSkill.type
            version = containerSkill.version
            additionalProperties = containerSkill.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ContainerSkill].
         *
     ...
     *   expected type.
     */
    fun validate(): ContainerSkill = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContainerSkill &&
    ...
    override fun toString() =
        "ContainerSkill{skillId=$skillId, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
