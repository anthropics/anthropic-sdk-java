...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [ToolReferenceBlockParam] with the required [toolName]
    ...
    class Builder internal constructor() {
        ...
        internal fun from(toolReferenceBlockParam: ToolReferenceBlockParam) = apply {
            ...
            additionalProperties = toolReferenceBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ToolReferenceBlockParam =
     ...
     *   expected type.
     */
    fun validate(): ToolReferenceBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ToolReferenceBlockParam &&
    ...
    override fun toString() =
        "ToolReferenceBlockParam{toolName=$toolName, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
