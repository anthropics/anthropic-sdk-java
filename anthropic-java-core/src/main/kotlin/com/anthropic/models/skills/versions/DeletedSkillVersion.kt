...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [DeletedSkillVersion] with the required [id] set to the
         * given value.
         */
    ...
    class Builder internal constructor() {
        ...
        fun build(): DeletedSkillVersion =
            DeletedSkillVersion(checkRequired("id", id), type, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "DeletedSkillVersion{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
