...
private constructor(
    ...
    private val source: JsonField<SkillSource>,
    ...
    private constructor(
        ...
        @JsonProperty("source") @ExcludeMissing source: JsonField<SkillSource> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun source(): SkillSource = source.getRequired("source")
     ...
     */
    @JsonProperty("source") @ExcludeMissing fun _source(): JsonField<SkillSource> = source
    ...
    class Builder internal constructor() {
        ...
        private var source: JsonField<SkillSource>? = null
         ...
         * * `"plugin"`: resolved from an installed plugin
         */
        fun source(source: SkillSource) = source(JsonField.of(source))

        /**
         * Sets [Builder.source] to an arbitrary JSON value.
         *
         * You should usually call [Builder.source] with a well-typed [SkillSource] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun source(source: JsonField<SkillSource>) = apply { this.source = source }
    ...
    override fun toString() =
        "Skill{id=$id, createdAt=$createdAt, displayName=$displayName, latestVersionId=$latestVersionId, source=$source, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
