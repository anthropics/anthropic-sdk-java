...
private constructor(
    private val data: JsonField<List<SkillVersion>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<SkillVersion>> = JsonMissing.of(),
     ...
     */
    fun data(): List<SkillVersion> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<SkillVersion>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<SkillVersion>>? = null
        ...
        /** List of skills. */
        fun data(data: List<SkillVersion>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<SkillVersion>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<SkillVersion>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [SkillVersion] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: SkillVersion) = apply {
            this.data =
