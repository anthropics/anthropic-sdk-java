...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = betaManagedAgentsVaultNotFoundRunError.message
            type = betaManagedAgentsVaultNotFoundRunError.type
            additionalProperties =
                betaManagedAgentsVaultNotFoundRunError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsVaultNotFoundRunError =
            BetaManagedAgentsVaultNotFoundRunError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsVaultNotFoundRunError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsVaultNotFoundRunError &&
    ...
    override fun toString() =
        "BetaManagedAgentsVaultNotFoundRunError{message=$message, type=$type, additionalProperties=$additionalProperties}"
}
