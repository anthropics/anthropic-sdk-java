...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsGlobToolConfig]. */
    class Builder internal constructor() {

        private var enabled: JsonField<Boolean>? = null
        private var name: JsonValue = JsonValue.from("glob")
        private var permissionPolicy: JsonField<PermissionPolicy>? = null
        private var type: JsonValue = JsonValue.from("glob")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaManagedAgentsGlobToolConfig: BetaManagedAgentsGlobToolConfig) =
            apply {
                enabled = betaManagedAgentsGlobToolConfig.enabled
                name = betaManagedAgentsGlobToolConfig.name
                permissionPolicy = betaManagedAgentsGlobToolConfig.permissionPolicy
                type = betaManagedAgentsGlobToolConfig.type
                additionalProperties =
                    betaManagedAgentsGlobToolConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsGlobToolConfig].
         *
         ...
         */
        fun build(): BetaManagedAgentsGlobToolConfig =
            BetaManagedAgentsGlobToolConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsGlobToolConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (enabled.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("glob")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsGlobToolConfig &&
    ...
    override fun toString() =
        "BetaManagedAgentsGlobToolConfig{enabled=$enabled, name=$name, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
