...
private constructor(
    private val data: JsonField<List<BetaWorkspaceRateLimit>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaWorkspaceRateLimit>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaWorkspaceRateLimit> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<BetaWorkspaceRateLimit>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BetaWorkspaceRateLimit>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaWorkspaceRateLimit>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<BetaWorkspaceRateLimit>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaWorkspaceRateLimit] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaWorkspaceRateLimit) = apply {
            this.data =
