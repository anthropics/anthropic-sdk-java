...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserCloseTabConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserCloseTabConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserCloseTabConfig: BetaBrowserCloseTabConfig) = apply {
            deferLoading = betaBrowserCloseTabConfig.deferLoading
            enabled = betaBrowserCloseTabConfig.enabled
            additionalProperties = betaBrowserCloseTabConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserCloseTabConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserCloseTabConfig =
            BetaBrowserCloseTabConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserCloseTabConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserCloseTabConfig &&
    ...
    override fun toString() =
        "BetaBrowserCloseTabConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
