...
private constructor(
    ...
    /**
     * Anthropic-assigned hostname for the tunnel. MCP server URLs whose host is a subdomain of this
     * value are routed through the tunnel. Globally unique and never reused, even after the tunnel
     * is archived.
     *
     * @throws AnthropicInvalidDataException if the JSON field has an unexpected type or is
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaTunnel].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaTunnel: BetaTunnel) = apply {
            id = betaTunnel.id
            archivedAt = betaTunnel.archivedAt
        ...
        /**
         * Anthropic-assigned hostname for the tunnel. MCP server URLs whose host is a subdomain of
         * this value are routed through the tunnel. Globally unique and never reused, even after
         * the tunnel is archived.
         */
        ...
        /**
         * Returns an immutable instance of [BetaTunnel].
         *
