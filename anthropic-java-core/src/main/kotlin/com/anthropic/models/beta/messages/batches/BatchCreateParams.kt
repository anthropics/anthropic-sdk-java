...
import com.anthropic.models.beta.messages.BetaToolSearchToolBm25_20251119
...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
             ...
             *   if the server responded with an unexpected value).
             */
            fun outputConfig(): Optional<BetaOutputConfig> =
            ...
            class Builder internal constructor() {
                 ...
                 * [BetaCacheControlEphemeral] value instead. This method is primarily for setting
                 ...
                 * [FallbackCreditToken] value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                fun fallbackCreditToken(fallbackCreditToken: JsonField<FallbackCreditToken>) =
                    apply {
                 ...
                 * `FallbackCreditToken.ofString(string)`.
                 */
                ...
                fun fallbackCreditToken(
                    ...
                    fallbackCreditToken(
                        FallbackCreditToken.ofBetaFallbackCreditTokenParam(
                 ...
                 * [BetaFallbacksParam] value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                 ...
                 * [BetaOutputConfig] value instead. This method is primarily for setting the field
            ...
            private constructor(
                 ...
                 * equivalent (both select ``strict``), so wrapping an existing token changes
                 * nothing by itself.
                 */
                ...
                companion object {
                     ...
                     * object are equivalent (both select ``strict``), so wrapping an existing token
                ...
                /**
                 * An interface that defines how to map each variant of [FallbackCreditToken] to a
                 * value of type [T].
                 */
                interface Visitor<out T> {
