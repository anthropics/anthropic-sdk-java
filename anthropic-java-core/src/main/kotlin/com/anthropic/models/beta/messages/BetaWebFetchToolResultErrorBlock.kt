...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaWebFetchToolResultErrorBlock] with the required
         * [errorCode] set to the given value.
         */
        @JvmStatic
        fun of(errorCode: BetaWebFetchToolResultErrorCode) = builder().errorCode(errorCode).build()
    }
