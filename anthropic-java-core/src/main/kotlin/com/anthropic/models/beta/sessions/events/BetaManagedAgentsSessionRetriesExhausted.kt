...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsSessionRetriesExhausted] with the
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = betaManagedAgentsSessionRetriesExhausted.type
            additionalProperties =
                betaManagedAgentsSessionRetriesExhausted.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSessionRetriesExhausted =
            BetaManagedAgentsSessionRetriesExhausted(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSessionRetriesExhausted = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSessionRetriesExhausted &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaManagedAgentsSessionRetriesExhausted{type=$type, additionalProperties=$additionalProperties}"
}
