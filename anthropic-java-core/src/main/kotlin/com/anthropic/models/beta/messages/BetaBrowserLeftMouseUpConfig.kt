...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserLeftMouseUpConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserLeftMouseUpConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserLeftMouseUpConfig: BetaBrowserLeftMouseUpConfig) = apply {
            deferLoading = betaBrowserLeftMouseUpConfig.deferLoading
            enabled = betaBrowserLeftMouseUpConfig.enabled
            additionalProperties = betaBrowserLeftMouseUpConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserLeftMouseUpConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserLeftMouseUpConfig =
            BetaBrowserLeftMouseUpConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserLeftMouseUpConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserLeftMouseUpConfig &&
    ...
    override fun toString() =
        "BetaBrowserLeftMouseUpConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
