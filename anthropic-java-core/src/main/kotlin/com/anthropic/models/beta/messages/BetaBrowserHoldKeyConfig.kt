...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserHoldKeyConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserHoldKeyConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserHoldKeyConfig: BetaBrowserHoldKeyConfig) = apply {
            deferLoading = betaBrowserHoldKeyConfig.deferLoading
            enabled = betaBrowserHoldKeyConfig.enabled
            additionalProperties = betaBrowserHoldKeyConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserHoldKeyConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserHoldKeyConfig =
            BetaBrowserHoldKeyConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserHoldKeyConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserHoldKeyConfig &&
    ...
    override fun toString() =
        "BetaBrowserHoldKeyConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
