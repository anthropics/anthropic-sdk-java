...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsCronSchedule: BetaManagedAgentsCronSchedule) = apply {
            expression = betaManagedAgentsCronSchedule.expression
            timezone = betaManagedAgentsCronSchedule.timezone
            type = betaManagedAgentsCronSchedule.type
            lastRunAt = betaManagedAgentsCronSchedule.lastRunAt
            upcomingRunsAt =
                betaManagedAgentsCronSchedule.upcomingRunsAt
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            additionalProperties = betaManagedAgentsCronSchedule.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsCronSchedule =
            BetaManagedAgentsCronSchedule(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsCronSchedule = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsCronSchedule &&
    ...
    override fun toString() =
        "BetaManagedAgentsCronSchedule{expression=$expression, timezone=$timezone, type=$type, lastRunAt=$lastRunAt, upcomingRunsAt=$upcomingRunsAt, additionalProperties=$additionalProperties}"
}
