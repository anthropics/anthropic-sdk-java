...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserMiddleClickConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserMiddleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserMiddleClickConfig: BetaBrowserMiddleClickConfig) = apply {
            deferLoading = betaBrowserMiddleClickConfig.deferLoading
            enabled = betaBrowserMiddleClickConfig.enabled
            additionalProperties = betaBrowserMiddleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserMiddleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserMiddleClickConfig =
            BetaBrowserMiddleClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserMiddleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserMiddleClickConfig &&
    ...
    override fun toString() =
        "BetaBrowserMiddleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
