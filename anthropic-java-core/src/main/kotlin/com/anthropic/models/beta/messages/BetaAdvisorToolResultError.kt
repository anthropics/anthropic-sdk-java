...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaAdvisorToolResultError: BetaAdvisorToolResultError) = apply {
            errorCode = betaAdvisorToolResultError.errorCode
            type = betaAdvisorToolResultError.type
            additionalProperties = betaAdvisorToolResultError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaAdvisorToolResultError =
    ...
    fun validate(): BetaAdvisorToolResultError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaAdvisorToolResultError &&
    ...
    override fun toString() =
        "BetaAdvisorToolResultError{errorCode=$errorCode, type=$type, additionalProperties=$additionalProperties}"
}
