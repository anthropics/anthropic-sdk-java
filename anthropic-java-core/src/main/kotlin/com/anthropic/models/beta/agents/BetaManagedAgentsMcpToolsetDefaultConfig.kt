...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            enabled = betaManagedAgentsMcpToolsetDefaultConfig.enabled
            permissionPolicy = betaManagedAgentsMcpToolsetDefaultConfig.permissionPolicy
            additionalProperties =
                betaManagedAgentsMcpToolsetDefaultConfig.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsMcpToolsetDefaultConfig =
            BetaManagedAgentsMcpToolsetDefaultConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsMcpToolsetDefaultConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsMcpToolsetDefaultConfig &&
    ...
    override fun toString() =
        "BetaManagedAgentsMcpToolsetDefaultConfig{enabled=$enabled, permissionPolicy=$permissionPolicy, additionalProperties=$additionalProperties}"
}
