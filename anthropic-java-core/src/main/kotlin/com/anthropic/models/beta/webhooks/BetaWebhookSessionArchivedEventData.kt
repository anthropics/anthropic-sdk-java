...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.archived")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.archived")
        ...
        internal fun from(
            ...
            id = betaWebhookSessionArchivedEventData.id
            organizationId = betaWebhookSessionArchivedEventData.organizationId
            type = betaWebhookSessionArchivedEventData.type
            workspaceId = betaWebhookSessionArchivedEventData.workspaceId
            additionalProperties =
                betaWebhookSessionArchivedEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookSessionArchivedEventData =
            BetaWebhookSessionArchivedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionArchivedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.archived")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.archived")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionArchivedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionArchivedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
