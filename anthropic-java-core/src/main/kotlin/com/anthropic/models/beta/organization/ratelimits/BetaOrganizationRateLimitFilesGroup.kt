...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaOrganizationRateLimitFilesGroup] with the required
         * [id] set to the given value.
         */
        @JvmStatic fun of(id: String) = builder().id(id).build()
    }

    /** A builder for [BetaOrganizationRateLimitFilesGroup]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaOrganizationRateLimitFilesGroup.id
            type = betaOrganizationRateLimitFilesGroup.type
            additionalProperties =
                betaOrganizationRateLimitFilesGroup.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaOrganizationRateLimitFilesGroup].
         *
         ...
         */
        fun build(): BetaOrganizationRateLimitFilesGroup =
            BetaOrganizationRateLimitFilesGroup(
                checkRequired("id", id),
                type,
     ...
     *   expected type.
     */
    fun validate(): BetaOrganizationRateLimitFilesGroup = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaOrganizationRateLimitFilesGroup &&
            id == other.id &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaOrganizationRateLimitFilesGroup{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
