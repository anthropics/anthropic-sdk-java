...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaComputerScrollConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerScrollConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerScrollConfig: BetaComputerScrollConfig) = apply {
            deferLoading = betaComputerScrollConfig.deferLoading
            enabled = betaComputerScrollConfig.enabled
            additionalProperties = betaComputerScrollConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerScrollConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerScrollConfig =
            BetaComputerScrollConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerScrollConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerScrollConfig &&
    ...
    override fun toString() =
        "BetaComputerScrollConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
