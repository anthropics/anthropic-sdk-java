...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = betaManagedAgentsSkillNotFoundRunError.message
            type = betaManagedAgentsSkillNotFoundRunError.type
            additionalProperties =
                betaManagedAgentsSkillNotFoundRunError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSkillNotFoundRunError =
            BetaManagedAgentsSkillNotFoundRunError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSkillNotFoundRunError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSkillNotFoundRunError &&
    ...
    override fun toString() =
        "BetaManagedAgentsSkillNotFoundRunError{message=$message, type=$type, additionalProperties=$additionalProperties}"
}
