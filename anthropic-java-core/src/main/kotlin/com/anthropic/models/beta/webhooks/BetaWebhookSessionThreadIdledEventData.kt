...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.thread_idled")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                betaWebhookSessionThreadIdledEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookSessionThreadIdledEventData =
            BetaWebhookSessionThreadIdledEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionThreadIdledEventData = apply {
        if (validated) {
            return@apply
        }
