...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            expression = betaManagedAgentsCronScheduleParams.expression
            timezone = betaManagedAgentsCronScheduleParams.timezone
            type = betaManagedAgentsCronScheduleParams.type
            additionalProperties =
                betaManagedAgentsCronScheduleParams.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsCronScheduleParams =
            BetaManagedAgentsCronScheduleParams(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsCronScheduleParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsCronScheduleParams &&
    ...
    override fun toString() =
        "BetaManagedAgentsCronScheduleParams{expression=$expression, timezone=$timezone, type=$type, additionalProperties=$additionalProperties}"
}
