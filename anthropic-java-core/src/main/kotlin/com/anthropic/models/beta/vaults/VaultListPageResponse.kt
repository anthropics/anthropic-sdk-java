...
private constructor(
    private val data: JsonField<List<BetaManagedAgentsVault>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaManagedAgentsVault>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<BetaManagedAgentsVault>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<BetaManagedAgentsVault>> = data
    ...
    /** A builder for [VaultListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BetaManagedAgentsVault>>? = null
        ...
        /** List of vaults. */
        fun data(data: List<BetaManagedAgentsVault>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaManagedAgentsVault>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<BetaManagedAgentsVault>>) = apply {
         ...
         */
        fun addData(data: BetaManagedAgentsVault) = apply {
            this.data =
         ...
         */
        fun build(): VaultListPageResponse =
    ...
    fun validate(): VaultListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is VaultListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "VaultListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
