...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [BetaManagedAgentsDeploymentStatus]'s known values, as well as an
     * [_UNKNOWN] member.
     *
     * An instance of [BetaManagedAgentsDeploymentStatus] can contain an unknown value in a couple
     * of cases:
        ...
        when (this) {
            ...
            PAUSED -> Known.PAUSED
                ...
                throw AnthropicInvalidDataException(
                    "Unknown BetaManagedAgentsDeploymentStatus: $value"
                )
        }
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsDeploymentStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsDeploymentStatus && value == other.value
    }
