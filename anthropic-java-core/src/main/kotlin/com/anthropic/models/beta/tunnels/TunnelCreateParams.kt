...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TunnelCreateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TunnelCreateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TunnelCreateParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TunnelCreateParams].
         *
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(displayName, additionalProperties.toMutableMap())
        }
