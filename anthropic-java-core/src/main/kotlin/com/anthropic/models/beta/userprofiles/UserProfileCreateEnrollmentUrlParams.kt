...
class UserProfileCreateEnrollmentUrlParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UserProfileCreateEnrollmentUrlParams = builder().build()
    ...
    /** A builder for [UserProfileCreateEnrollmentUrlParams]. */
    class Builder internal constructor() {
         ...
         */
        fun build(): UserProfileCreateEnrollmentUrlParams =
            UserProfileCreateEnrollmentUrlParams(
                userProfileId,
                betas?.toImmutable(),
