...
private constructor(
    ...
    ) : this(toolUseId, type, content, isError, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            toolUseId = betaManagedAgentsUserToolResultEventParams.toolUseId
            type = betaManagedAgentsUserToolResultEventParams.type
            content = betaManagedAgentsUserToolResultEventParams.content.map { it.toMutableList() }
            isError = betaManagedAgentsUserToolResultEventParams.isError
            additionalProperties =
                betaManagedAgentsUserToolResultEventParams.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsUserToolResultEventParams =
            BetaManagedAgentsUserToolResultEventParams(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsUserToolResultEventParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsUserToolResultEventParams &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(toolUseId, type, content, isError, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsUserToolResultEventParams{toolUseId=$toolUseId, type=$type, content=$content, isError=$isError, additionalProperties=$additionalProperties}"
}
