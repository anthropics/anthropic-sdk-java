...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsSpanModelRequestStartEvent.id
            processedAt = betaManagedAgentsSpanModelRequestStartEvent.processedAt
            type = betaManagedAgentsSpanModelRequestStartEvent.type
            additionalProperties =
                betaManagedAgentsSpanModelRequestStartEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSpanModelRequestStartEvent =
            BetaManagedAgentsSpanModelRequestStartEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSpanModelRequestStartEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSpanModelRequestStartEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsSpanModelRequestStartEvent{id=$id, processedAt=$processedAt, type=$type, additionalProperties=$additionalProperties}"
}
