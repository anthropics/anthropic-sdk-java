...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(issuerRetrieveParams: IssuerRetrieveParams) = apply {
            ...
            betas = issuerRetrieveParams.betas?.toMutableList()
    ...
    override fun hashCode(): Int =
        Objects.hash(federationIssuerId, betas, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "IssuerRetrieveParams{federationIssuerId=$federationIssuerId, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
