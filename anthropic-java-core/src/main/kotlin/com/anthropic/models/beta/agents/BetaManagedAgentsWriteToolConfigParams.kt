...
private constructor(
    ...
    ) : this(name, enabled, permissionPolicy, type, mutableMapOf())
    ...
    /** A builder for [BetaManagedAgentsWriteToolConfigParams]. */
    class Builder internal constructor() {

        private var name: JsonValue = JsonValue.from("write")
        ...
        internal fun from(
            ...
            name = betaManagedAgentsWriteToolConfigParams.name
            enabled = betaManagedAgentsWriteToolConfigParams.enabled
            permissionPolicy = betaManagedAgentsWriteToolConfigParams.permissionPolicy
            type = betaManagedAgentsWriteToolConfigParams.type
            additionalProperties =
                betaManagedAgentsWriteToolConfigParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsWriteToolConfigParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaManagedAgentsWriteToolConfigParams =
            BetaManagedAgentsWriteToolConfigParams(
                name,
                enabled,
                permissionPolicy,
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsWriteToolConfigParams = apply {
        if (validated) {
            return@apply
        }

        _name().let {
            if (it != JsonValue.from("write")) {
    ...
    internal fun validity(): Int =
        name.let { if (it == JsonValue.from("write")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsWriteToolConfigParams &&
            name == other.name &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(name, enabled, permissionPolicy, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsWriteToolConfigParams{name=$name, enabled=$enabled, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
