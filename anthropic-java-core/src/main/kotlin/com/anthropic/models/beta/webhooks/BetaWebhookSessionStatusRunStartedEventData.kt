...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.status_run_started")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.status_run_started")
        ...
        internal fun from(
            ...
            id = betaWebhookSessionStatusRunStartedEventData.id
            organizationId = betaWebhookSessionStatusRunStartedEventData.organizationId
            type = betaWebhookSessionStatusRunStartedEventData.type
            workspaceId = betaWebhookSessionStatusRunStartedEventData.workspaceId
            additionalProperties =
                betaWebhookSessionStatusRunStartedEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookSessionStatusRunStartedEventData =
            BetaWebhookSessionStatusRunStartedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionStatusRunStartedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.status_run_started")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.status_run_started")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionStatusRunStartedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionStatusRunStartedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
