...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = betaManagedAgentsContentSha256Precondition.type
            contentSha256 = betaManagedAgentsContentSha256Precondition.contentSha256
            additionalProperties =
                betaManagedAgentsContentSha256Precondition.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsContentSha256Precondition =
            BetaManagedAgentsContentSha256Precondition(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsContentSha256Precondition = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsContentSha256Precondition &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaManagedAgentsContentSha256Precondition{type=$type, contentSha256=$contentSha256, additionalProperties=$additionalProperties}"
}
