...
private constructor(
    private val data: JsonField<List<BetaDream>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<BetaDream>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BetaDream>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DreamListPageResponse].
         *
    ...
    /** A builder for [DreamListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BetaDream>>? = null
        private var nextPage: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(dreamListPageResponse: DreamListPageResponse) = apply {
            data =
                dreamListPageResponse.data.map { it.toMutableList() }.takeUnless { it.isMissing() }
            nextPage = dreamListPageResponse.nextPage
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaDream>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<BetaDream>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaDream] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaDream) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [DreamListPageResponse].
         *
         ...
         */
        fun build(): DreamListPageResponse =
            DreamListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): DreamListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DreamListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "DreamListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
