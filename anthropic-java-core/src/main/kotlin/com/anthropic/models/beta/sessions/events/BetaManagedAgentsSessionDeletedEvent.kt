...
/**
 * Emitted when a session has been deleted. Terminates any active event stream — no further events
 * will be emitted for this session.
 */
...
private constructor(
    ...
    ) : this(id, processedAt, type, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsSessionDeletedEvent.id
            processedAt = betaManagedAgentsSessionDeletedEvent.processedAt
            type = betaManagedAgentsSessionDeletedEvent.type
            additionalProperties =
                betaManagedAgentsSessionDeletedEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSessionDeletedEvent =
            BetaManagedAgentsSessionDeletedEvent(
                checkRequired("id", id),
    ...
    fun validate(): BetaManagedAgentsSessionDeletedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSessionDeletedEvent &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy { Objects.hash(id, processedAt, type, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsSessionDeletedEvent{id=$id, processedAt=$processedAt, type=$type, additionalProperties=$additionalProperties}"
}
