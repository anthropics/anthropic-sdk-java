...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserMouseMoveConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserMouseMoveConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserMouseMoveConfig: BetaBrowserMouseMoveConfig) = apply {
            deferLoading = betaBrowserMouseMoveConfig.deferLoading
            enabled = betaBrowserMouseMoveConfig.enabled
            additionalProperties = betaBrowserMouseMoveConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserMouseMoveConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserMouseMoveConfig =
            BetaBrowserMouseMoveConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserMouseMoveConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserMouseMoveConfig &&
    ...
    override fun toString() =
        "BetaBrowserMouseMoveConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
