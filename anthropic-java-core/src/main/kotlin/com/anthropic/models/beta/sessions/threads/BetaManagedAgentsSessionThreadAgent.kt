...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                betaManagedAgentsSessionThreadAgent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSessionThreadAgent =
            BetaManagedAgentsSessionThreadAgent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSessionThreadAgent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSessionThreadAgent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsSessionThreadAgent{id=$id, description=$description, mcpServers=$mcpServers, model=$model, name=$name, skills=$skills, system=$system, tools=$tools, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
