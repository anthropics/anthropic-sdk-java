...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(workspaceRemoveResponse: WorkspaceRemoveResponse) = apply {
            serviceAccountId = workspaceRemoveResponse.serviceAccountId
    ...
    override fun toString() =
        "WorkspaceRemoveResponse{serviceAccountId=$serviceAccountId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
