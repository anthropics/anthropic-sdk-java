...
private constructor(
    ...
    /** A builder for [WorkRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(workRetrieveParams: WorkRetrieveParams) = apply {
            environmentId = workRetrieveParams.environmentId
            workId = workRetrieveParams.workId
            betas = workRetrieveParams.betas?.toMutableList()
            additionalHeaders = workRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = workRetrieveParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkRetrieveParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(environmentId, workId, betas, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "WorkRetrieveParams{environmentId=$environmentId, workId=$workId, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
