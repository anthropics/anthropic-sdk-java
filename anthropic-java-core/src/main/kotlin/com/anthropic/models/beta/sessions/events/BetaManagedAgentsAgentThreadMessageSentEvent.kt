...
private constructor(
    ...
    private val toSessionThreadId: JsonField<String>,
    private val type: JsonField<Type>,
    private val toAgentName: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("to_session_thread_id")
        @ExcludeMissing
        toSessionThreadId: JsonField<String> = JsonMissing.of(),
        @JsonProperty("type") @ExcludeMissing type: JsonField<Type> = JsonMissing.of(),
        @JsonProperty("to_agent_name")
        @ExcludeMissing
        toAgentName: JsonField<String> = JsonMissing.of(),
    ) : this(id, content, processedAt, toSessionThreadId, type, toAgentName, mutableMapOf())
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun toSessionThreadId(): String = toSessionThreadId.getRequired("to_session_thread_id")
     ...
     */
    fun toAgentName(): Optional<String> = toAgentName.getOptional("to_agent_name")
     ...
     *
     * Unlike [toSessionThreadId], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("to_session_thread_id")
    @ExcludeMissing
    fun _toSessionThreadId(): JsonField<String> = toSessionThreadId
    ...
    @JsonProperty("to_agent_name")
    @ExcludeMissing
    fun _toAgentName(): JsonField<String> = toAgentName
    ...
    class Builder internal constructor() {
        ...
        private var toSessionThreadId: JsonField<String>? = null
        private var type: JsonField<Type>? = null
        private var toAgentName: JsonField<String> = JsonMissing.of()
        ...
        internal fun from(
            ...
            id = betaManagedAgentsAgentThreadMessageSentEvent.id
            content =
                betaManagedAgentsAgentThreadMessageSentEvent.content.map { it.toMutableList() }
            processedAt = betaManagedAgentsAgentThreadMessageSentEvent.processedAt
            toSessionThreadId = betaManagedAgentsAgentThreadMessageSentEvent.toSessionThreadId
            type = betaManagedAgentsAgentThreadMessageSentEvent.type
            toAgentName = betaManagedAgentsAgentThreadMessageSentEvent.toAgentName
            additionalProperties =
                betaManagedAgentsAgentThreadMessageSentEvent.additionalProperties.toMutableMap()
        }
        ...
        /** Public `sthr_` ID of the thread the message was sent to. */
        fun toSessionThreadId(toSessionThreadId: String) =
            toSessionThreadId(JsonField.of(toSessionThreadId))

        /**
         * Sets [Builder.toSessionThreadId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.toSessionThreadId] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun toSessionThreadId(toSessionThreadId: JsonField<String>) = apply {
            this.toSessionThreadId = toSessionThreadId
        }
        ...
        /**
         * Name of the callable agent this message was sent to. Absent when sent to the primary
         * agent.
         */
        fun toAgentName(toAgentName: String?) = toAgentName(JsonField.ofNullable(toAgentName))

        /** Alias for calling [Builder.toAgentName] with `toAgentName.orElse(null)`. */
        fun toAgentName(toAgentName: Optional<String>) = toAgentName(toAgentName.getOrNull())

        /**
         * Sets [Builder.toAgentName] to an arbitrary JSON value.
         *
         * You should usually call [Builder.toAgentName] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun toAgentName(toAgentName: JsonField<String>) = apply { this.toAgentName = toAgentName }
         ...
         */
        fun build(): BetaManagedAgentsAgentThreadMessageSentEvent =
            BetaManagedAgentsAgentThreadMessageSentEvent(
                checkRequired("id", id),
                checkRequired("content", content).map { it.toImmutable() },
                checkRequired("processedAt", processedAt),
                checkRequired("toSessionThreadId", toSessionThreadId),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsAgentThreadMessageSentEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (toSessionThreadId.asKnown().isPresent) 1 else 0) +
            (type.asKnown().getOrNull()?.validity() ?: 0) +
            (if (toAgentName.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsAgentThreadMessageSentEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsAgentThreadMessageSentEvent{id=$id, content=$content, processedAt=$processedAt, toSessionThreadId=$toSessionThreadId, type=$type, toAgentName=$toAgentName, additionalProperties=$additionalProperties}"
}
