...
/**
 * A GitHub repository mounted into each session's container. The authorization token is write-only
 * and never returned.
 */
...
private constructor(
    ...
    ) : this(type, url, checkout, mountPath, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = betaManagedAgentsGitHubRepositoryResourceConfig.type
            url = betaManagedAgentsGitHubRepositoryResourceConfig.url
            checkout = betaManagedAgentsGitHubRepositoryResourceConfig.checkout
            mountPath = betaManagedAgentsGitHubRepositoryResourceConfig.mountPath
            additionalProperties =
                betaManagedAgentsGitHubRepositoryResourceConfig.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsGitHubRepositoryResourceConfig =
            BetaManagedAgentsGitHubRepositoryResourceConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsGitHubRepositoryResourceConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsGitHubRepositoryResourceConfig &&
            type == other.type &&
            url == other.url &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(type, url, checkout, mountPath, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsGitHubRepositoryResourceConfig{type=$type, url=$url, checkout=$checkout, mountPath=$mountPath, additionalProperties=$additionalProperties}"
}
