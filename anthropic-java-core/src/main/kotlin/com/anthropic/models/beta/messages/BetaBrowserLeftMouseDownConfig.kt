...
private constructor(
    ...
    /** A builder for [BetaBrowserLeftMouseDownConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserLeftMouseDownConfig: BetaBrowserLeftMouseDownConfig) = apply {
            deferLoading = betaBrowserLeftMouseDownConfig.deferLoading
            enabled = betaBrowserLeftMouseDownConfig.enabled
            additionalProperties =
                betaBrowserLeftMouseDownConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserLeftMouseDownConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserLeftMouseDownConfig =
            BetaBrowserLeftMouseDownConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserLeftMouseDownConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserLeftMouseDownConfig &&
    ...
    override fun toString() =
        "BetaBrowserLeftMouseDownConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
