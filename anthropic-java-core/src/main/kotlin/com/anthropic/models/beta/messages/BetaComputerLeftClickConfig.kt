...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaComputerLeftClickConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerLeftClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerLeftClickConfig: BetaComputerLeftClickConfig) = apply {
            deferLoading = betaComputerLeftClickConfig.deferLoading
            enabled = betaComputerLeftClickConfig.enabled
            additionalProperties = betaComputerLeftClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerLeftClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerLeftClickConfig =
            BetaComputerLeftClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerLeftClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerLeftClickConfig &&
    ...
    override fun toString() =
        "BetaComputerLeftClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
