...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = betaManagedAgentsModelRateLimitedError.message
            retryStatus = betaManagedAgentsModelRateLimitedError.retryStatus
            type = betaManagedAgentsModelRateLimitedError.type
            additionalProperties =
                betaManagedAgentsModelRateLimitedError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsModelRateLimitedError =
            BetaManagedAgentsModelRateLimitedError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsModelRateLimitedError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsModelRateLimitedError &&
    ...
    override fun toString() =
        "BetaManagedAgentsModelRateLimitedError{message=$message, retryStatus=$retryStatus, type=$type, additionalProperties=$additionalProperties}"
}
