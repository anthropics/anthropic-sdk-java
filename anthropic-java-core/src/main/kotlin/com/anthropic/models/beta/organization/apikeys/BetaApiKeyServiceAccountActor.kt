...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaApiKeyServiceAccountActor] with the required
    ...
    /** A builder for [BetaApiKeyServiceAccountActor]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaApiKeyServiceAccountActor: BetaApiKeyServiceAccountActor) = apply {
            serviceAccountId = betaApiKeyServiceAccountActor.serviceAccountId
            type = betaApiKeyServiceAccountActor.type
            additionalProperties = betaApiKeyServiceAccountActor.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaApiKeyServiceAccountActor].
         *
         ...
         */
        fun build(): BetaApiKeyServiceAccountActor =
            BetaApiKeyServiceAccountActor(
     ...
     *   expected type.
     */
    fun validate(): BetaApiKeyServiceAccountActor = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaApiKeyServiceAccountActor &&
    ...
    override fun toString() =
        "BetaApiKeyServiceAccountActor{serviceAccountId=$serviceAccountId, type=$type, additionalProperties=$additionalProperties}"
}
