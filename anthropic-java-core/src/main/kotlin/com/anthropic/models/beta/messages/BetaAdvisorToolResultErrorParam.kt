...
private constructor(
     ...
     * ```java
     * JsonValue.from("advisor_tool_result_error")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaAdvisorToolResultErrorParam] with the required
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("advisor_tool_result_error")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaAdvisorToolResultErrorParam: BetaAdvisorToolResultErrorParam) =
            apply {
                errorCode = betaAdvisorToolResultErrorParam.errorCode
                type = betaAdvisorToolResultErrorParam.type
                additionalProperties =
                    betaAdvisorToolResultErrorParam.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaAdvisorToolResultErrorParam =
            BetaAdvisorToolResultErrorParam(
     ...
     *   expected type.
     */
    fun validate(): BetaAdvisorToolResultErrorParam = apply {
        if (validated) {
            return@apply
        }
        ...
        errorCode().validate()
        _type().let {
            if (it != JsonValue.from("advisor_tool_result_error")) {
    ...
    class ErrorCode @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun value(): Value =
            when (this) {
                ...
                PROMPT_TOO_LONG -> Value.PROMPT_TOO_LONG
        ...
        fun known(): Known =
            when (this) {
                ...
                PROMPT_TOO_LONG -> Known.PROMPT_TOO_LONG
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaAdvisorToolResultErrorParam &&
    ...
    override fun toString() =
        "BetaAdvisorToolResultErrorParam{errorCode=$errorCode, type=$type, additionalProperties=$additionalProperties}"
}
