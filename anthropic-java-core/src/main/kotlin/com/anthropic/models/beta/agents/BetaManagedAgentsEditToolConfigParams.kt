...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsEditToolConfigParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            name = betaManagedAgentsEditToolConfigParams.name
            enabled = betaManagedAgentsEditToolConfigParams.enabled
            permissionPolicy = betaManagedAgentsEditToolConfigParams.permissionPolicy
            type = betaManagedAgentsEditToolConfigParams.type
            additionalProperties =
                betaManagedAgentsEditToolConfigParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsEditToolConfigParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaManagedAgentsEditToolConfigParams =
            BetaManagedAgentsEditToolConfigParams(
                name,
                enabled,
                permissionPolicy,
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsEditToolConfigParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsEditToolConfigParams &&
            name == other.name &&
    ...
    override fun toString() =
        "BetaManagedAgentsEditToolConfigParams{name=$name, enabled=$enabled, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
