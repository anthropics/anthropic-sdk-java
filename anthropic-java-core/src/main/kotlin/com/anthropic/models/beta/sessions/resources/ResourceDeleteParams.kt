...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(resourceDeleteParams: ResourceDeleteParams) = apply {
         ...
         */
        fun build(): ResourceDeleteParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ResourceDeleteParams &&
