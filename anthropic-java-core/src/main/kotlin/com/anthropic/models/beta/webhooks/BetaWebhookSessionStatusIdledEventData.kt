...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.status_idled")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.status_idled")
        ...
        internal fun from(
            ...
            id = betaWebhookSessionStatusIdledEventData.id
            organizationId = betaWebhookSessionStatusIdledEventData.organizationId
            type = betaWebhookSessionStatusIdledEventData.type
            workspaceId = betaWebhookSessionStatusIdledEventData.workspaceId
            additionalProperties =
                betaWebhookSessionStatusIdledEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookSessionStatusIdledEventData =
            BetaWebhookSessionStatusIdledEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionStatusIdledEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.status_idled")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.status_idled")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionStatusIdledEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionStatusIdledEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
