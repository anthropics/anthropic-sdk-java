...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaComputerWaitConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerWaitConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerWaitConfig: BetaComputerWaitConfig) = apply {
            deferLoading = betaComputerWaitConfig.deferLoading
            enabled = betaComputerWaitConfig.enabled
            additionalProperties = betaComputerWaitConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerWaitConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerWaitConfig =
            BetaComputerWaitConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerWaitConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerWaitConfig &&
    ...
    override fun toString() =
        "BetaComputerWaitConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
