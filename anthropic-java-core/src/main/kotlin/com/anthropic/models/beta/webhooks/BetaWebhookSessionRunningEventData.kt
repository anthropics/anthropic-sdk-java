...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.running")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.running")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookSessionRunningEventData: BetaWebhookSessionRunningEventData) =
            apply {
                id = betaWebhookSessionRunningEventData.id
                organizationId = betaWebhookSessionRunningEventData.organizationId
                type = betaWebhookSessionRunningEventData.type
                workspaceId = betaWebhookSessionRunningEventData.workspaceId
                additionalProperties =
                    betaWebhookSessionRunningEventData.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaWebhookSessionRunningEventData =
            BetaWebhookSessionRunningEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionRunningEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.running")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.running")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionRunningEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionRunningEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
