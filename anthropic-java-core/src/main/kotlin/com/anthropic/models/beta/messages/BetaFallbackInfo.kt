...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaFallbackInfo] with the required [model] set to the
         * given value.
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaFallbackInfo: BetaFallbackInfo) = apply {
            model = betaFallbackInfo.model
            additionalProperties = betaFallbackInfo.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaFallbackInfo =
            BetaFallbackInfo(checkRequired("model", model), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaFallbackInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaFallbackInfo &&
            model == other.model &&
    ...
    override fun toString() =
        "BetaFallbackInfo{model=$model, additionalProperties=$additionalProperties}"
}
