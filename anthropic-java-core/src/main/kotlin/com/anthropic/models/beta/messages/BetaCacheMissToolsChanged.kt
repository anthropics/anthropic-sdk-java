...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaCacheMissToolsChanged] with the required
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("tools_changed")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaCacheMissToolsChanged: BetaCacheMissToolsChanged) = apply {
            cacheMissedInputTokens = betaCacheMissToolsChanged.cacheMissedInputTokens
            type = betaCacheMissToolsChanged.type
            additionalProperties = betaCacheMissToolsChanged.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaCacheMissToolsChanged =
     ...
     *   expected type.
     */
    fun validate(): BetaCacheMissToolsChanged = apply {
        if (validated) {
            return@apply
        }
        ...
        cacheMissedInputTokens()
        _type().let {
            if (it != JsonValue.from("tools_changed")) {
    ...
    internal fun validity(): Int =
        (if (cacheMissedInputTokens.asKnown().isPresent) 1 else 0) +
            type.let { if (it == JsonValue.from("tools_changed")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaCacheMissToolsChanged &&
    ...
    override fun toString() =
        "BetaCacheMissToolsChanged{cacheMissedInputTokens=$cacheMissedInputTokens, type=$type, additionalProperties=$additionalProperties}"
}
