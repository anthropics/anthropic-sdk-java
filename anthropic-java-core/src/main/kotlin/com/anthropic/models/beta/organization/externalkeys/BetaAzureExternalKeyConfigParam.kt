...
private constructor(
    ...
    /** A builder for [BetaAzureExternalKeyConfigParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaAzureExternalKeyConfigParam: BetaAzureExternalKeyConfigParam) =
            apply {
                keyName = betaAzureExternalKeyConfigParam.keyName
                tenantId = betaAzureExternalKeyConfigParam.tenantId
                type = betaAzureExternalKeyConfigParam.type
                vaultUri = betaAzureExternalKeyConfigParam.vaultUri
                clientId = betaAzureExternalKeyConfigParam.clientId
                additionalProperties =
                    betaAzureExternalKeyConfigParam.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaAzureExternalKeyConfigParam].
         *
         ...
         */
        fun build(): BetaAzureExternalKeyConfigParam =
            BetaAzureExternalKeyConfigParam(
     ...
     *   expected type.
     */
    fun validate(): BetaAzureExternalKeyConfigParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaAzureExternalKeyConfigParam &&
    ...
    override fun toString() =
        "BetaAzureExternalKeyConfigParam{keyName=$keyName, tenantId=$tenantId, type=$type, vaultUri=$vaultUri, clientId=$clientId, additionalProperties=$additionalProperties}"
}
