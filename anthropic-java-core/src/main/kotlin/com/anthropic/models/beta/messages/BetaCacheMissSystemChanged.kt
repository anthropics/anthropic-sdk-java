...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("system_changed")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaCacheMissSystemChanged: BetaCacheMissSystemChanged) = apply {
            cacheMissedInputTokens = betaCacheMissSystemChanged.cacheMissedInputTokens
            type = betaCacheMissSystemChanged.type
            additionalProperties = betaCacheMissSystemChanged.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaCacheMissSystemChanged =
     ...
     *   expected type.
     */
    fun validate(): BetaCacheMissSystemChanged = apply {
        if (validated) {
            return@apply
        }
        ...
        cacheMissedInputTokens()
        _type().let {
            if (it != JsonValue.from("system_changed")) {
    ...
    internal fun validity(): Int =
        (if (cacheMissedInputTokens.asKnown().isPresent) 1 else 0) +
            type.let { if (it == JsonValue.from("system_changed")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaCacheMissSystemChanged &&
    ...
    override fun toString() =
        "BetaCacheMissSystemChanged{cacheMissedInputTokens=$cacheMissedInputTokens, type=$type, additionalProperties=$additionalProperties}"
}
