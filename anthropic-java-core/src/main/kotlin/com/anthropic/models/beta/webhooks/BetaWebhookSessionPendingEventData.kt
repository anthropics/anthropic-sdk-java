...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.pending")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.pending")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookSessionPendingEventData: BetaWebhookSessionPendingEventData) =
            apply {
                id = betaWebhookSessionPendingEventData.id
                organizationId = betaWebhookSessionPendingEventData.organizationId
                type = betaWebhookSessionPendingEventData.type
                workspaceId = betaWebhookSessionPendingEventData.workspaceId
         ...
         */
        fun build(): BetaWebhookSessionPendingEventData =
            BetaWebhookSessionPendingEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionPendingEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.pending")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.pending")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionPendingEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionPendingEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
