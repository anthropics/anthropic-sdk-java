...
private constructor(
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns an immutable instance of [Body] with the required [role] set to the given
             * value.
             */
            @JvmStatic fun of(role: Role) = builder().role(role).build()
        }
         ...
         */
        @JvmSynthetic internal fun validity(): Int = (role.asKnown().getOrNull()?.validity() ?: 0)
