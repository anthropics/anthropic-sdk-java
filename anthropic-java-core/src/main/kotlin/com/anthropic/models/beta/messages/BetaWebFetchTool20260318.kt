...
private constructor(
    ...
    override fun toString() =
        "BetaWebFetchTool20260318{name=$name, type=$type, allowedCallers=$allowedCallers, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, cacheControl=$cacheControl, citations=$citations, deferLoading=$deferLoading, maxContentTokens=$maxContentTokens, maxUses=$maxUses, responseInclusion=$responseInclusion, strict=$strict, useCache=$useCache, additionalProperties=$additionalProperties}"
}
