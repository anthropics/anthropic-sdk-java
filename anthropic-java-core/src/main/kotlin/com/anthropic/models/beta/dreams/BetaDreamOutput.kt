...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaDreamOutput].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaDreamOutput: BetaDreamOutput) = apply {
            memoryStoreId = betaDreamOutput.memoryStoreId
            type = betaDreamOutput.type
            additionalProperties = betaDreamOutput.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaDreamOutput].
         *
     ...
     *   expected type.
     */
    fun validate(): BetaDreamOutput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaDreamOutput &&
    ...
    override fun toString() =
        "BetaDreamOutput{memoryStoreId=$memoryStoreId, type=$type, additionalProperties=$additionalProperties}"
}
