...
private constructor(
     ...
     * ```java
     * JsonValue.from("deployment_run.started")
     * ```
     *
    ...
    /** A builder for [BetaWebhookDeploymentRunStartedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("deployment_run.started")
        ...
        internal fun from(
            ...
            id = betaWebhookDeploymentRunStartedEventData.id
            organizationId = betaWebhookDeploymentRunStartedEventData.organizationId
            type = betaWebhookDeploymentRunStartedEventData.type
            workspaceId = betaWebhookDeploymentRunStartedEventData.workspaceId
            additionalProperties =
                betaWebhookDeploymentRunStartedEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookDeploymentRunStartedEventData].
         *
         ...
         */
        fun build(): BetaWebhookDeploymentRunStartedEventData =
            BetaWebhookDeploymentRunStartedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookDeploymentRunStartedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("deployment_run.started")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("deployment_run.started")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookDeploymentRunStartedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookDeploymentRunStartedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
