...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): BetaThinkingConfigAdaptive =
            BetaThinkingConfigAdaptive(type, additionalProperties.toMutableMap())
    }
     ...
     */
    @JvmSynthetic
    internal fun validity(): Int = type.let { if (it == JsonValue.from("adaptive")) 1 else 0 }
    ...
    override fun toString() =
        "BetaThinkingConfigAdaptive{type=$type, additionalProperties=$additionalProperties}"
}
