...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsBashToolConfigParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            name = betaManagedAgentsBashToolConfigParams.name
            enabled = betaManagedAgentsBashToolConfigParams.enabled
            permissionPolicy = betaManagedAgentsBashToolConfigParams.permissionPolicy
            type = betaManagedAgentsBashToolConfigParams.type
            additionalProperties =
                betaManagedAgentsBashToolConfigParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsBashToolConfigParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaManagedAgentsBashToolConfigParams =
            BetaManagedAgentsBashToolConfigParams(
                name,
                enabled,
                permissionPolicy,
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsBashToolConfigParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsBashToolConfigParams &&
            name == other.name &&
    ...
    override fun toString() =
        "BetaManagedAgentsBashToolConfigParams{name=$name, enabled=$enabled, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
