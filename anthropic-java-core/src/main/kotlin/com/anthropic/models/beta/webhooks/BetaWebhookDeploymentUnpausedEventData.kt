...
private constructor(
     ...
     * ```java
     * JsonValue.from("deployment.unpaused")
     * ```
     *
    ...
    /** A builder for [BetaWebhookDeploymentUnpausedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("deployment.unpaused")
        ...
        internal fun from(
            ...
            id = betaWebhookDeploymentUnpausedEventData.id
            organizationId = betaWebhookDeploymentUnpausedEventData.organizationId
            type = betaWebhookDeploymentUnpausedEventData.type
            workspaceId = betaWebhookDeploymentUnpausedEventData.workspaceId
            additionalProperties =
                betaWebhookDeploymentUnpausedEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookDeploymentUnpausedEventData].
         *
         ...
         */
        fun build(): BetaWebhookDeploymentUnpausedEventData =
            BetaWebhookDeploymentUnpausedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookDeploymentUnpausedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("deployment.unpaused")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("deployment.unpaused")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookDeploymentUnpausedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookDeploymentUnpausedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
