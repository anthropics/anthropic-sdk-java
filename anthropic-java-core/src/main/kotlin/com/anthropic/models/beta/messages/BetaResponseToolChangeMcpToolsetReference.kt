...
private constructor(
    ...
    fun toParam(): BetaToolChangeMcpToolsetReference =
        BetaToolChangeMcpToolsetReference.builder().serverName(_serverName()).build()
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaResponseToolChangeMcpToolsetReference] with the
         * required [serverName] set to the given value.
         */
        @JvmStatic fun of(serverName: String) = builder().serverName(serverName).build()
    }

    /** A builder for [BetaResponseToolChangeMcpToolsetReference]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            serverName = betaResponseToolChangeMcpToolsetReference.serverName
            type = betaResponseToolChangeMcpToolsetReference.type
            additionalProperties =
                betaResponseToolChangeMcpToolsetReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseToolChangeMcpToolsetReference].
         *
         ...
         */
        fun build(): BetaResponseToolChangeMcpToolsetReference =
            BetaResponseToolChangeMcpToolsetReference(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseToolChangeMcpToolsetReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseToolChangeMcpToolsetReference &&
    ...
    override fun toString() =
        "BetaResponseToolChangeMcpToolsetReference{serverName=$serverName, type=$type, additionalProperties=$additionalProperties}"
}
