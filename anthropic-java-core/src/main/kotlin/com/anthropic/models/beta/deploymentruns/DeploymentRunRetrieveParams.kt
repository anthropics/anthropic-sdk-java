...
/** Get Deployment Run */
class DeploymentRunRetrieveParams
private constructor(
    ...
    /** A builder for [DeploymentRunRetrieveParams]. */
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.deploymentRunId] with `deploymentRunId.orElse(null)`. */
        fun deploymentRunId(deploymentRunId: Optional<String>) =
            deploymentRunId(deploymentRunId.getOrNull())
         ...
         */
        fun build(): DeploymentRunRetrieveParams =
