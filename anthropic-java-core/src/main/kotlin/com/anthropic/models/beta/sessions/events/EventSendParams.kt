...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventSendParams: EventSendParams) = apply {
            ...
            workspaceId = eventSendParams.workspaceId
    ...
    override fun toString() =
        "EventSendParams{sessionId=$sessionId, betas=$betas, workspaceId=$workspaceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
