...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserFindConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserFindConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserFindConfig: BetaBrowserFindConfig) = apply {
            deferLoading = betaBrowserFindConfig.deferLoading
            enabled = betaBrowserFindConfig.enabled
            additionalProperties = betaBrowserFindConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserFindConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserFindConfig =
            BetaBrowserFindConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserFindConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserFindConfig &&
    ...
    override fun toString() =
        "BetaBrowserFindConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
