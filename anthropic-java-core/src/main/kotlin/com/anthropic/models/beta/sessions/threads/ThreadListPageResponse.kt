...
private constructor(
    private val data: JsonField<List<BetaManagedAgentsSessionThread>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaManagedAgentsSessionThread>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<BetaManagedAgentsSessionThread>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<BetaManagedAgentsSessionThread>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BetaManagedAgentsSessionThread>>? = null
        ...
        internal fun from(threadListPageResponse: ThreadListPageResponse) = apply {
            data =
                threadListPageResponse.data.map { it.toMutableList() }.takeUnless { it.isMissing() }
            nextPage = threadListPageResponse.nextPage
            additionalProperties = threadListPageResponse.additionalProperties.toMutableMap()
        }

        /** Threads in the session, primary first then children in spawn order. */
        fun data(data: List<BetaManagedAgentsSessionThread>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<BetaManagedAgentsSessionThread>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<BetaManagedAgentsSessionThread>>) = apply {
         ...
         */
        fun addData(data: BetaManagedAgentsSessionThread) = apply {
            this.data =
    ...
    override fun toString() =
        "ThreadListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
