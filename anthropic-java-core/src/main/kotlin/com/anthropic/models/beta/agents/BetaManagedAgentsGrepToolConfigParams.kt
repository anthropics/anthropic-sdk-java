...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsGrepToolConfigParams]. */
    class Builder internal constructor() {

        private var name: JsonValue = JsonValue.from("grep")
        ...
        internal fun from(
            ...
            name = betaManagedAgentsGrepToolConfigParams.name
            enabled = betaManagedAgentsGrepToolConfigParams.enabled
            permissionPolicy = betaManagedAgentsGrepToolConfigParams.permissionPolicy
            type = betaManagedAgentsGrepToolConfigParams.type
            additionalProperties =
                betaManagedAgentsGrepToolConfigParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsGrepToolConfigParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaManagedAgentsGrepToolConfigParams =
            BetaManagedAgentsGrepToolConfigParams(
                name,
                enabled,
                permissionPolicy,
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsGrepToolConfigParams = apply {
        if (validated) {
            return@apply
        }

        _name().let {
            if (it != JsonValue.from("grep")) {
    ...
    internal fun validity(): Int =
        name.let { if (it == JsonValue.from("grep")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsGrepToolConfigParams &&
            name == other.name &&
    ...
    override fun toString() =
        "BetaManagedAgentsGrepToolConfigParams{name=$name, enabled=$enabled, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
