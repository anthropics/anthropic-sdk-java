...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsAgentThreadContextCompactedEvent.id
            processedAt = betaManagedAgentsAgentThreadContextCompactedEvent.processedAt
            type = betaManagedAgentsAgentThreadContextCompactedEvent.type
            additionalProperties =
                betaManagedAgentsAgentThreadContextCompactedEvent.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsAgentThreadContextCompactedEvent =
            BetaManagedAgentsAgentThreadContextCompactedEvent(
                checkRequired("id", id),
    ...
    fun validate(): BetaManagedAgentsAgentThreadContextCompactedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsAgentThreadContextCompactedEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsAgentThreadContextCompactedEvent{id=$id, processedAt=$processedAt, type=$type, additionalProperties=$additionalProperties}"
}
