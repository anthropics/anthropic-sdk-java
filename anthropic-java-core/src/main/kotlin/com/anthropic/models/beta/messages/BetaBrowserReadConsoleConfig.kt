...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserReadConsoleConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserReadConsoleConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserReadConsoleConfig: BetaBrowserReadConsoleConfig) = apply {
            deferLoading = betaBrowserReadConsoleConfig.deferLoading
            enabled = betaBrowserReadConsoleConfig.enabled
            additionalProperties = betaBrowserReadConsoleConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserReadConsoleConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserReadConsoleConfig =
            BetaBrowserReadConsoleConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserReadConsoleConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserReadConsoleConfig &&
    ...
    override fun toString() =
        "BetaBrowserReadConsoleConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
