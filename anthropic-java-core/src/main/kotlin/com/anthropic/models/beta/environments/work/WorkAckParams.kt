 ...
 *
 * Acknowledge receipt of a work item, transitioning it from 'queued' to 'starting' and removing it
 * from the queue.
 */
class WorkAckParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(workAckParams: WorkAckParams) = apply {
            environmentId = workAckParams.environmentId
            workId = workAckParams.workId
            betas = workAckParams.betas?.toMutableList()
            additionalHeaders = workAckParams.additionalHeaders.toBuilder()
            additionalQueryParams = workAckParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = workAckParams.additionalBodyProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "WorkAckParams{environmentId=$environmentId, workId=$workId, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
