...
private constructor(
    private val data: JsonField<List<BetaApiKey>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<BetaApiKey>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaApiKey> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BetaApiKey>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BetaApiKey>>? = null
        ...
        internal fun from(apiKeyListPageResponse: ApiKeyListPageResponse) = apply {
            data =
                apiKeyListPageResponse.data.map { it.toMutableList() }.takeUnless { it.isMissing() }
            firstId = apiKeyListPageResponse.firstId
            hasMore = apiKeyListPageResponse.hasMore
            lastId = apiKeyListPageResponse.lastId
            additionalProperties = apiKeyListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<BetaApiKey>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaApiKey>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<BetaApiKey>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaApiKey] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaApiKey) = apply {
            this.data =
    ...
    override fun toString() =
        "ApiKeyListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
