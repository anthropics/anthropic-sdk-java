...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): BetaManagedAgentsUserMessageEventParams =
            BetaManagedAgentsUserMessageEventParams(
    ...
    fun validate(): BetaManagedAgentsUserMessageEventParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsUserMessageEventParams &&
    ...
    override fun toString() =
        "BetaManagedAgentsUserMessageEventParams{content=$content, type=$type, additionalProperties=$additionalProperties}"
}
