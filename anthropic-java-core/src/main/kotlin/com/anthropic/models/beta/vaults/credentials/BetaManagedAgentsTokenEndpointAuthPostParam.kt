...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            clientSecret = betaManagedAgentsTokenEndpointAuthPostParam.clientSecret
            type = betaManagedAgentsTokenEndpointAuthPostParam.type
            additionalProperties =
                betaManagedAgentsTokenEndpointAuthPostParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsTokenEndpointAuthPostParam =
            BetaManagedAgentsTokenEndpointAuthPostParam(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsTokenEndpointAuthPostParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsTokenEndpointAuthPostParam &&
    ...
    override fun toString() =
        "BetaManagedAgentsTokenEndpointAuthPostParam{clientSecret=$clientSecret, type=$type, additionalProperties=$additionalProperties}"
}
