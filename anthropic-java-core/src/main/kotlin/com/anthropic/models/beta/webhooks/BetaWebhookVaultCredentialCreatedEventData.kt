...
private constructor(
     ...
     * ```java
     * JsonValue.from("vault_credential.created")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("vault_credential.created")
        ...
        internal fun from(
            ...
            id = betaWebhookVaultCredentialCreatedEventData.id
            organizationId = betaWebhookVaultCredentialCreatedEventData.organizationId
            type = betaWebhookVaultCredentialCreatedEventData.type
            vaultId = betaWebhookVaultCredentialCreatedEventData.vaultId
            workspaceId = betaWebhookVaultCredentialCreatedEventData.workspaceId
            additionalProperties =
                betaWebhookVaultCredentialCreatedEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookVaultCredentialCreatedEventData =
            BetaWebhookVaultCredentialCreatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookVaultCredentialCreatedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("vault_credential.created")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("vault_credential.created")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookVaultCredentialCreatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookVaultCredentialCreatedEventData{id=$id, organizationId=$organizationId, type=$type, vaultId=$vaultId, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
