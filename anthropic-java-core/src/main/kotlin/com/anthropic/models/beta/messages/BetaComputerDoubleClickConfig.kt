...
private constructor(
    ...
    /** A builder for [BetaComputerDoubleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerDoubleClickConfig: BetaComputerDoubleClickConfig) = apply {
            deferLoading = betaComputerDoubleClickConfig.deferLoading
            enabled = betaComputerDoubleClickConfig.enabled
            additionalProperties = betaComputerDoubleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerDoubleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerDoubleClickConfig =
            BetaComputerDoubleClickConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaComputerDoubleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerDoubleClickConfig &&
    ...
    override fun toString() =
        "BetaComputerDoubleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
