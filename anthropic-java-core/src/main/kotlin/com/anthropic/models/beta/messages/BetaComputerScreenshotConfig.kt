...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaComputerScreenshotConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerScreenshotConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerScreenshotConfig: BetaComputerScreenshotConfig) = apply {
            deferLoading = betaComputerScreenshotConfig.deferLoading
            enabled = betaComputerScreenshotConfig.enabled
            additionalProperties = betaComputerScreenshotConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerScreenshotConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerScreenshotConfig =
            BetaComputerScreenshotConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerScreenshotConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerScreenshotConfig &&
    ...
    override fun toString() =
        "BetaComputerScreenshotConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
