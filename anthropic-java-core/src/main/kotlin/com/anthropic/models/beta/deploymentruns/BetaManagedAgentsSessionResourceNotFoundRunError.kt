...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = betaManagedAgentsSessionResourceNotFoundRunError.message
            type = betaManagedAgentsSessionResourceNotFoundRunError.type
            additionalProperties =
                betaManagedAgentsSessionResourceNotFoundRunError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSessionResourceNotFoundRunError =
            BetaManagedAgentsSessionResourceNotFoundRunError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSessionResourceNotFoundRunError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSessionResourceNotFoundRunError &&
    ...
    override fun toString() =
        "BetaManagedAgentsSessionResourceNotFoundRunError{message=$message, type=$type, additionalProperties=$additionalProperties}"
}
