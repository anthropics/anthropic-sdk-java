...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaComputerKeyConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerKeyConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerKeyConfig: BetaComputerKeyConfig) = apply {
            deferLoading = betaComputerKeyConfig.deferLoading
            enabled = betaComputerKeyConfig.enabled
            additionalProperties = betaComputerKeyConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerKeyConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerKeyConfig =
            BetaComputerKeyConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerKeyConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerKeyConfig &&
    ...
    override fun toString() =
        "BetaComputerKeyConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
