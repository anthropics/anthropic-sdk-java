...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaComputerTypeConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerTypeConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerTypeConfig: BetaComputerTypeConfig) = apply {
            deferLoading = betaComputerTypeConfig.deferLoading
            enabled = betaComputerTypeConfig.enabled
            additionalProperties = betaComputerTypeConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerTypeConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerTypeConfig =
            BetaComputerTypeConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerTypeConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerTypeConfig &&
    ...
    override fun toString() =
        "BetaComputerTypeConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
