...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventListParams: EventListParams) = apply {
            ...
            workspaceId = eventListParams.workspaceId
    ...
    override fun toString() =
        "EventListParams{sessionId=$sessionId, createdAtGt=$createdAtGt, createdAtGte=$createdAtGte, createdAtLt=$createdAtLt, createdAtLte=$createdAtLte, limit=$limit, order=$order, page=$page, types=$types, betas=$betas, workspaceId=$workspaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
