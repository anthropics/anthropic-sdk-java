...
private constructor(
    ...
    private constructor(
        ...
        fun type(): Type =
            accept(
                object : Visitor<Type> {
                    override fun visitBase64(base64: BetaManagedAgentsBase64DocumentSource): Type =
                        Type.BASE64

                    override fun visitText(text: BetaManagedAgentsPlainTextDocumentSource): Type =
                        Type.TEXT

                    override fun visitUrl(url: BetaManagedAgentsUrlDocumentSource): Type = Type.URL

                    override fun visitFile(file: BetaManagedAgentsFileDocumentSource): Type =
                        Type.FILE
