...
private constructor(
    ...
    /** A builder for [BetaBrowserJavascriptExecConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserJavascriptExecConfig: BetaBrowserJavascriptExecConfig) =
            apply {
                deferLoading = betaBrowserJavascriptExecConfig.deferLoading
                enabled = betaBrowserJavascriptExecConfig.enabled
                additionalProperties =
                    betaBrowserJavascriptExecConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserJavascriptExecConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserJavascriptExecConfig =
            BetaBrowserJavascriptExecConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserJavascriptExecConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserJavascriptExecConfig &&
    ...
    override fun toString() =
        "BetaBrowserJavascriptExecConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
