...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaResponseToolInputSchema].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaResponseToolInputSchema]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaResponseToolInputSchema: BetaResponseToolInputSchema) = apply {
            type = betaResponseToolInputSchema.type
            properties = betaResponseToolInputSchema.properties
            required =
                betaResponseToolInputSchema.required
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            additionalProperties = betaResponseToolInputSchema.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseToolInputSchema].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaResponseToolInputSchema =
     ...
     *   expected type.
     */
    fun validate(): BetaResponseToolInputSchema = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseToolInputSchema &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaResponseToolInputSchema{type=$type, properties=$properties, required=$required, additionalProperties=$additionalProperties}"
}
