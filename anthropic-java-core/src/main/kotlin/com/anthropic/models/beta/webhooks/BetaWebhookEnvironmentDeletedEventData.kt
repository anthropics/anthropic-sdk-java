...
private constructor(
     ...
     * ```java
     * JsonValue.from("environment.deleted")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("environment.deleted")
    ...
    fun validate(): BetaWebhookEnvironmentDeletedEventData = apply {
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("environment.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("environment.deleted")) 1 else 0 } +
