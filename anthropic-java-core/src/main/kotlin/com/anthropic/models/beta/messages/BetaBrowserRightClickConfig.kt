...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserRightClickConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserRightClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserRightClickConfig: BetaBrowserRightClickConfig) = apply {
            deferLoading = betaBrowserRightClickConfig.deferLoading
            enabled = betaBrowserRightClickConfig.enabled
            additionalProperties = betaBrowserRightClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserRightClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserRightClickConfig =
            BetaBrowserRightClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserRightClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserRightClickConfig &&
    ...
    override fun toString() =
        "BetaBrowserRightClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
