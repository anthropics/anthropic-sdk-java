...
private constructor(
    private val data: JsonField<List<BetaTunnelCertificate>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaTunnelCertificate>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaTunnelCertificate> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BetaTunnelCertificate>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CertificateListPageResponse].
         *
    ...
    /** A builder for [CertificateListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BetaTunnelCertificate>>? = null
        private var nextPage: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(certificateListPageResponse: CertificateListPageResponse) = apply {
            data =
                certificateListPageResponse.data
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            nextPage = certificateListPageResponse.nextPage
            additionalProperties = certificateListPageResponse.additionalProperties.toMutableMap()
        }

        /** List of certificates, ordered by created_at descending. */
        fun data(data: List<BetaTunnelCertificate>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaTunnelCertificate>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<BetaTunnelCertificate>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaTunnelCertificate] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaTunnelCertificate) = apply {
            this.data =
         ...
         */
        fun build(): CertificateListPageResponse =
            CertificateListPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CertificateListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CertificateListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
