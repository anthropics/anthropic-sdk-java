...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserGetPageTextConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserGetPageTextConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserGetPageTextConfig: BetaBrowserGetPageTextConfig) = apply {
            deferLoading = betaBrowserGetPageTextConfig.deferLoading
            enabled = betaBrowserGetPageTextConfig.enabled
            additionalProperties = betaBrowserGetPageTextConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserGetPageTextConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserGetPageTextConfig =
            BetaBrowserGetPageTextConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserGetPageTextConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserGetPageTextConfig &&
    ...
    override fun toString() =
        "BetaBrowserGetPageTextConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
