...
/**
 * Indicates the agent is making forward progress via extended thinking. A progress signal, not a
 * content carrier.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsAgentThinkingEvent.id
            processedAt = betaManagedAgentsAgentThinkingEvent.processedAt
            type = betaManagedAgentsAgentThinkingEvent.type
            additionalProperties =
                betaManagedAgentsAgentThinkingEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsAgentThinkingEvent =
            BetaManagedAgentsAgentThinkingEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsAgentThinkingEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsAgentThinkingEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsAgentThinkingEvent{id=$id, processedAt=$processedAt, type=$type, additionalProperties=$additionalProperties}"
}
