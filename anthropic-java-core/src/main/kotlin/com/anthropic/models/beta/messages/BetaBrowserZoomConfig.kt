...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserZoomConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserZoomConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserZoomConfig: BetaBrowserZoomConfig) = apply {
            deferLoading = betaBrowserZoomConfig.deferLoading
            enabled = betaBrowserZoomConfig.enabled
            additionalProperties = betaBrowserZoomConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserZoomConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserZoomConfig =
            BetaBrowserZoomConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserZoomConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserZoomConfig &&
    ...
    override fun toString() =
        "BetaBrowserZoomConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
