...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsGrepToolConfig]. */
    class Builder internal constructor() {

        private var enabled: JsonField<Boolean>? = null
        private var name: JsonValue = JsonValue.from("grep")
        private var permissionPolicy: JsonField<PermissionPolicy>? = null
        private var type: JsonValue = JsonValue.from("grep")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaManagedAgentsGrepToolConfig: BetaManagedAgentsGrepToolConfig) =
            apply {
                enabled = betaManagedAgentsGrepToolConfig.enabled
                name = betaManagedAgentsGrepToolConfig.name
                permissionPolicy = betaManagedAgentsGrepToolConfig.permissionPolicy
                type = betaManagedAgentsGrepToolConfig.type
                additionalProperties =
                    betaManagedAgentsGrepToolConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsGrepToolConfig].
         *
         ...
         */
        fun build(): BetaManagedAgentsGrepToolConfig =
            BetaManagedAgentsGrepToolConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsGrepToolConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (enabled.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("grep")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsGrepToolConfig &&
    ...
    override fun toString() =
        "BetaManagedAgentsGrepToolConfig{enabled=$enabled, name=$name, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
