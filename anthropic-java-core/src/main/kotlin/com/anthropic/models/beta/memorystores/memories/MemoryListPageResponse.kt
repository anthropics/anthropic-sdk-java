...
private constructor(
    private val data: JsonField<List<BetaManagedAgentsMemoryListItem>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaManagedAgentsMemoryListItem>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<BetaManagedAgentsMemoryListItem>> = data
    ...
    /** A builder for [MemoryListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BetaManagedAgentsMemoryListItem>>? = null
         ...
         * `List<BetaManagedAgentsMemoryListItem>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<BetaManagedAgentsMemoryListItem>>) = apply {
         ...
         */
        fun addData(data: BetaManagedAgentsMemoryListItem) = apply {
            this.data =
        ...
        /** Alias for calling [addData] with `BetaManagedAgentsMemoryListItem.ofMemory(memory)`. */
        fun addData(memory: BetaManagedAgentsMemory) =
            addData(BetaManagedAgentsMemoryListItem.ofMemory(memory))

        /**
         * Alias for calling [addData] with
         * `BetaManagedAgentsMemoryListItem.ofMemoryPrefix(memoryPrefix)`.
         */
        fun addData(memoryPrefix: BetaManagedAgentsMemoryPrefix) =
            addData(BetaManagedAgentsMemoryListItem.ofMemoryPrefix(memoryPrefix))
         ...
         * ```
         */
        fun addMemoryPrefixData(path: String) =
            addData(
                BetaManagedAgentsMemoryPrefix.builder()
                    .type(BetaManagedAgentsMemoryPrefix.Type.MEMORY_PREFIX)
                    .path(path)
         ...
         */
        fun build(): MemoryListPageResponse =
    ...
    fun validate(): MemoryListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MemoryListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MemoryListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
