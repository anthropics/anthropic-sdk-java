...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserNewTabConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserNewTabConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserNewTabConfig: BetaBrowserNewTabConfig) = apply {
            deferLoading = betaBrowserNewTabConfig.deferLoading
            enabled = betaBrowserNewTabConfig.enabled
            additionalProperties = betaBrowserNewTabConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserNewTabConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserNewTabConfig =
            BetaBrowserNewTabConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserNewTabConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserNewTabConfig &&
    ...
    override fun toString() =
        "BetaBrowserNewTabConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
