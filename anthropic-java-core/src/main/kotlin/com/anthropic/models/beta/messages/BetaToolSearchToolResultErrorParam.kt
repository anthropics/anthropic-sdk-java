...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaToolSearchToolResultErrorParam] with the required
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaToolSearchToolResultErrorParam: BetaToolSearchToolResultErrorParam) =
            apply {
                ...
                errorMessage = betaToolSearchToolResultErrorParam.errorMessage
                additionalProperties =
                    betaToolSearchToolResultErrorParam.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaToolSearchToolResultErrorParam =
            BetaToolSearchToolResultErrorParam(
     ...
     *   expected type.
     */
    fun validate(): BetaToolSearchToolResultErrorParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolSearchToolResultErrorParam &&
    ...
    override fun toString() =
        "BetaToolSearchToolResultErrorParam{errorCode=$errorCode, type=$type, errorMessage=$errorMessage, additionalProperties=$additionalProperties}"
}
