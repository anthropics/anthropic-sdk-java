...
private constructor(
    ...
    companion object {
         ...
         * with the required [type] set to the given value.
         */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = betaManagedAgentsTokenEndpointAuthBasicUpdateParam.type
            clientSecret = betaManagedAgentsTokenEndpointAuthBasicUpdateParam.clientSecret
            additionalProperties =
                betaManagedAgentsTokenEndpointAuthBasicUpdateParam.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsTokenEndpointAuthBasicUpdateParam =
            BetaManagedAgentsTokenEndpointAuthBasicUpdateParam(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsTokenEndpointAuthBasicUpdateParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsTokenEndpointAuthBasicUpdateParam &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaManagedAgentsTokenEndpointAuthBasicUpdateParam{type=$type, clientSecret=$clientSecret, additionalProperties=$additionalProperties}"
}
