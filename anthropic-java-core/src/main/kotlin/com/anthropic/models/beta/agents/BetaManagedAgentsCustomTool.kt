...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsCustomTool: BetaManagedAgentsCustomTool) = apply {
            description = betaManagedAgentsCustomTool.description
            inputSchema = betaManagedAgentsCustomTool.inputSchema
            name = betaManagedAgentsCustomTool.name
            type = betaManagedAgentsCustomTool.type
            additionalProperties = betaManagedAgentsCustomTool.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsCustomTool =
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsCustomTool = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsCustomTool &&
    ...
    override fun toString() =
        "BetaManagedAgentsCustomTool{description=$description, inputSchema=$inputSchema, name=$name, type=$type, additionalProperties=$additionalProperties}"
}
