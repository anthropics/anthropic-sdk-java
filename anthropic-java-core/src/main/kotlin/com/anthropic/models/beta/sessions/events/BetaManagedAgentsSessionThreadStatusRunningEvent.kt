...
/**
 * A session thread has begun executing. Emitted on the thread's own stream and cross-posted to the
 * primary stream for child threads.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsSessionThreadStatusRunningEvent.id
            agentName = betaManagedAgentsSessionThreadStatusRunningEvent.agentName
            processedAt = betaManagedAgentsSessionThreadStatusRunningEvent.processedAt
            sessionThreadId = betaManagedAgentsSessionThreadStatusRunningEvent.sessionThreadId
            type = betaManagedAgentsSessionThreadStatusRunningEvent.type
            additionalProperties =
                betaManagedAgentsSessionThreadStatusRunningEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSessionThreadStatusRunningEvent =
            BetaManagedAgentsSessionThreadStatusRunningEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSessionThreadStatusRunningEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSessionThreadStatusRunningEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsSessionThreadStatusRunningEvent{id=$id, agentName=$agentName, processedAt=$processedAt, sessionThreadId=$sessionThreadId, type=$type, additionalProperties=$additionalProperties}"
}
