...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaComputerRightClickConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerRightClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerRightClickConfig: BetaComputerRightClickConfig) = apply {
            deferLoading = betaComputerRightClickConfig.deferLoading
            enabled = betaComputerRightClickConfig.enabled
            additionalProperties = betaComputerRightClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerRightClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerRightClickConfig =
            BetaComputerRightClickConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerRightClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerRightClickConfig &&
    ...
    override fun toString() =
        "BetaComputerRightClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
