...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaFileMetadata].
         *
    ...
    /** A builder for [BetaFileMetadata]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaFileMetadata: BetaFileMetadata) = apply {
            id = betaFileMetadata.id
            createdAt = betaFileMetadata.createdAt
            filename = betaFileMetadata.filename
            mimeType = betaFileMetadata.mimeType
        ...
        /**
         * Returns an immutable instance of [BetaFileMetadata].
         *
     ...
     *   expected type.
     */
    fun validate(): BetaFileMetadata = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaFileMetadata &&
            id == other.id &&
