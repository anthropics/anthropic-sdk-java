...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaComputerMouseMoveConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerMouseMoveConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerMouseMoveConfig: BetaComputerMouseMoveConfig) = apply {
            deferLoading = betaComputerMouseMoveConfig.deferLoading
            enabled = betaComputerMouseMoveConfig.enabled
            additionalProperties = betaComputerMouseMoveConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerMouseMoveConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerMouseMoveConfig =
            BetaComputerMouseMoveConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerMouseMoveConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerMouseMoveConfig &&
    ...
    override fun toString() =
        "BetaComputerMouseMoveConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
