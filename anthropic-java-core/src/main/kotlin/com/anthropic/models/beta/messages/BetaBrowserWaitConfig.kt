...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserWaitConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserWaitConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserWaitConfig: BetaBrowserWaitConfig) = apply {
            deferLoading = betaBrowserWaitConfig.deferLoading
            enabled = betaBrowserWaitConfig.enabled
            additionalProperties = betaBrowserWaitConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserWaitConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserWaitConfig =
            BetaBrowserWaitConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserWaitConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserWaitConfig &&
    ...
    override fun toString() =
        "BetaBrowserWaitConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
