...
private constructor(
    ...
    fun issuerId(): Optional<String> = Optional.ofNullable(issuerId)
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ruleListParams: RuleListParams) = apply {
            includeArchived = ruleListParams.includeArchived
            issuerId = ruleListParams.issuerId
            limit = ruleListParams.limit
            page = ruleListParams.page
            betas = ruleListParams.betas?.toMutableList()
        ...
        /** Filter to rules referencing this federation issuer. */
        fun issuerId(issuerId: String?) = apply { this.issuerId = issuerId }

        /** Alias for calling [Builder.issuerId] with `issuerId.orElse(null)`. */
        fun issuerId(issuerId: Optional<String>) = issuerId(issuerId.getOrNull())
    ...
    override fun toString() =
        "RuleListParams{includeArchived=$includeArchived, issuerId=$issuerId, limit=$limit, page=$page, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
