...
private constructor(
    ...
    /** A builder for [BetaWebhookAgentCreatedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("agent.created")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookAgentCreatedEventData: BetaWebhookAgentCreatedEventData) =
            apply {
                id = betaWebhookAgentCreatedEventData.id
                organizationId = betaWebhookAgentCreatedEventData.organizationId
                type = betaWebhookAgentCreatedEventData.type
                workspaceId = betaWebhookAgentCreatedEventData.workspaceId
                additionalProperties =
                    betaWebhookAgentCreatedEventData.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookAgentCreatedEventData].
         *
         ...
         */
        fun build(): BetaWebhookAgentCreatedEventData =
            BetaWebhookAgentCreatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookAgentCreatedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("agent.created")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.created")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookAgentCreatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookAgentCreatedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
