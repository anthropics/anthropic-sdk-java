...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("vault.deleted")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookVaultDeletedEventData: BetaWebhookVaultDeletedEventData) =
            apply {
                id = betaWebhookVaultDeletedEventData.id
                organizationId = betaWebhookVaultDeletedEventData.organizationId
                type = betaWebhookVaultDeletedEventData.type
                workspaceId = betaWebhookVaultDeletedEventData.workspaceId
                additionalProperties =
                    betaWebhookVaultDeletedEventData.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaWebhookVaultDeletedEventData =
            BetaWebhookVaultDeletedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookVaultDeletedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("vault.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("vault.deleted")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookVaultDeletedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookVaultDeletedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
