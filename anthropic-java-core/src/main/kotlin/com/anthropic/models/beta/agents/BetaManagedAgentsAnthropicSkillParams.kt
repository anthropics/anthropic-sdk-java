...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            skillId = betaManagedAgentsAnthropicSkillParams.skillId
            type = betaManagedAgentsAnthropicSkillParams.type
            version = betaManagedAgentsAnthropicSkillParams.version
            additionalProperties =
                betaManagedAgentsAnthropicSkillParams.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsAnthropicSkillParams =
            BetaManagedAgentsAnthropicSkillParams(
    ...
    fun validate(): BetaManagedAgentsAnthropicSkillParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsAnthropicSkillParams &&
    ...
    override fun toString() =
        "BetaManagedAgentsAnthropicSkillParams{skillId=$skillId, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
