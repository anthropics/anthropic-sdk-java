...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaDreamModelConfig].
         *
        ...
        /**
         * Returns an immutable instance of [BetaDreamModelConfig] with the required [id] set to the
         * given value.
         */
        @JvmStatic fun of(id: String) = builder().id(id).build()
    }

    /** A builder for [BetaDreamModelConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaDreamModelConfig: BetaDreamModelConfig) = apply {
            id = betaDreamModelConfig.id
            speed = betaDreamModelConfig.speed
        ...
        /**
         * Returns an immutable instance of [BetaDreamModelConfig].
         *
         ...
         */
        fun build(): BetaDreamModelConfig =
     ...
     *   expected type.
     */
    fun validate(): BetaDreamModelConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaDreamModelConfig &&
            id == other.id &&
            speed == other.speed &&
    ...
    override fun toString() =
        "BetaDreamModelConfig{id=$id, speed=$speed, additionalProperties=$additionalProperties}"
}
