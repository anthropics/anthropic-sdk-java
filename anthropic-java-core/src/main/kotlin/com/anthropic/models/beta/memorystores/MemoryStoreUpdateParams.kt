...
private constructor(
    ...
    /**
     * ID of the memory store to update (a `memstore_...` identifier). Required. Enumerate IDs via
     * `GET /v1/memory_stores`. Updating an archived store returns 400.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): MemoryStoreUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MemoryStoreUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MemoryStoreUpdateParams]. */
    class Builder internal constructor() {
        ...
        /**
         * ID of the memory store to update (a `memstore_...` identifier). Required. Enumerate IDs
         * via `GET /v1/memory_stores`. Updating an archived store returns 400.
         */
         ...
         */
        fun build(): MemoryStoreUpdateParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(description, metadata, name, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{description=$description, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
    }
