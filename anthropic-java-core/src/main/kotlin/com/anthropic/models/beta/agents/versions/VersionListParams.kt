...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(versionListParams: VersionListParams) = apply {
            agentId = versionListParams.agentId
    ...
    override fun hashCode(): Int =
        Objects.hash(agentId, limit, page, betas, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "VersionListParams{agentId=$agentId, limit=$limit, page=$page, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
