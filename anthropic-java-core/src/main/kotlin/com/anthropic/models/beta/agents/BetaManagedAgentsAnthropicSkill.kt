...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsAnthropicSkill: BetaManagedAgentsAnthropicSkill) =
            apply {
                skillId = betaManagedAgentsAnthropicSkill.skillId
                type = betaManagedAgentsAnthropicSkill.type
                version = betaManagedAgentsAnthropicSkill.version
                additionalProperties =
                    betaManagedAgentsAnthropicSkill.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaManagedAgentsAnthropicSkill =
            BetaManagedAgentsAnthropicSkill(
    ...
    fun validate(): BetaManagedAgentsAnthropicSkill = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsAnthropicSkill &&
    ...
    override fun toString() =
        "BetaManagedAgentsAnthropicSkill{skillId=$skillId, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
