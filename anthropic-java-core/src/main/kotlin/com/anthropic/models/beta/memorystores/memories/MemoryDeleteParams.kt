...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(memoryDeleteParams: MemoryDeleteParams) = apply {
            memoryStoreId = memoryDeleteParams.memoryStoreId
        ...
        /**
         * Alias for calling [Builder.expectedContentSha256] with
         * `expectedContentSha256.orElse(null)`.
         */
        fun expectedContentSha256(expectedContentSha256: Optional<String>) =
            expectedContentSha256(expectedContentSha256.getOrNull())
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                expectedContentSha256?.let { put("expected_content_sha256", it) }
