...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(serviceAccountAddParams: ServiceAccountAddParams) = apply {
            ...
            betas = serviceAccountAddParams.betas?.toMutableList()
    ...
    override fun hashCode(): Int =
        Objects.hash(workspaceId, betas, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ServiceAccountAddParams{workspaceId=$workspaceId, betas=$betas, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
