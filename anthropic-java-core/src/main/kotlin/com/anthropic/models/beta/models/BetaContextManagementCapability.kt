...
private constructor(
    ...
    private val compact20260112: JsonField<BetaCapabilitySupport>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        clearThinking20251015: JsonField<BetaCapabilitySupport> = JsonMissing.of(),
        @JsonProperty("clear_tool_uses_20250919")
        @ExcludeMissing
        clearToolUses20250919: JsonField<BetaCapabilitySupport> = JsonMissing.of(),
        @JsonProperty("compact_20260112")
        @ExcludeMissing
        compact20260112: JsonField<BetaCapabilitySupport> = JsonMissing.of(),
     ...
     */
    fun clearThinking20251015(): Optional<BetaCapabilitySupport> =
     ...
     *   server responded with an unexpected value).
     */
    fun clearToolUses20250919(): Optional<BetaCapabilitySupport> =
     ...
     *   server responded with an unexpected value).
     */
    fun compact20260112(): Optional<BetaCapabilitySupport> =
    ...
    @JsonProperty("clear_thinking_20251015")
    @ExcludeMissing
    fun _clearThinking20251015(): JsonField<BetaCapabilitySupport> = clearThinking20251015
    ...
    @JsonProperty("clear_tool_uses_20250919")
    @ExcludeMissing
    fun _clearToolUses20250919(): JsonField<BetaCapabilitySupport> = clearToolUses20250919
    ...
    @JsonProperty("compact_20260112")
    @ExcludeMissing
    fun _compact20260112(): JsonField<BetaCapabilitySupport> = compact20260112
    ...
    class Builder internal constructor() {
        ...
        private var clearThinking20251015: JsonField<BetaCapabilitySupport>? = null
        private var clearToolUses20250919: JsonField<BetaCapabilitySupport>? = null
        private var compact20260112: JsonField<BetaCapabilitySupport>? = null
        ...
        internal fun from(betaContextManagementCapability: BetaContextManagementCapability) =
            apply {
                ...
                compact20260112 = betaContextManagementCapability.compact20260112
                supported = betaContextManagementCapability.supported
         ...
         */
        fun clearThinking20251015(clearThinking20251015: Optional<BetaCapabilitySupport>) =
         ...
         */
        fun clearThinking20251015(clearThinking20251015: JsonField<BetaCapabilitySupport>) = apply {
         ...
         */
        fun clearToolUses20250919(clearToolUses20250919: Optional<BetaCapabilitySupport>) =
         ...
         * an undocumented or not yet supported value.
         */
        fun clearToolUses20250919(clearToolUses20250919: JsonField<BetaCapabilitySupport>) = apply {
        ...
        fun compact20260112(compact20260112: Optional<BetaCapabilitySupport>) =
            compact20260112(compact20260112.getOrNull())

        /**
         * Sets [Builder.compact20260112] to an arbitrary JSON value.
         *
         * You should usually call [Builder.compact20260112] with a well-typed
         * [BetaCapabilitySupport] value instead. This method is primarily for setting the field to
         * an undocumented or not yet supported value.
         */
        fun compact20260112(compact20260112: JsonField<BetaCapabilitySupport>) = apply {
         ...
         */
        fun build(): BetaContextManagementCapability =
            BetaContextManagementCapability(
    ...
    fun validate(): BetaContextManagementCapability = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (clearThinking20251015.asKnown().getOrNull()?.validity() ?: 0) +
            (clearToolUses20250919.asKnown().getOrNull()?.validity() ?: 0) +
            (compact20260112.asKnown().getOrNull()?.validity() ?: 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaContextManagementCapability &&
    ...
    override fun toString() =
        "BetaContextManagementCapability{clearThinking20251015=$clearThinking20251015, clearToolUses20250919=$clearToolUses20250919, compact20260112=$compact20260112, supported=$supported, additionalProperties=$additionalProperties}"
}
