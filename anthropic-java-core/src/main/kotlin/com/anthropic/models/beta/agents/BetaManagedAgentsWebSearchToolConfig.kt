...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsWebSearchToolConfig]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            enabled = betaManagedAgentsWebSearchToolConfig.enabled
            name = betaManagedAgentsWebSearchToolConfig.name
            permissionPolicy = betaManagedAgentsWebSearchToolConfig.permissionPolicy
            type = betaManagedAgentsWebSearchToolConfig.type
            allowedDomains =
                betaManagedAgentsWebSearchToolConfig.allowedDomains
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            blockedDomains =
                betaManagedAgentsWebSearchToolConfig.blockedDomains
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            userLocation = betaManagedAgentsWebSearchToolConfig.userLocation
            additionalProperties =
                betaManagedAgentsWebSearchToolConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsWebSearchToolConfig].
         *
         ...
         */
        fun build(): BetaManagedAgentsWebSearchToolConfig =
            BetaManagedAgentsWebSearchToolConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsWebSearchToolConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsWebSearchToolConfig &&
    ...
    override fun toString() =
        "BetaManagedAgentsWebSearchToolConfig{enabled=$enabled, name=$name, permissionPolicy=$permissionPolicy, type=$type, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, userLocation=$userLocation, additionalProperties=$additionalProperties}"
}
