...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsSessionStatusRunningEvent.id
            processedAt = betaManagedAgentsSessionStatusRunningEvent.processedAt
            type = betaManagedAgentsSessionStatusRunningEvent.type
            additionalProperties =
                betaManagedAgentsSessionStatusRunningEvent.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSessionStatusRunningEvent =
            BetaManagedAgentsSessionStatusRunningEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSessionStatusRunningEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSessionStatusRunningEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsSessionStatusRunningEvent{id=$id, processedAt=$processedAt, type=$type, additionalProperties=$additionalProperties}"
}
