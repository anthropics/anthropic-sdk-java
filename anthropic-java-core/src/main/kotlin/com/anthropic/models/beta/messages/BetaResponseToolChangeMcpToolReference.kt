...
/**
 * Reference to a single MCP tool, by its server and its name on that server, as a ``compaction``
...
private constructor(
    ...
    fun toParam(): BetaToolChangeMcpToolReference =
        BetaToolChangeMcpToolReference.builder().name(_name()).serverName(_serverName()).build()
    ...
    /** A builder for [BetaResponseToolChangeMcpToolReference]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            name = betaResponseToolChangeMcpToolReference.name
            serverName = betaResponseToolChangeMcpToolReference.serverName
            type = betaResponseToolChangeMcpToolReference.type
            additionalProperties =
                betaResponseToolChangeMcpToolReference.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaResponseToolChangeMcpToolReference].
         *
         ...
         */
        fun build(): BetaResponseToolChangeMcpToolReference =
            BetaResponseToolChangeMcpToolReference(
     ...
     *   expected type.
     */
    fun validate(): BetaResponseToolChangeMcpToolReference = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaResponseToolChangeMcpToolReference &&
            name == other.name &&
    ...
    override fun toString() =
        "BetaResponseToolChangeMcpToolReference{name=$name, serverName=$serverName, type=$type, additionalProperties=$additionalProperties}"
}
