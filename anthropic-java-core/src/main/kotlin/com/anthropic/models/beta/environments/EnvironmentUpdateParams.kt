...
private constructor(
    ...
    /**
     * User-provided metadata key-value pairs. Set a value to null or empty string to delete the
     * key.
     *
     * @throws AnthropicInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     ...
     * all accounts. 'account' restricts visibility to the owning account only.
     *
     * @throws AnthropicInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): EnvironmentUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EnvironmentUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EnvironmentUpdateParams]. */
    class Builder internal constructor() {
         ...
         * to all accounts. 'account' restricts visibility to the owning account only.
         */
         ...
         */
        fun build(): EnvironmentUpdateParams =
    ...
    private constructor(
        ...
        ) : this(config, description, metadata, name, scope, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            /**
             * User-provided metadata key-value pairs. Set a value to null or empty string to delete
             * the key.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(config, description, metadata, name, scope, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{config=$config, description=$description, metadata=$metadata, name=$name, scope=$scope, additionalProperties=$additionalProperties}"
    }
