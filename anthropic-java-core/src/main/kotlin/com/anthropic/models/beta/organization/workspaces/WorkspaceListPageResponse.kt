...
private constructor(
    private val data: JsonField<List<BetaWorkspace>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaWorkspace>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaWorkspace> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BetaWorkspace>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BetaWorkspace>>? = null
        ...
        internal fun from(workspaceListPageResponse: WorkspaceListPageResponse) = apply {
            ...
            firstId = workspaceListPageResponse.firstId
            hasMore = workspaceListPageResponse.hasMore
            lastId = workspaceListPageResponse.lastId
            additionalProperties = workspaceListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<BetaWorkspace>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaWorkspace>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<BetaWorkspace>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaWorkspace] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaWorkspace) = apply {
            this.data =
    ...
    override fun toString() =
        "WorkspaceListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
