...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(serviceAccountListParams: ServiceAccountListParams) = apply {
            includeArchived = serviceAccountListParams.includeArchived
    ...
    override fun toString() =
        "ServiceAccountListParams{includeArchived=$includeArchived, limit=$limit, page=$page, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
