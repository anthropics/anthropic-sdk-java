...
private constructor(
    ...
    /**
     * The `signature` value of this thinking block, exactly as returned by the API in a previous
     * response. Used to verify that the block was generated by Claude.
     *
     * Thinking blocks must be passed back unmodified and in their original order; a modified block
     * results in a 400 `invalid_request_error`.
     *
