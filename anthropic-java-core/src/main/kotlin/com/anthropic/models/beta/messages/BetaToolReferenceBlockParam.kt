...
private constructor(
    ...
    ) : this(toolName, type, cacheControl, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaToolReferenceBlockParam] with the required
         * [toolName] set to the given value.
         */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaToolReferenceBlockParam: BetaToolReferenceBlockParam) = apply {
            ...
            additionalProperties = betaToolReferenceBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaToolReferenceBlockParam =
     ...
     *   expected type.
     */
    fun validate(): BetaToolReferenceBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolReferenceBlockParam &&
    ...
    override fun toString() =
        "BetaToolReferenceBlockParam{toolName=$toolName, type=$type, cacheControl=$cacheControl, additionalProperties=$additionalProperties}"
}
