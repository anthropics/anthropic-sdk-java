...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): IssuerListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [IssuerListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IssuerListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(issuerListParams: IssuerListParams) = apply {
            includeArchived = issuerListParams.includeArchived
            limit = issuerListParams.limit
            page = issuerListParams.page
            betas = issuerListParams.betas?.toMutableList()
            additionalHeaders = issuerListParams.additionalHeaders.toBuilder()
            additionalQueryParams = issuerListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IssuerListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IssuerListParams =
            IssuerListParams(
                includeArchived,
                limit,
                page,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IssuerListParams &&
    ...
    override fun toString() =
        "IssuerListParams{includeArchived=$includeArchived, limit=$limit, page=$page, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
