...
private constructor(
    private val data: JsonField<List<BetaManagedAgentsAgent>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaManagedAgentsAgent>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<BetaManagedAgentsAgent>> = data
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [AgentListPageResponse] with the required [data] set to
         * the given value.
         */
        @JvmStatic fun of(data: List<BetaManagedAgentsAgent>) = builder().data(data).build()
    }

    /** A builder for [AgentListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BetaManagedAgentsAgent>>? = null
        ...
        internal fun from(agentListPageResponse: AgentListPageResponse) = apply {
            data =
                agentListPageResponse.data.map { it.toMutableList() }.takeUnless { it.isMissing() }
            nextPage = agentListPageResponse.nextPage
            additionalProperties = agentListPageResponse.additionalProperties.toMutableMap()
        }

        /** List of agents. */
        fun data(data: List<BetaManagedAgentsAgent>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaManagedAgentsAgent>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<BetaManagedAgentsAgent>>) = apply {
         ...
         */
        fun addData(data: BetaManagedAgentsAgent) = apply {
            this.data =
    ...
    override fun toString() =
        "AgentListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
