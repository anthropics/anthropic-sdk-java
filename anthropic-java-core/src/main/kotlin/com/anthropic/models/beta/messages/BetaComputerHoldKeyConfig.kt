...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaComputerHoldKeyConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaComputerHoldKeyConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerHoldKeyConfig: BetaComputerHoldKeyConfig) = apply {
            deferLoading = betaComputerHoldKeyConfig.deferLoading
            enabled = betaComputerHoldKeyConfig.enabled
            additionalProperties = betaComputerHoldKeyConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerHoldKeyConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerHoldKeyConfig =
            BetaComputerHoldKeyConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaComputerHoldKeyConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerHoldKeyConfig &&
    ...
    override fun toString() =
        "BetaComputerHoldKeyConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
