...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(environmentCreateParams: EnvironmentCreateParams) = apply {
            ...
            workspaceId = environmentCreateParams.workspaceId
    ...
    override fun toString() =
        "EnvironmentCreateParams{betas=$betas, workspaceId=$workspaceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
