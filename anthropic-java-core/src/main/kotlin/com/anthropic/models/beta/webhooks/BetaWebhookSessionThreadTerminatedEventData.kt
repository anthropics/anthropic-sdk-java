...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.thread_terminated")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.thread_terminated")
        ...
        internal fun from(
            ...
            id = betaWebhookSessionThreadTerminatedEventData.id
            organizationId = betaWebhookSessionThreadTerminatedEventData.organizationId
            sessionThreadId = betaWebhookSessionThreadTerminatedEventData.sessionThreadId
            type = betaWebhookSessionThreadTerminatedEventData.type
            workspaceId = betaWebhookSessionThreadTerminatedEventData.workspaceId
            additionalProperties =
                betaWebhookSessionThreadTerminatedEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookSessionThreadTerminatedEventData =
            BetaWebhookSessionThreadTerminatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionThreadTerminatedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        sessionThreadId()
        _type().let {
            if (it != JsonValue.from("session.thread_terminated")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.thread_terminated")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionThreadTerminatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionThreadTerminatedEventData{id=$id, organizationId=$organizationId, sessionThreadId=$sessionThreadId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
