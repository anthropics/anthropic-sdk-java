...
private constructor(
...
) : Page<BetaFederationRuleWorkspace> {
     ...
     */
    fun data(): List<BetaFederationRuleWorkspace> =
    ...
    override fun items(): List<BetaFederationRuleWorkspace> = data()
    ...
    fun autoPager(): AutoPager<BetaFederationRuleWorkspace> = AutoPager.from(this)
