...
private constructor(
    private val data: JsonField<List<BetaWorkspaceMember>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaWorkspaceMember>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaWorkspaceMember> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BetaWorkspaceMember>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MemberListPageResponse].
         *
    ...
    /** A builder for [MemberListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BetaWorkspaceMember>>? = null
        ...
        @JvmSynthetic
        internal fun from(memberListPageResponse: MemberListPageResponse) = apply {
            data =
                memberListPageResponse.data.map { it.toMutableList() }.takeUnless { it.isMissing() }
            firstId = memberListPageResponse.firstId
            hasMore = memberListPageResponse.hasMore
            lastId = memberListPageResponse.lastId
            additionalProperties = memberListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<BetaWorkspaceMember>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaWorkspaceMember>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<BetaWorkspaceMember>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaWorkspaceMember] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaWorkspaceMember) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [MemberListPageResponse].
         *
         ...
         */
        fun build(): MemberListPageResponse =
     ...
     *   expected type.
     */
    fun validate(): MemberListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MemberListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MemberListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
