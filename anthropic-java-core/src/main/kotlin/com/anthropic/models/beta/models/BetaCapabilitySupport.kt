...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): BetaCapabilitySupport =
    ...
    fun validate(): BetaCapabilitySupport = apply {
        if (validated) {
            return@apply
        }
     ...
     */
    @JvmSynthetic internal fun validity(): Int = (if (supported.asKnown().isPresent) 1 else 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaCapabilitySupport &&
    ...
    override fun toString() =
        "BetaCapabilitySupport{supported=$supported, additionalProperties=$additionalProperties}"
}
