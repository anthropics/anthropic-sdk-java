...
private constructor(
     ...
     * ```java
     * JsonValue.from("tool_search_tool_bm25")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaToolSearchToolBm25_20251119] with the required
    ...
    class Builder internal constructor() {
        ...
        private var name: JsonValue = JsonValue.from("tool_search_tool_bm25")
        ...
        @JvmSynthetic
        internal fun from(betaToolSearchToolBm25_20251119: BetaToolSearchToolBm25_20251119) =
            apply {
                ...
                additionalProperties =
                    betaToolSearchToolBm25_20251119.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaToolSearchToolBm25_20251119 =
            BetaToolSearchToolBm25_20251119(
                name,
     ...
     *   expected type.
     */
    fun validate(): BetaToolSearchToolBm25_20251119 = apply {
        if (validated) {
            return@apply
        }

        _name().let {
            if (it != JsonValue.from("tool_search_tool_bm25")) {
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        fun value(): Value =
            when (this) {
                TOOL_SEARCH_TOOL_BM25_20251119 -> Value.TOOL_SEARCH_TOOL_BM25_20251119
        ...
        fun known(): Known =
            when (this) {
                TOOL_SEARCH_TOOL_BM25_20251119 -> Known.TOOL_SEARCH_TOOL_BM25_20251119
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolSearchToolBm25_20251119 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaToolSearchToolBm25_20251119{name=$name, type=$type, allowedCallers=$allowedCallers, cacheControl=$cacheControl, deferLoading=$deferLoading, strict=$strict, additionalProperties=$additionalProperties}"
}
