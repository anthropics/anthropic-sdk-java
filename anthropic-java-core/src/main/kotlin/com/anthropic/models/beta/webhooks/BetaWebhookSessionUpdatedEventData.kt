...
private constructor(
    ...
    /** A builder for [BetaWebhookSessionUpdatedEventData]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaWebhookSessionUpdatedEventData: BetaWebhookSessionUpdatedEventData) =
            apply {
                id = betaWebhookSessionUpdatedEventData.id
                organizationId = betaWebhookSessionUpdatedEventData.organizationId
                type = betaWebhookSessionUpdatedEventData.type
                workspaceId = betaWebhookSessionUpdatedEventData.workspaceId
                additionalProperties =
                    betaWebhookSessionUpdatedEventData.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookSessionUpdatedEventData].
         *
         ...
         */
        fun build(): BetaWebhookSessionUpdatedEventData =
            BetaWebhookSessionUpdatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionUpdatedEventData = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionUpdatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionUpdatedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
