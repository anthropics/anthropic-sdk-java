...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(workListParams: WorkListParams) = apply {
            environmentId = workListParams.environmentId
            limit = workListParams.limit
            page = workListParams.page
            betas = workListParams.betas?.toMutableList()
            additionalHeaders = workListParams.additionalHeaders.toBuilder()
            additionalQueryParams = workListParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WorkListParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(environmentId, limit, page, betas, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "WorkListParams{environmentId=$environmentId, limit=$limit, page=$page, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
