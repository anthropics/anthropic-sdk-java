...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CertificateListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CertificateListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CertificateListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(certificateListParams: CertificateListParams) = apply {
            tunnelId = certificateListParams.tunnelId
            includeArchived = certificateListParams.includeArchived
            limit = certificateListParams.limit
            page = certificateListParams.page
            betas = certificateListParams.betas?.toMutableList()
            workspaceId = certificateListParams.workspaceId
            additionalHeaders = certificateListParams.additionalHeaders.toBuilder()
            additionalQueryParams = certificateListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CertificateListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CertificateListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CertificateListParams &&
    ...
    override fun toString() =
        "CertificateListParams{tunnelId=$tunnelId, includeArchived=$includeArchived, limit=$limit, page=$page, betas=$betas, workspaceId=$workspaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
