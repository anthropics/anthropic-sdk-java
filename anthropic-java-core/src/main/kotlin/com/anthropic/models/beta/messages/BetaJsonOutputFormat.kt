...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaJsonOutputFormat] with the required [schema] set to
         * the given value.
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaJsonOutputFormat: BetaJsonOutputFormat) = apply {
            schema = betaJsonOutputFormat.schema
            type = betaJsonOutputFormat.type
            additionalProperties = betaJsonOutputFormat.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaJsonOutputFormat =
     ...
     *   expected type.
     */
    fun validate(): BetaJsonOutputFormat = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaJsonOutputFormat &&
            schema == other.schema &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaJsonOutputFormat{schema=$schema, type=$type, additionalProperties=$additionalProperties}"
}
