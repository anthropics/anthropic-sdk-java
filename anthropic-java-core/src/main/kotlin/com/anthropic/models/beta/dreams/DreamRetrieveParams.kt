...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DreamRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DreamRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DreamRetrieveParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DreamRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DreamRetrieveParams =
            DreamRetrieveParams(
                dreamId,
                betas?.toImmutable(),
