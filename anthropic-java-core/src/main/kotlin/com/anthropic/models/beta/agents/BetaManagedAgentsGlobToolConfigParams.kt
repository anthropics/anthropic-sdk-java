...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsGlobToolConfigParams]. */
    class Builder internal constructor() {

        private var name: JsonValue = JsonValue.from("glob")
        ...
        internal fun from(
            ...
            name = betaManagedAgentsGlobToolConfigParams.name
            enabled = betaManagedAgentsGlobToolConfigParams.enabled
            permissionPolicy = betaManagedAgentsGlobToolConfigParams.permissionPolicy
            type = betaManagedAgentsGlobToolConfigParams.type
            additionalProperties =
                betaManagedAgentsGlobToolConfigParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsGlobToolConfigParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaManagedAgentsGlobToolConfigParams =
            BetaManagedAgentsGlobToolConfigParams(
                name,
                enabled,
                permissionPolicy,
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsGlobToolConfigParams = apply {
        if (validated) {
            return@apply
        }

        _name().let {
            if (it != JsonValue.from("glob")) {
    ...
    internal fun validity(): Int =
        name.let { if (it == JsonValue.from("glob")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsGlobToolConfigParams &&
            name == other.name &&
    ...
    override fun toString() =
        "BetaManagedAgentsGlobToolConfigParams{name=$name, enabled=$enabled, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
