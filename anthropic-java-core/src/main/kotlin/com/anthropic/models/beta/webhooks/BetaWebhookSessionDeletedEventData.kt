...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.deleted")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.deleted")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookSessionDeletedEventData: BetaWebhookSessionDeletedEventData) =
            apply {
                id = betaWebhookSessionDeletedEventData.id
                organizationId = betaWebhookSessionDeletedEventData.organizationId
                type = betaWebhookSessionDeletedEventData.type
                workspaceId = betaWebhookSessionDeletedEventData.workspaceId
                additionalProperties =
                    betaWebhookSessionDeletedEventData.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaWebhookSessionDeletedEventData =
            BetaWebhookSessionDeletedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionDeletedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.deleted")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionDeletedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionDeletedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
