...
class BetaWorkspaceRole @JsonCreator private constructor(private val value: JsonField<String>) :
    ...
    /** An enum containing [BetaWorkspaceRole]'s known values. */
    enum class Known {
        WORKSPACE_ADMIN,
        WORKSPACE_BILLING,
        WORKSPACE_DEVELOPER,
    ...
    /**
     * An enum containing [BetaWorkspaceRole]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [BetaWorkspaceRole] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        WORKSPACE_USER,
        /**
         * An enum member indicating that [BetaWorkspaceRole] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun value(): Value =
        when (this) {
            ...
            WORKSPACE_BILLING -> Value.WORKSPACE_BILLING
    ...
    fun known(): Known =
        when (this) {
            ...
            WORKSPACE_BILLING -> Known.WORKSPACE_BILLING
            ...
            else -> throw AnthropicInvalidDataException("Unknown BetaWorkspaceRole: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): BetaWorkspaceRole = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWorkspaceRole && value == other.value
    }
