...
private constructor(
    ...
    ) : this(description, rubric, type, maxIterations, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        private var maxIterations: JsonField<Int> = JsonMissing.of()
        ...
        internal fun from(
            ...
            description = betaManagedAgentsUserDefineOutcomeEventParams.description
            rubric = betaManagedAgentsUserDefineOutcomeEventParams.rubric
            type = betaManagedAgentsUserDefineOutcomeEventParams.type
            maxIterations = betaManagedAgentsUserDefineOutcomeEventParams.maxIterations
            additionalProperties =
                betaManagedAgentsUserDefineOutcomeEventParams.additionalProperties.toMutableMap()
        }
        ...
        fun rubric(file: BetaManagedAgentsFileRubricParams) = rubric(Rubric.ofFile(file))
        ...
        fun rubric(text: BetaManagedAgentsTextRubricParams) = rubric(Rubric.ofText(text))
         ...
         */
        fun build(): BetaManagedAgentsUserDefineOutcomeEventParams =
            BetaManagedAgentsUserDefineOutcomeEventParams(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsUserDefineOutcomeEventParams = apply {
        if (validated) {
            return@apply
        }
    ...
    class Rubric
    private constructor(
        private val file: BetaManagedAgentsFileRubricParams? = null,
        private val text: BetaManagedAgentsTextRubricParams? = null,
        ...
        fun text(): Optional<BetaManagedAgentsTextRubricParams> = Optional.ofNullable(text)
        ...
        /** Rubric referenced by a file uploaded via the Files API. */
        fun asFile(): BetaManagedAgentsFileRubricParams = file.getOrThrow("file")

        /** Rubric content provided inline as text. */
        fun asText(): BetaManagedAgentsTextRubricParams = text.getOrThrow("text")
         ...
         *     @Override
         *     public Optional<String> visitFile(BetaManagedAgentsFileRubricParams file) {
        ...
        companion object {
            ...
            /** Rubric referenced by a file uploaded via the Files API. */
            @JvmStatic fun ofFile(file: BetaManagedAgentsFileRubricParams) = Rubric(file = file)

            /** Rubric content provided inline as text. */
            @JvmStatic fun ofText(text: BetaManagedAgentsTextRubricParams) = Rubric(text = text)
        }
        ...
        interface Visitor<out T> {
            ...
            /** Rubric referenced by a file uploaded via the Files API. */
            fun visitFile(file: BetaManagedAgentsFileRubricParams): T

            /** Rubric content provided inline as text. */
            fun visitText(text: BetaManagedAgentsTextRubricParams): T
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsUserDefineOutcomeEventParams &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(description, rubric, type, maxIterations, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsUserDefineOutcomeEventParams{description=$description, rubric=$rubric, type=$type, maxIterations=$maxIterations, additionalProperties=$additionalProperties}"
}
