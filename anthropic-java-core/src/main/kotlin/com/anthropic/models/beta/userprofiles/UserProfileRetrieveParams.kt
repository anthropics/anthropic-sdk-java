...
/** Get User Profile */
class UserProfileRetrieveParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UserProfileRetrieveParams = builder().build()
    ...
    /** A builder for [UserProfileRetrieveParams]. */
    class Builder internal constructor() {
         ...
         */
        fun build(): UserProfileRetrieveParams =
