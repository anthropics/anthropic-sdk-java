...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserSwitchTabConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserSwitchTabConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserSwitchTabConfig: BetaBrowserSwitchTabConfig) = apply {
            deferLoading = betaBrowserSwitchTabConfig.deferLoading
            enabled = betaBrowserSwitchTabConfig.enabled
            additionalProperties = betaBrowserSwitchTabConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserSwitchTabConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserSwitchTabConfig =
            BetaBrowserSwitchTabConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserSwitchTabConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserSwitchTabConfig &&
    ...
    override fun toString() =
        "BetaBrowserSwitchTabConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
