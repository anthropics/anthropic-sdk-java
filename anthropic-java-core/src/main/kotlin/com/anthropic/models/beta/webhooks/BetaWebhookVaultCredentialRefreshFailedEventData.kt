...
private constructor(
     ...
     * ```java
     * JsonValue.from("vault_credential.refresh_failed")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("vault_credential.refresh_failed")
        ...
        internal fun from(
            ...
            id = betaWebhookVaultCredentialRefreshFailedEventData.id
            organizationId = betaWebhookVaultCredentialRefreshFailedEventData.organizationId
            type = betaWebhookVaultCredentialRefreshFailedEventData.type
            vaultId = betaWebhookVaultCredentialRefreshFailedEventData.vaultId
            workspaceId = betaWebhookVaultCredentialRefreshFailedEventData.workspaceId
         ...
         */
        fun build(): BetaWebhookVaultCredentialRefreshFailedEventData =
            BetaWebhookVaultCredentialRefreshFailedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookVaultCredentialRefreshFailedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("vault_credential.refresh_failed")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("vault_credential.refresh_failed")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookVaultCredentialRefreshFailedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookVaultCredentialRefreshFailedEventData{id=$id, organizationId=$organizationId, type=$type, vaultId=$vaultId, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
