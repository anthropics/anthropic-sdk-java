...
private constructor(
     ...
     * ```java
     * JsonValue.from("deployment.deleted")
     * ```
     *
    ...
    /** A builder for [BetaWebhookDeploymentDeletedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("deployment.deleted")
        ...
        internal fun from(
            ...
            id = betaWebhookDeploymentDeletedEventData.id
            organizationId = betaWebhookDeploymentDeletedEventData.organizationId
            type = betaWebhookDeploymentDeletedEventData.type
            workspaceId = betaWebhookDeploymentDeletedEventData.workspaceId
            additionalProperties =
                betaWebhookDeploymentDeletedEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookDeploymentDeletedEventData].
         *
         ...
         */
        fun build(): BetaWebhookDeploymentDeletedEventData =
            BetaWebhookDeploymentDeletedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookDeploymentDeletedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("deployment.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("deployment.deleted")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookDeploymentDeletedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookDeploymentDeletedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
