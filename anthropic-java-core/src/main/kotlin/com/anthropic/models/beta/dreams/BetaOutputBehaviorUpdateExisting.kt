...
private constructor(
    ...
    /** A builder for [BetaOutputBehaviorUpdateExisting]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaOutputBehaviorUpdateExisting: BetaOutputBehaviorUpdateExisting) =
            apply {
                memoryStoreId = betaOutputBehaviorUpdateExisting.memoryStoreId
                type = betaOutputBehaviorUpdateExisting.type
        ...
        /**
         * Returns an immutable instance of [BetaOutputBehaviorUpdateExisting].
         *
         ...
         */
        fun build(): BetaOutputBehaviorUpdateExisting =
            BetaOutputBehaviorUpdateExisting(
     ...
     *   expected type.
     */
    fun validate(): BetaOutputBehaviorUpdateExisting = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaOutputBehaviorUpdateExisting &&
    ...
    override fun toString() =
        "BetaOutputBehaviorUpdateExisting{memoryStoreId=$memoryStoreId, type=$type, additionalProperties=$additionalProperties}"
}
