...
private constructor(
     ...
     * ```java
     * JsonValue.from("messages_changed")
     * ```
     *
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaCacheMissMessagesChanged] with the required
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("messages_changed")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaCacheMissMessagesChanged: BetaCacheMissMessagesChanged) = apply {
            cacheMissedInputTokens = betaCacheMissMessagesChanged.cacheMissedInputTokens
            type = betaCacheMissMessagesChanged.type
            additionalProperties = betaCacheMissMessagesChanged.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaCacheMissMessagesChanged =
     ...
     *   expected type.
     */
    fun validate(): BetaCacheMissMessagesChanged = apply {
        if (validated) {
            return@apply
        }
        ...
        cacheMissedInputTokens()
        _type().let {
            if (it != JsonValue.from("messages_changed")) {
    ...
    internal fun validity(): Int =
        (if (cacheMissedInputTokens.asKnown().isPresent) 1 else 0) +
            type.let { if (it == JsonValue.from("messages_changed")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaCacheMissMessagesChanged &&
    ...
    override fun toString() =
        "BetaCacheMissMessagesChanged{cacheMissedInputTokens=$cacheMissedInputTokens, type=$type, additionalProperties=$additionalProperties}"
}
