...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            content = betaEncryptedCodeExecutionResultBlockParam.content.map { it.toMutableList() }
            encryptedStdout = betaEncryptedCodeExecutionResultBlockParam.encryptedStdout
            returnCode = betaEncryptedCodeExecutionResultBlockParam.returnCode
            stderr = betaEncryptedCodeExecutionResultBlockParam.stderr
            type = betaEncryptedCodeExecutionResultBlockParam.type
            additionalProperties =
                betaEncryptedCodeExecutionResultBlockParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaEncryptedCodeExecutionResultBlockParam =
            BetaEncryptedCodeExecutionResultBlockParam(
    ...
    fun validate(): BetaEncryptedCodeExecutionResultBlockParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaEncryptedCodeExecutionResultBlockParam &&
    ...
    override fun toString() =
        "BetaEncryptedCodeExecutionResultBlockParam{content=$content, encryptedStdout=$encryptedStdout, returnCode=$returnCode, stderr=$stderr, type=$type, additionalProperties=$additionalProperties}"
}
