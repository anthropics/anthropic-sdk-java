...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = edit.accept(new Edit.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitClearToolUses20250919(BetaClearToolUses20250919Edit clearToolUses20250919) {
        ...
        class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            fun value(): Value =
                when (this) {
                    ...
                    COMPACT_20260112 -> Value.COMPACT_20260112
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    ...
                    COMPACT_20260112 -> Known.COMPACT_20260112
