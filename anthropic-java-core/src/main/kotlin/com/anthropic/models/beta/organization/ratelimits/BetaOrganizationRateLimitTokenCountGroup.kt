...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaOrganizationRateLimitTokenCountGroup] with the
         * required [id] set to the given value.
         */
        @JvmStatic fun of(id: String) = builder().id(id).build()
    }

    /** A builder for [BetaOrganizationRateLimitTokenCountGroup]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("token_count")
        ...
        internal fun from(
            ...
            id = betaOrganizationRateLimitTokenCountGroup.id
            type = betaOrganizationRateLimitTokenCountGroup.type
            additionalProperties =
                betaOrganizationRateLimitTokenCountGroup.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaOrganizationRateLimitTokenCountGroup].
         *
         ...
         */
        fun build(): BetaOrganizationRateLimitTokenCountGroup =
            BetaOrganizationRateLimitTokenCountGroup(
                checkRequired("id", id),
                type,
     ...
     *   expected type.
     */
    fun validate(): BetaOrganizationRateLimitTokenCountGroup = apply {
        if (validated) {
            return@apply
        }
        ...
        id()
        _type().let {
            if (it != JsonValue.from("token_count")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            type.let { if (it == JsonValue.from("token_count")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaOrganizationRateLimitTokenCountGroup &&
            id == other.id &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaOrganizationRateLimitTokenCountGroup{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
