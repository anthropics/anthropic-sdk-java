...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsUserLocation]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsUserLocation: BetaManagedAgentsUserLocation) = apply {
            type = betaManagedAgentsUserLocation.type
            city = betaManagedAgentsUserLocation.city
            country = betaManagedAgentsUserLocation.country
            region = betaManagedAgentsUserLocation.region
            timezone = betaManagedAgentsUserLocation.timezone
            additionalProperties = betaManagedAgentsUserLocation.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsUserLocation].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaManagedAgentsUserLocation =
            BetaManagedAgentsUserLocation(
                type,
                city,
                country,
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsUserLocation = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsUserLocation &&
            type == other.type &&
            city == other.city &&
    ...
    override fun toString() =
        "BetaManagedAgentsUserLocation{type=$type, city=$city, country=$country, region=$region, timezone=$timezone, additionalProperties=$additionalProperties}"
}
