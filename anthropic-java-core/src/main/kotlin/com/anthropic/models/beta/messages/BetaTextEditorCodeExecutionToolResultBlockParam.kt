...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitBetaTextEditorCodeExecutionToolResultErrorParam(BetaTextEditorCodeExecutionToolResultErrorParam betaTextEditorCodeExecutionToolResultErrorParam) {
         *         return Optional.of(betaTextEditorCodeExecutionToolResultErrorParam.toString());
         *     }
         *
         *     // ...
         *
