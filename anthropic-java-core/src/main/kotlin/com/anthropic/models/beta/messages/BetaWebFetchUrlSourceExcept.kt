...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaWebFetchUrlSourceExcept].
         *
        ...
        /**
         * Returns an immutable instance of [BetaWebFetchUrlSourceExcept] with the required [tools]
    ...
    /** A builder for [BetaWebFetchUrlSourceExcept]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaWebFetchUrlSourceExcept: BetaWebFetchUrlSourceExcept) = apply {
            tools =
                betaWebFetchUrlSourceExcept.tools
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            type = betaWebFetchUrlSourceExcept.type
            additionalProperties = betaWebFetchUrlSourceExcept.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebFetchUrlSourceExcept].
         *
         ...
         */
        fun build(): BetaWebFetchUrlSourceExcept =
     ...
     *   expected type.
     */
    fun validate(): BetaWebFetchUrlSourceExcept = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebFetchUrlSourceExcept &&
            tools == other.tools &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaWebFetchUrlSourceExcept{tools=$tools, type=$type, additionalProperties=$additionalProperties}"
}
