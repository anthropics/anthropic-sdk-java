...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = betaManagedAgentsPlainTextDocumentSource.data
            mediaType = betaManagedAgentsPlainTextDocumentSource.mediaType
            type = betaManagedAgentsPlainTextDocumentSource.type
            additionalProperties =
                betaManagedAgentsPlainTextDocumentSource.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsPlainTextDocumentSource =
            BetaManagedAgentsPlainTextDocumentSource(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsPlainTextDocumentSource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsPlainTextDocumentSource &&
            data == other.data &&
    ...
    override fun toString() =
        "BetaManagedAgentsPlainTextDocumentSource{data=$data, mediaType=$mediaType, type=$type, additionalProperties=$additionalProperties}"
}
