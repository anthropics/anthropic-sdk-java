...
private constructor(
    private val data: JsonField<List<BetaOrganizationInvite>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaOrganizationInvite>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaOrganizationInvite> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<BetaOrganizationInvite>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BetaOrganizationInvite>>? = null
        ...
        internal fun from(inviteListPageResponse: InviteListPageResponse) = apply {
            data =
                inviteListPageResponse.data.map { it.toMutableList() }.takeUnless { it.isMissing() }
        ...
        fun data(data: List<BetaOrganizationInvite>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaOrganizationInvite>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<BetaOrganizationInvite>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaOrganizationInvite] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaOrganizationInvite) = apply {
            this.data =
    ...
    override fun toString() =
        "InviteListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
