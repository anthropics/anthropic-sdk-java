...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            memoryStoreId = betaManagedAgentsMemoryStoreResourceParam.memoryStoreId
            type = betaManagedAgentsMemoryStoreResourceParam.type
            access = betaManagedAgentsMemoryStoreResourceParam.access
            instructions = betaManagedAgentsMemoryStoreResourceParam.instructions
            additionalProperties =
                betaManagedAgentsMemoryStoreResourceParam.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsMemoryStoreResourceParam =
            BetaManagedAgentsMemoryStoreResourceParam(
    ...
    fun validate(): BetaManagedAgentsMemoryStoreResourceParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsMemoryStoreResourceParam &&
    ...
    override fun toString() =
        "BetaManagedAgentsMemoryStoreResourceParam{memoryStoreId=$memoryStoreId, type=$type, access=$access, instructions=$instructions, additionalProperties=$additionalProperties}"
}
