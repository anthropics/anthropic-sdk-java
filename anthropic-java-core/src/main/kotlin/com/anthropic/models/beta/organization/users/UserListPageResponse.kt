...
private constructor(
    private val data: JsonField<List<BetaOrganizationUser>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaOrganizationUser>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaOrganizationUser> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BetaOrganizationUser>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<BetaOrganizationUser>>? = null
        ...
        internal fun from(userListPageResponse: UserListPageResponse) = apply {
            data =
                userListPageResponse.data.map { it.toMutableList() }.takeUnless { it.isMissing() }
            firstId = userListPageResponse.firstId
            hasMore = userListPageResponse.hasMore
            lastId = userListPageResponse.lastId
            additionalProperties = userListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<BetaOrganizationUser>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaOrganizationUser>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<BetaOrganizationUser>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaOrganizationUser] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaOrganizationUser) = apply {
            this.data =
    ...
    override fun toString() =
        "UserListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, additionalProperties=$additionalProperties}"
}
