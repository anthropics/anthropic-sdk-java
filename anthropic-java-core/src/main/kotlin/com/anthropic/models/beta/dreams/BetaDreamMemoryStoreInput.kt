...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaDreamMemoryStoreInput].
         *
    ...
    /** A builder for [BetaDreamMemoryStoreInput]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaDreamMemoryStoreInput: BetaDreamMemoryStoreInput) = apply {
            memoryStoreId = betaDreamMemoryStoreInput.memoryStoreId
            type = betaDreamMemoryStoreInput.type
        ...
        /**
         * Returns an immutable instance of [BetaDreamMemoryStoreInput].
         *
         ...
         */
        fun build(): BetaDreamMemoryStoreInput =
     ...
     *   expected type.
     */
    fun validate(): BetaDreamMemoryStoreInput = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaDreamMemoryStoreInput &&
    ...
    override fun toString() =
        "BetaDreamMemoryStoreInput{memoryStoreId=$memoryStoreId, type=$type, additionalProperties=$additionalProperties}"
}
