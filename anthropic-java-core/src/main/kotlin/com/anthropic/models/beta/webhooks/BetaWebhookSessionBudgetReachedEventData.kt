...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.budget_reached")
     * ```
     *
    ...
    /** A builder for [BetaWebhookSessionBudgetReachedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("session.budget_reached")
        ...
        internal fun from(
            ...
            id = betaWebhookSessionBudgetReachedEventData.id
            organizationId = betaWebhookSessionBudgetReachedEventData.organizationId
            type = betaWebhookSessionBudgetReachedEventData.type
            workspaceId = betaWebhookSessionBudgetReachedEventData.workspaceId
            additionalProperties =
                betaWebhookSessionBudgetReachedEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookSessionBudgetReachedEventData].
         *
         ...
         */
        fun build(): BetaWebhookSessionBudgetReachedEventData =
            BetaWebhookSessionBudgetReachedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionBudgetReachedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.budget_reached")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.budget_reached")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionBudgetReachedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionBudgetReachedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
