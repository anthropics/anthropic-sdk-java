...
private constructor(
    ...
    private val status: BetaManagedAgentsDeploymentStatus?,
    ...
    companion object {
        ...
        @JvmStatic fun none(): DeploymentListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DeploymentListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DeploymentListParams]. */
    class Builder internal constructor() {
        ...
        private var status: BetaManagedAgentsDeploymentStatus? = null
        ...
        @JvmSynthetic
        internal fun from(deploymentListParams: DeploymentListParams) = apply {
            agentId = deploymentListParams.agentId
            createdAtGte = deploymentListParams.createdAtGte
            createdAtLte = deploymentListParams.createdAtLte
            includeArchived = deploymentListParams.includeArchived
            limit = deploymentListParams.limit
            page = deploymentListParams.page
            status = deploymentListParams.status
            betas = deploymentListParams.betas?.toMutableList()
            workspaceId = deploymentListParams.workspaceId
            additionalHeaders = deploymentListParams.additionalHeaders.toBuilder()
        ...
        fun status(status: Optional<BetaManagedAgentsDeploymentStatus>) = status(status.getOrNull())
         ...
         */
        fun build(): DeploymentListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DeploymentListParams &&
    ...
    override fun toString() =
        "DeploymentListParams{agentId=$agentId, createdAtGte=$createdAtGte, createdAtLte=$createdAtLte, includeArchived=$includeArchived, limit=$limit, page=$page, status=$status, betas=$betas, workspaceId=$workspaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
