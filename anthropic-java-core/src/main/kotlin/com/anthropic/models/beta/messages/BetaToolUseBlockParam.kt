...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaToolUseBlockParam: BetaToolUseBlockParam) = apply {
            ...
            toolsetName = betaToolUseBlockParam.toolsetName
    ...
    override fun toString() =
        "BetaToolUseBlockParam{id=$id, input=$input, name=$name, type=$type, cacheControl=$cacheControl, caller=$caller, toolsetName=$toolsetName, additionalProperties=$additionalProperties}"
}
