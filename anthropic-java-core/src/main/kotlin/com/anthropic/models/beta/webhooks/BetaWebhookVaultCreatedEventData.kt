...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("vault.created")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookVaultCreatedEventData: BetaWebhookVaultCreatedEventData) =
            apply {
                id = betaWebhookVaultCreatedEventData.id
                organizationId = betaWebhookVaultCreatedEventData.organizationId
                type = betaWebhookVaultCreatedEventData.type
                workspaceId = betaWebhookVaultCreatedEventData.workspaceId
                additionalProperties =
                    betaWebhookVaultCreatedEventData.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaWebhookVaultCreatedEventData =
            BetaWebhookVaultCreatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookVaultCreatedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("vault.created")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("vault.created")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookVaultCreatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookVaultCreatedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
