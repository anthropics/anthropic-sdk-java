...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsAgentToolUseEvent: BetaManagedAgentsAgentToolUseEvent) =
            apply {
                id = betaManagedAgentsAgentToolUseEvent.id
                input = betaManagedAgentsAgentToolUseEvent.input
                name = betaManagedAgentsAgentToolUseEvent.name
         ...
         */
        fun build(): BetaManagedAgentsAgentToolUseEvent =
            BetaManagedAgentsAgentToolUseEvent(
                checkRequired("id", id),
    ...
    fun validate(): BetaManagedAgentsAgentToolUseEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsAgentToolUseEvent &&
            id == other.id &&
            input == other.input &&
            name == other.name &&
