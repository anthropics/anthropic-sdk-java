...
private constructor(
    ...
    /** A builder for [BetaWebhookAgentUpdatedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("agent.updated")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookAgentUpdatedEventData: BetaWebhookAgentUpdatedEventData) =
            apply {
                id = betaWebhookAgentUpdatedEventData.id
                organizationId = betaWebhookAgentUpdatedEventData.organizationId
                type = betaWebhookAgentUpdatedEventData.type
                workspaceId = betaWebhookAgentUpdatedEventData.workspaceId
                additionalProperties =
                    betaWebhookAgentUpdatedEventData.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookAgentUpdatedEventData].
         *
         ...
         */
        fun build(): BetaWebhookAgentUpdatedEventData =
            BetaWebhookAgentUpdatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookAgentUpdatedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("agent.updated")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.updated")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookAgentUpdatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookAgentUpdatedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
