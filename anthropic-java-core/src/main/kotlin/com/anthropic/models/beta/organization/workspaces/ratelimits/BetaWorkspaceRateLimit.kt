...
import com.anthropic.models.beta.organization.ratelimits.BetaOrganizationRateLimitBatchGroup
import com.anthropic.models.beta.organization.ratelimits.BetaOrganizationRateLimitFilesGroup
import com.anthropic.models.beta.organization.ratelimits.BetaOrganizationRateLimitModelGroup
import com.anthropic.models.beta.organization.ratelimits.BetaOrganizationRateLimitSkillsGroup
import com.anthropic.models.beta.organization.ratelimits.BetaOrganizationRateLimitTokenCountGroup
import com.anthropic.models.beta.organization.ratelimits.BetaOrganizationRateLimitWebSearchGroup
...
private constructor(
    ...
    ) : this(group, groupType, limits, models, rateLimitId, type, workspaceId, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaWorkspaceRateLimit: BetaWorkspaceRateLimit) = apply {
            group = betaWorkspaceRateLimit.group
    ...
    override fun toString() =
        "BetaWorkspaceRateLimit{group=$group, groupType=$groupType, limits=$limits, models=$models, rateLimitId=$rateLimitId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
