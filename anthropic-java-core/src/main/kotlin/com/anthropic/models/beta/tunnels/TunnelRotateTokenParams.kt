 ...
 *
 * Rotates a tunnel's connector token. Rotation invalidates the current token for new connections
 * and returns a fresh value; established connections are not severed. A connector restarted after
 * rotation must use the new value.
 */
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TunnelRotateTokenParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TunnelRotateTokenParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TunnelRotateTokenParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TunnelRotateTokenParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TunnelRotateTokenParams =
