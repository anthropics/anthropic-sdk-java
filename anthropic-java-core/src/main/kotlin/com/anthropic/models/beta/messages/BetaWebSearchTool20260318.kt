...
private constructor(
     ...
     * Expected to always return the following:
     * ```java
     * JsonValue.from("web_search_20260318")
     * ```
     *
     * However, this method can be useful for debugging and logging (e.g. if the server responded
     * with an unexpected value).
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaWebSearchTool20260318].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaWebSearchTool20260318]. */
    class Builder internal constructor() {

        private var name: JsonValue = JsonValue.from("web_search")
        private var type: JsonValue = JsonValue.from("web_search_20260318")
        ...
        @JvmSynthetic
        internal fun from(betaWebSearchTool20260318: BetaWebSearchTool20260318) = apply {
            name = betaWebSearchTool20260318.name
            type = betaWebSearchTool20260318.type
            allowedCallers =
                betaWebSearchTool20260318.allowedCallers
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            allowedDomains =
                betaWebSearchTool20260318.allowedDomains
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            blockedDomains =
                betaWebSearchTool20260318.blockedDomains
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            cacheControl = betaWebSearchTool20260318.cacheControl
            deferLoading = betaWebSearchTool20260318.deferLoading
            maxUses = betaWebSearchTool20260318.maxUses
            responseInclusion = betaWebSearchTool20260318.responseInclusion
            strict = betaWebSearchTool20260318.strict
            userLocation = betaWebSearchTool20260318.userLocation
            additionalProperties = betaWebSearchTool20260318.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebSearchTool20260318].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaWebSearchTool20260318 =
     ...
     *   expected type.
     */
    fun validate(): BetaWebSearchTool20260318 = apply {
        if (validated) {
            return@apply
        }
        ...
        _type().let {
            if (it != JsonValue.from("web_search_20260318")) {
    ...
    internal fun validity(): Int =
        name.let { if (it == JsonValue.from("web_search")) 1 else 0 } +
            type.let { if (it == JsonValue.from("web_search_20260318")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebSearchTool20260318 &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaWebSearchTool20260318{name=$name, type=$type, allowedCallers=$allowedCallers, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, cacheControl=$cacheControl, deferLoading=$deferLoading, maxUses=$maxUses, responseInclusion=$responseInclusion, strict=$strict, userLocation=$userLocation, additionalProperties=$additionalProperties}"
}
