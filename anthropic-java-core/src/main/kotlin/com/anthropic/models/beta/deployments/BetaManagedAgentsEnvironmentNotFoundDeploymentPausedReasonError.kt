...
private constructor(
    ...
    companion object {
         ...
         * [BetaManagedAgentsEnvironmentNotFoundDeploymentPausedReasonError] with the required
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): BetaManagedAgentsEnvironmentNotFoundDeploymentPausedReasonError =
            BetaManagedAgentsEnvironmentNotFoundDeploymentPausedReasonError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsEnvironmentNotFoundDeploymentPausedReasonError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsEnvironmentNotFoundDeploymentPausedReasonError &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaManagedAgentsEnvironmentNotFoundDeploymentPausedReasonError{type=$type, additionalProperties=$additionalProperties}"
}
