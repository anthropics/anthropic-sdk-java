...
/**
 * A tool defined by value, as a `compaction` block's `tool_changes` entry reports it: `definition`
 * is the tool's definition as it was sent, in the form of a `tools` entry, without `cache_control`.
 * Send it back unchanged with the block.
 */
class BetaToolChangeToolDefinition
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val definition: JsonField<BetaResponseToolUnion>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        definition: JsonField<BetaResponseToolUnion> = JsonMissing.of(),
        @JsonProperty("type") @ExcludeMissing type: JsonValue = JsonMissing.of(),
    ) : this(definition, type, mutableMapOf())

    fun toParam(): BetaToolChangeToolDefinitionParam =
        BetaToolChangeToolDefinitionParam.builder()
            .definition(_definition().map { it.toParam() })
            .build()
     ...
     */
    fun definition(): BetaResponseToolUnion = definition.getRequired("definition")
    ...
    @JsonProperty("definition")
    @ExcludeMissing
    fun _definition(): JsonField<BetaResponseToolUnion> = definition
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaToolChangeToolDefinition].
         *
        ...
        /**
         * Returns an immutable instance of [BetaToolChangeToolDefinition] with the required
    ...
    class Builder internal constructor() {
        ...
        private var definition: JsonField<BetaResponseToolUnion>? = null
        private var type: JsonValue = JsonValue.from("tool_definition")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaToolChangeToolDefinition: BetaToolChangeToolDefinition) = apply {
            definition = betaToolChangeToolDefinition.definition
            type = betaToolChangeToolDefinition.type
            additionalProperties = betaToolChangeToolDefinition.additionalProperties.toMutableMap()
        }

        fun definition(definition: BetaResponseToolUnion) = definition(JsonField.of(definition))

        /**
         * Sets [Builder.definition] to an arbitrary JSON value.
         *
         * You should usually call [Builder.definition] with a well-typed [BetaResponseToolUnion]
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun definition(definition: JsonField<BetaResponseToolUnion>) = apply {
        ...
        /**
         * Returns an immutable instance of [BetaToolChangeToolDefinition].
         *
         ...
         */
        fun build(): BetaToolChangeToolDefinition =
     ...
     *   expected type.
     */
    fun validate(): BetaToolChangeToolDefinition = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolChangeToolDefinition &&
    ...
    override fun toString() =
        "BetaToolChangeToolDefinition{definition=$definition, type=$type, additionalProperties=$additionalProperties}"
}
