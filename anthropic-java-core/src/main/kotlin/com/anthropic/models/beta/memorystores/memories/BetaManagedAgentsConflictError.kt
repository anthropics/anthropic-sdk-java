...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsConflictError] with the required
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsConflictError: BetaManagedAgentsConflictError) = apply {
            type = betaManagedAgentsConflictError.type
            message = betaManagedAgentsConflictError.message
            additionalProperties =
                betaManagedAgentsConflictError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsConflictError =
            BetaManagedAgentsConflictError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsConflictError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsConflictError &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaManagedAgentsConflictError{type=$type, message=$message, additionalProperties=$additionalProperties}"
}
