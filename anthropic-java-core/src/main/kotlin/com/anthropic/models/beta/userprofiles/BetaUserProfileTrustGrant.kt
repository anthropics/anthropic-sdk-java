...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaUserProfileTrustGrant: BetaUserProfileTrustGrant) = apply {
            status = betaUserProfileTrustGrant.status
            additionalProperties = betaUserProfileTrustGrant.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaUserProfileTrustGrant =
     ...
     *   expected type.
     */
    fun validate(): BetaUserProfileTrustGrant = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaUserProfileTrustGrant &&
            status == other.status &&
    ...
    override fun toString() =
        "BetaUserProfileTrustGrant{status=$status, additionalProperties=$additionalProperties}"
}
