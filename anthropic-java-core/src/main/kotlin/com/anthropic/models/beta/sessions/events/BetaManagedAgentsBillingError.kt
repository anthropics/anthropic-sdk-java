...
/**
 * The caller's organization or workspace cannot make model requests — out of credits or spend limit
 * reached. Retrying with the same credentials will not succeed; the caller must resolve the billing
 * state.
 */
...
private constructor(
    ...
    ) : this(message, retryStatus, type, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsBillingError: BetaManagedAgentsBillingError) = apply {
            message = betaManagedAgentsBillingError.message
            retryStatus = betaManagedAgentsBillingError.retryStatus
            type = betaManagedAgentsBillingError.type
            additionalProperties = betaManagedAgentsBillingError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsBillingError =
            BetaManagedAgentsBillingError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsBillingError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsBillingError &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(message, retryStatus, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsBillingError{message=$message, retryStatus=$retryStatus, type=$type, additionalProperties=$additionalProperties}"
}
