...
private constructor(
    ...
    /** A builder for [BetaWebhookAgentArchivedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("agent.archived")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookAgentArchivedEventData: BetaWebhookAgentArchivedEventData) =
            apply {
                id = betaWebhookAgentArchivedEventData.id
                organizationId = betaWebhookAgentArchivedEventData.organizationId
                type = betaWebhookAgentArchivedEventData.type
                workspaceId = betaWebhookAgentArchivedEventData.workspaceId
                additionalProperties =
                    betaWebhookAgentArchivedEventData.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookAgentArchivedEventData].
         *
         ...
         */
        fun build(): BetaWebhookAgentArchivedEventData =
            BetaWebhookAgentArchivedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookAgentArchivedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("agent.archived")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.archived")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookAgentArchivedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookAgentArchivedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
