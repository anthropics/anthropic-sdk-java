...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = betaManagedAgentsModelRequestFailedError.message
            retryStatus = betaManagedAgentsModelRequestFailedError.retryStatus
            type = betaManagedAgentsModelRequestFailedError.type
            additionalProperties =
                betaManagedAgentsModelRequestFailedError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsModelRequestFailedError =
            BetaManagedAgentsModelRequestFailedError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsModelRequestFailedError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsModelRequestFailedError &&
    ...
    override fun toString() =
        "BetaManagedAgentsModelRequestFailedError{message=$message, retryStatus=$retryStatus, type=$type, additionalProperties=$additionalProperties}"
}
