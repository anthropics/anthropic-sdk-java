...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsUserActor: BetaManagedAgentsUserActor) = apply {
            type = betaManagedAgentsUserActor.type
            userId = betaManagedAgentsUserActor.userId
            additionalProperties = betaManagedAgentsUserActor.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsUserActor =
    ...
    fun validate(): BetaManagedAgentsUserActor = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsUserActor &&
            type == other.type &&
            userId == other.userId &&
    ...
    override fun toString() =
        "BetaManagedAgentsUserActor{type=$type, userId=$userId, additionalProperties=$additionalProperties}"
}
