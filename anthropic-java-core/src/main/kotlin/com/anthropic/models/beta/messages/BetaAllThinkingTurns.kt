...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): BetaAllThinkingTurns =
            BetaAllThinkingTurns(type, additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): BetaAllThinkingTurns = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaAllThinkingTurns &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaAllThinkingTurns{type=$type, additionalProperties=$additionalProperties}"
}
