...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            mcpServerUrl = betaManagedAgentsStaticBearerAuthResponse.mcpServerUrl
            type = betaManagedAgentsStaticBearerAuthResponse.type
            additionalProperties =
                betaManagedAgentsStaticBearerAuthResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsStaticBearerAuthResponse =
            BetaManagedAgentsStaticBearerAuthResponse(
    ...
    fun validate(): BetaManagedAgentsStaticBearerAuthResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsStaticBearerAuthResponse &&
    ...
    override fun toString() =
        "BetaManagedAgentsStaticBearerAuthResponse{mcpServerUrl=$mcpServerUrl, type=$type, additionalProperties=$additionalProperties}"
}
