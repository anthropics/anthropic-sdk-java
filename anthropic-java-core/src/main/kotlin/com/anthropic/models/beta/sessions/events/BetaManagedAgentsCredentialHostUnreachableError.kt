 ...
 * environment's network policy does not permit.
 */
...
private constructor(
    ...
    ) : this(credentialId, message, retryStatus, type, vaultId, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            credentialId = betaManagedAgentsCredentialHostUnreachableError.credentialId
            message = betaManagedAgentsCredentialHostUnreachableError.message
            retryStatus = betaManagedAgentsCredentialHostUnreachableError.retryStatus
            type = betaManagedAgentsCredentialHostUnreachableError.type
            vaultId = betaManagedAgentsCredentialHostUnreachableError.vaultId
            additionalProperties =
                betaManagedAgentsCredentialHostUnreachableError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsCredentialHostUnreachableError =
            BetaManagedAgentsCredentialHostUnreachableError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsCredentialHostUnreachableError = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = retryStatus.accept(new RetryStatus.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitRetrying(BetaManagedAgentsRetryStatusRetrying retrying) {
         *         return Optional.of(retrying.toString());
         *     }
         *
         *     // ...
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsCredentialHostUnreachableError &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(credentialId, message, retryStatus, type, vaultId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsCredentialHostUnreachableError{credentialId=$credentialId, message=$message, retryStatus=$retryStatus, type=$type, vaultId=$vaultId, additionalProperties=$additionalProperties}"
}
