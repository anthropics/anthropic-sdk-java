...
private constructor(
    ...
    /** A builder for [BetaBrowserLeftClickDragConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserLeftClickDragConfig: BetaBrowserLeftClickDragConfig) = apply {
            deferLoading = betaBrowserLeftClickDragConfig.deferLoading
            enabled = betaBrowserLeftClickDragConfig.enabled
            additionalProperties =
                betaBrowserLeftClickDragConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserLeftClickDragConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserLeftClickDragConfig =
            BetaBrowserLeftClickDragConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserLeftClickDragConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserLeftClickDragConfig &&
    ...
    override fun toString() =
        "BetaBrowserLeftClickDragConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
