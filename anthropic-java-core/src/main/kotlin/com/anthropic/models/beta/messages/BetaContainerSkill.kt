...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaContainerSkill].
         *
    ...
    /** A builder for [BetaContainerSkill]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaContainerSkill: BetaContainerSkill) = apply {
            skillId = betaContainerSkill.skillId
            type = betaContainerSkill.type
            version = betaContainerSkill.version
            additionalProperties = betaContainerSkill.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaContainerSkill].
         *
     ...
     *   expected type.
     */
    fun validate(): BetaContainerSkill = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaContainerSkill &&
    ...
    override fun toString() =
        "BetaContainerSkill{skillId=$skillId, type=$type, version=$version, additionalProperties=$additionalProperties}"
}
