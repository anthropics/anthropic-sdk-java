...
private constructor(
    ...
    /**
     * ID of the memory store to permanently delete (a `memstore_...` identifier). Required.
     * Deletion cascades to all memories and memory versions in the store and cannot be undone.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): MemoryStoreDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MemoryStoreDeleteParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MemoryStoreDeleteParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(memoryStoreDeleteParams: MemoryStoreDeleteParams) = apply {
            ...
            additionalBodyProperties =
                memoryStoreDeleteParams.additionalBodyProperties.toMutableMap()
        }
         ...
         */
        fun build(): MemoryStoreDeleteParams =
