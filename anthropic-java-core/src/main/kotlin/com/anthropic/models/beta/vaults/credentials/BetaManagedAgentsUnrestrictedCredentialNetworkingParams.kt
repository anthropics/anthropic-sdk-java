...
private constructor(
    ...
    companion object {
         ...
         * [BetaManagedAgentsUnrestrictedCredentialNetworkingParams] with the required [type] set to
         * the given value.
         */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = betaManagedAgentsUnrestrictedCredentialNetworkingParams.type
         ...
         */
        fun build(): BetaManagedAgentsUnrestrictedCredentialNetworkingParams =
            BetaManagedAgentsUnrestrictedCredentialNetworkingParams(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsUnrestrictedCredentialNetworkingParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsUnrestrictedCredentialNetworkingParams &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaManagedAgentsUnrestrictedCredentialNetworkingParams{type=$type, additionalProperties=$additionalProperties}"
}
