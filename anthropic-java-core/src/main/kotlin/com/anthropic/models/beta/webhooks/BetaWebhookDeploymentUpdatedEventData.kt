...
private constructor(
     ...
     * ```java
     * JsonValue.from("deployment.updated")
     * ```
     *
    ...
    /** A builder for [BetaWebhookDeploymentUpdatedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("deployment.updated")
        ...
        internal fun from(
            ...
            id = betaWebhookDeploymentUpdatedEventData.id
            organizationId = betaWebhookDeploymentUpdatedEventData.organizationId
            type = betaWebhookDeploymentUpdatedEventData.type
            workspaceId = betaWebhookDeploymentUpdatedEventData.workspaceId
            additionalProperties =
                betaWebhookDeploymentUpdatedEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookDeploymentUpdatedEventData].
         *
         ...
         */
        fun build(): BetaWebhookDeploymentUpdatedEventData =
            BetaWebhookDeploymentUpdatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookDeploymentUpdatedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("deployment.updated")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("deployment.updated")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookDeploymentUpdatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookDeploymentUpdatedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
