...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = resourceUpdateResponse.accept(new ResourceUpdateResponse.Visitor<Optional<String>>() {
     *     @Override
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [ResourceUpdateResponse] whose [ofMemoryStore] variant
