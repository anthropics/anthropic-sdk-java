...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsDeletedMemoryStore.id
            type = betaManagedAgentsDeletedMemoryStore.type
         ...
         */
        fun build(): BetaManagedAgentsDeletedMemoryStore =
            BetaManagedAgentsDeletedMemoryStore(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsDeletedMemoryStore = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsDeletedMemoryStore &&
            id == other.id &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaManagedAgentsDeletedMemoryStore{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
