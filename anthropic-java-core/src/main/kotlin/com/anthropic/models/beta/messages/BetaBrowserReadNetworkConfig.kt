...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserReadNetworkConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserReadNetworkConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserReadNetworkConfig: BetaBrowserReadNetworkConfig) = apply {
            deferLoading = betaBrowserReadNetworkConfig.deferLoading
            enabled = betaBrowserReadNetworkConfig.enabled
            additionalProperties = betaBrowserReadNetworkConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserReadNetworkConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserReadNetworkConfig =
            BetaBrowserReadNetworkConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserReadNetworkConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserReadNetworkConfig &&
    ...
    override fun toString() =
        "BetaBrowserReadNetworkConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
