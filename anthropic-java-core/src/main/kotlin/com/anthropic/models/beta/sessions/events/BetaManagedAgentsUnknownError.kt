...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsUnknownError: BetaManagedAgentsUnknownError) = apply {
            message = betaManagedAgentsUnknownError.message
            retryStatus = betaManagedAgentsUnknownError.retryStatus
            type = betaManagedAgentsUnknownError.type
            additionalProperties = betaManagedAgentsUnknownError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsUnknownError =
            BetaManagedAgentsUnknownError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsUnknownError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsUnknownError &&
    ...
    override fun toString() =
        "BetaManagedAgentsUnknownError{message=$message, retryStatus=$retryStatus, type=$type, additionalProperties=$additionalProperties}"
}
