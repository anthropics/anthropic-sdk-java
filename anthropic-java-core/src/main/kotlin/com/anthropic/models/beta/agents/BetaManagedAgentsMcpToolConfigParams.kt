...
private constructor(
    ...
    ) : this(name, enabled, permissionPolicy, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsMcpToolConfigParams] with the required
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            name = betaManagedAgentsMcpToolConfigParams.name
            enabled = betaManagedAgentsMcpToolConfigParams.enabled
            permissionPolicy = betaManagedAgentsMcpToolConfigParams.permissionPolicy
            additionalProperties =
                betaManagedAgentsMcpToolConfigParams.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsMcpToolConfigParams =
            BetaManagedAgentsMcpToolConfigParams(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsMcpToolConfigParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsMcpToolConfigParams &&
            name == other.name &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(name, enabled, permissionPolicy, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsMcpToolConfigParams{name=$name, enabled=$enabled, permissionPolicy=$permissionPolicy, additionalProperties=$additionalProperties}"
}
