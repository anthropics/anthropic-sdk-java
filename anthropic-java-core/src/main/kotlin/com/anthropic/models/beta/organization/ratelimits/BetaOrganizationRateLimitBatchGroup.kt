...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaOrganizationRateLimitBatchGroup] with the required
         * [id] set to the given value.
         */
        @JvmStatic fun of(id: String) = builder().id(id).build()
    }

    /** A builder for [BetaOrganizationRateLimitBatchGroup]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("batch")
        ...
        internal fun from(
            ...
            id = betaOrganizationRateLimitBatchGroup.id
            type = betaOrganizationRateLimitBatchGroup.type
            additionalProperties =
                betaOrganizationRateLimitBatchGroup.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaOrganizationRateLimitBatchGroup].
         *
         ...
         */
        fun build(): BetaOrganizationRateLimitBatchGroup =
            BetaOrganizationRateLimitBatchGroup(
                checkRequired("id", id),
                type,
     ...
     *   expected type.
     */
    fun validate(): BetaOrganizationRateLimitBatchGroup = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            type.let { if (it == JsonValue.from("batch")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaOrganizationRateLimitBatchGroup &&
            id == other.id &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaOrganizationRateLimitBatchGroup{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
