...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(environmentListParams: EnvironmentListParams) = apply {
            ...
            workspaceId = environmentListParams.workspaceId
    ...
    override fun toString() =
        "EnvironmentListParams{includeArchived=$includeArchived, limit=$limit, page=$page, betas=$betas, workspaceId=$workspaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
