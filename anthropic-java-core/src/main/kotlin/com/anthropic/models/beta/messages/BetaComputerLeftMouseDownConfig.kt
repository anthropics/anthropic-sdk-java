...
private constructor(
    ...
    /** A builder for [BetaComputerLeftMouseDownConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerLeftMouseDownConfig: BetaComputerLeftMouseDownConfig) =
            apply {
                deferLoading = betaComputerLeftMouseDownConfig.deferLoading
                enabled = betaComputerLeftMouseDownConfig.enabled
                additionalProperties =
                    betaComputerLeftMouseDownConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaComputerLeftMouseDownConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerLeftMouseDownConfig =
            BetaComputerLeftMouseDownConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaComputerLeftMouseDownConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerLeftMouseDownConfig &&
    ...
    override fun toString() =
        "BetaComputerLeftMouseDownConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
