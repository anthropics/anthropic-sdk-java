...
private constructor(
    ...
    /** A builder for [BetaComputerLeftMouseUpConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerLeftMouseUpConfig: BetaComputerLeftMouseUpConfig) = apply {
            deferLoading = betaComputerLeftMouseUpConfig.deferLoading
            enabled = betaComputerLeftMouseUpConfig.enabled
            additionalProperties = betaComputerLeftMouseUpConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerLeftMouseUpConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerLeftMouseUpConfig =
            BetaComputerLeftMouseUpConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaComputerLeftMouseUpConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerLeftMouseUpConfig &&
    ...
    override fun toString() =
        "BetaComputerLeftMouseUpConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
