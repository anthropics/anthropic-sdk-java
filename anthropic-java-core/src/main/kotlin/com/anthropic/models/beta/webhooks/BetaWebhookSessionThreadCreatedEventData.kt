...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.thread_created")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.thread_created")
        ...
        internal fun from(
            ...
            id = betaWebhookSessionThreadCreatedEventData.id
            organizationId = betaWebhookSessionThreadCreatedEventData.organizationId
            sessionThreadId = betaWebhookSessionThreadCreatedEventData.sessionThreadId
            type = betaWebhookSessionThreadCreatedEventData.type
            workspaceId = betaWebhookSessionThreadCreatedEventData.workspaceId
            additionalProperties =
                betaWebhookSessionThreadCreatedEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookSessionThreadCreatedEventData =
            BetaWebhookSessionThreadCreatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionThreadCreatedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        sessionThreadId()
        _type().let {
            if (it != JsonValue.from("session.thread_created")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.thread_created")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionThreadCreatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionThreadCreatedEventData{id=$id, organizationId=$organizationId, sessionThreadId=$sessionThreadId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
