 ...
 *
 * Lists tunnels. Results are ordered by creation time, newest first; archived tunnels are excluded
...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TunnelListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [TunnelListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [TunnelListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(tunnelListParams: TunnelListParams) = apply {
            includeArchived = tunnelListParams.includeArchived
            limit = tunnelListParams.limit
            page = tunnelListParams.page
            betas = tunnelListParams.betas?.toMutableList()
            workspaceId = tunnelListParams.workspaceId
            additionalHeaders = tunnelListParams.additionalHeaders.toBuilder()
            additionalQueryParams = tunnelListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TunnelListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TunnelListParams =
            TunnelListParams(
                includeArchived,
                limit,
                page,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TunnelListParams &&
    ...
    override fun toString() =
        "TunnelListParams{includeArchived=$includeArchived, limit=$limit, page=$page, betas=$betas, workspaceId=$workspaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
