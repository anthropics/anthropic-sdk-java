...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserTypeConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserTypeConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserTypeConfig: BetaBrowserTypeConfig) = apply {
            deferLoading = betaBrowserTypeConfig.deferLoading
            enabled = betaBrowserTypeConfig.enabled
            additionalProperties = betaBrowserTypeConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserTypeConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserTypeConfig =
            BetaBrowserTypeConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserTypeConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserTypeConfig &&
    ...
    override fun toString() =
        "BetaBrowserTypeConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
