...
private constructor(
    ...
    fun error(): Optional<BetaCodeExecutionToolResultError> = optionalOfNullable(error)

    fun resultBlock(): Optional<BetaCodeExecutionResultBlock> = optionalOfNullable(resultBlock)
    ...
    override fun hashCode(): Int =
        contentHash(error, resultBlock, encryptedCodeExecutionResultBlock)
