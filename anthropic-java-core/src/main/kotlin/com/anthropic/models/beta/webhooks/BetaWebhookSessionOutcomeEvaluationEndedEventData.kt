...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.outcome_evaluation_ended")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.outcome_evaluation_ended")
        ...
        internal fun from(
            ...
            id = betaWebhookSessionOutcomeEvaluationEndedEventData.id
            organizationId = betaWebhookSessionOutcomeEvaluationEndedEventData.organizationId
            type = betaWebhookSessionOutcomeEvaluationEndedEventData.type
            workspaceId = betaWebhookSessionOutcomeEvaluationEndedEventData.workspaceId
            additionalProperties =
                betaWebhookSessionOutcomeEvaluationEndedEventData.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookSessionOutcomeEvaluationEndedEventData =
            BetaWebhookSessionOutcomeEvaluationEndedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionOutcomeEvaluationEndedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.outcome_evaluation_ended")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.outcome_evaluation_ended")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionOutcomeEvaluationEndedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionOutcomeEvaluationEndedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
