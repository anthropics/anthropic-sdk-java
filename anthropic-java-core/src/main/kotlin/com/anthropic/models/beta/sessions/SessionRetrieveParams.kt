...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sessionRetrieveParams: SessionRetrieveParams) = apply {
            ...
            betas = sessionRetrieveParams.betas?.toMutableList()
            workspaceId = sessionRetrieveParams.workspaceId
    ...
    override fun hashCode(): Int =
        Objects.hash(sessionId, betas, workspaceId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "SessionRetrieveParams{sessionId=$sessionId, betas=$betas, workspaceId=$workspaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
