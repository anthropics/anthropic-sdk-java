...
private constructor(
    ...
    /**
     * Whether tools are enabled and available to Claude by default. Defaults to true if not
     * specified.
     *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            enabled = betaManagedAgentsAgentToolsetDefaultConfigParams.enabled
            permissionPolicy = betaManagedAgentsAgentToolsetDefaultConfigParams.permissionPolicy
            additionalProperties =
                betaManagedAgentsAgentToolsetDefaultConfigParams.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsAgentToolsetDefaultConfigParams =
            BetaManagedAgentsAgentToolsetDefaultConfigParams(
                enabled,
                permissionPolicy,
    ...
    fun validate(): BetaManagedAgentsAgentToolsetDefaultConfigParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsAgentToolsetDefaultConfigParams &&
    ...
    override fun toString() =
        "BetaManagedAgentsAgentToolsetDefaultConfigParams{enabled=$enabled, permissionPolicy=$permissionPolicy, additionalProperties=$additionalProperties}"
}
