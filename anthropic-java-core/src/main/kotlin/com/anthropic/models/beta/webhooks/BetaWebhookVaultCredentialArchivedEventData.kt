...
private constructor(
     ...
     * ```java
     * JsonValue.from("vault_credential.archived")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("vault_credential.archived")
        ...
        internal fun from(
            ...
            id = betaWebhookVaultCredentialArchivedEventData.id
            organizationId = betaWebhookVaultCredentialArchivedEventData.organizationId
            type = betaWebhookVaultCredentialArchivedEventData.type
            vaultId = betaWebhookVaultCredentialArchivedEventData.vaultId
            workspaceId = betaWebhookVaultCredentialArchivedEventData.workspaceId
            additionalProperties =
                betaWebhookVaultCredentialArchivedEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookVaultCredentialArchivedEventData =
            BetaWebhookVaultCredentialArchivedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookVaultCredentialArchivedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("vault_credential.archived")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("vault_credential.archived")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookVaultCredentialArchivedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookVaultCredentialArchivedEventData{id=$id, organizationId=$organizationId, type=$type, vaultId=$vaultId, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
