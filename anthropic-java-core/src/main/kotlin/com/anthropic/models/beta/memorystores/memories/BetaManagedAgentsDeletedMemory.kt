...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsDeletedMemory: BetaManagedAgentsDeletedMemory) = apply {
            id = betaManagedAgentsDeletedMemory.id
            type = betaManagedAgentsDeletedMemory.type
         ...
         */
        fun build(): BetaManagedAgentsDeletedMemory =
            BetaManagedAgentsDeletedMemory(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsDeletedMemory = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MEMORY_DELETED = of("memory_deleted")
        ...
        fun value(): Value =
            when (this) {
                MEMORY_DELETED -> Value.MEMORY_DELETED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                MEMORY_DELETED -> Known.MEMORY_DELETED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsDeletedMemory &&
            id == other.id &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaManagedAgentsDeletedMemory{id=$id, type=$type, additionalProperties=$additionalProperties}"
}
