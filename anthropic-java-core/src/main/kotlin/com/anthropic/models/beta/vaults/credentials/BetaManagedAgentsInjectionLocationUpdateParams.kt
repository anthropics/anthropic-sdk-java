...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsInjectionLocationUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body = betaManagedAgentsInjectionLocationUpdateParams.body
            header = betaManagedAgentsInjectionLocationUpdateParams.header
            additionalProperties =
                betaManagedAgentsInjectionLocationUpdateParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsInjectionLocationUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaManagedAgentsInjectionLocationUpdateParams =
            BetaManagedAgentsInjectionLocationUpdateParams(
                body,
                header,
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsInjectionLocationUpdateParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsInjectionLocationUpdateParams &&
            body == other.body &&
            header == other.header &&
    ...
    override fun toString() =
        "BetaManagedAgentsInjectionLocationUpdateParams{body=$body, header=$header, additionalProperties=$additionalProperties}"
}
