...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserFileUploadConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserFileUploadConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserFileUploadConfig: BetaBrowserFileUploadConfig) = apply {
            deferLoading = betaBrowserFileUploadConfig.deferLoading
            enabled = betaBrowserFileUploadConfig.enabled
            additionalProperties = betaBrowserFileUploadConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserFileUploadConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserFileUploadConfig =
            BetaBrowserFileUploadConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserFileUploadConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserFileUploadConfig &&
    ...
    override fun toString() =
        "BetaBrowserFileUploadConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
