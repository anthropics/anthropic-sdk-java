...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("vault.archived")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookVaultArchivedEventData: BetaWebhookVaultArchivedEventData) =
            apply {
                id = betaWebhookVaultArchivedEventData.id
                organizationId = betaWebhookVaultArchivedEventData.organizationId
                type = betaWebhookVaultArchivedEventData.type
                workspaceId = betaWebhookVaultArchivedEventData.workspaceId
                additionalProperties =
                    betaWebhookVaultArchivedEventData.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaWebhookVaultArchivedEventData =
            BetaWebhookVaultArchivedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookVaultArchivedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("vault.archived")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("vault.archived")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookVaultArchivedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookVaultArchivedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
