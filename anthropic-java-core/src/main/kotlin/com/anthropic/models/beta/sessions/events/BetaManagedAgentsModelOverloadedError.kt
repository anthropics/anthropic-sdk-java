...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = betaManagedAgentsModelOverloadedError.message
            retryStatus = betaManagedAgentsModelOverloadedError.retryStatus
            type = betaManagedAgentsModelOverloadedError.type
            additionalProperties =
                betaManagedAgentsModelOverloadedError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsModelOverloadedError =
            BetaManagedAgentsModelOverloadedError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsModelOverloadedError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsModelOverloadedError &&
    ...
    override fun toString() =
        "BetaManagedAgentsModelOverloadedError{message=$message, retryStatus=$retryStatus, type=$type, additionalProperties=$additionalProperties}"
}
