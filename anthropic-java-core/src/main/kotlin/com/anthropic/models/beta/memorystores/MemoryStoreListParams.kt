...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(memoryStoreListParams: MemoryStoreListParams) = apply {
            ...
            workspaceId = memoryStoreListParams.workspaceId
    ...
    override fun toString() =
        "MemoryStoreListParams{createdAtGte=$createdAtGte, createdAtLte=$createdAtLte, includeArchived=$includeArchived, limit=$limit, page=$page, betas=$betas, workspaceId=$workspaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
