...
private constructor(
    private val agents: JsonField<List<BetaManagedAgentsSessionThreadAgent>>,
    ...
    private constructor(
        @JsonProperty("agents")
        @ExcludeMissing
        agents: JsonField<List<BetaManagedAgentsSessionThreadAgent>> = JsonMissing.of(),
     ...
     */
    fun agents(): List<BetaManagedAgentsSessionThreadAgent> = agents.getRequired("agents")
    ...
    @JsonProperty("agents")
    @ExcludeMissing
    fun _agents(): JsonField<List<BetaManagedAgentsSessionThreadAgent>> = agents
    ...
    class Builder internal constructor() {
        ...
        private var agents: JsonField<MutableList<BetaManagedAgentsSessionThreadAgent>>? = null
        ...
        internal fun from(
            ...
            agents = betaManagedAgentsSessionMultiagentCoordinator.agents.map { it.toMutableList() }
        ...
        /** Full `agent` definitions the coordinator may spawn as session threads. */
        fun agents(agents: List<BetaManagedAgentsSessionThreadAgent>) = agents(JsonField.of(agents))
         ...
         */
        fun agents(agents: JsonField<List<BetaManagedAgentsSessionThreadAgent>>) = apply {
            this.agents = agents.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaManagedAgentsSessionThreadAgent] to [agents].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addAgent(agent: BetaManagedAgentsSessionThreadAgent) = apply {
            agents =
