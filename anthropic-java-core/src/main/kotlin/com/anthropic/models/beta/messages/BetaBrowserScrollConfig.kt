...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserScrollConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserScrollConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserScrollConfig: BetaBrowserScrollConfig) = apply {
            deferLoading = betaBrowserScrollConfig.deferLoading
            enabled = betaBrowserScrollConfig.enabled
            additionalProperties = betaBrowserScrollConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserScrollConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserScrollConfig =
            BetaBrowserScrollConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserScrollConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserScrollConfig &&
    ...
    override fun toString() =
        "BetaBrowserScrollConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
