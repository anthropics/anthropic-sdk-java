...
private constructor(
    private val data: JsonField<List<BetaOrganizationRateLimit>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaOrganizationRateLimit>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<BetaOrganizationRateLimit>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RateLimitListPageResponse].
         *
    ...
    /** A builder for [RateLimitListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BetaOrganizationRateLimit>>? = null
        private var nextPage: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(rateLimitListPageResponse: RateLimitListPageResponse) = apply {
            data =
                rateLimitListPageResponse.data
                    .map { it.toMutableList() }
                    .takeUnless { it.isMissing() }
            nextPage = rateLimitListPageResponse.nextPage
            additionalProperties = rateLimitListPageResponse.additionalProperties.toMutableMap()
        }

        /** Rate-limit entries for the organization, one per group. */
        fun data(data: List<BetaOrganizationRateLimit>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<BetaOrganizationRateLimit>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<BetaOrganizationRateLimit>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BetaOrganizationRateLimit] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BetaOrganizationRateLimit) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [RateLimitListPageResponse].
         *
         ...
         */
        fun build(): RateLimitListPageResponse =
            RateLimitListPageResponse(
     ...
     *   expected type.
     */
    fun validate(): RateLimitListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RateLimitListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "RateLimitListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
