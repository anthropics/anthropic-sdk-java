...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserScreenshotConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserScreenshotConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserScreenshotConfig: BetaBrowserScreenshotConfig) = apply {
            deferLoading = betaBrowserScreenshotConfig.deferLoading
            enabled = betaBrowserScreenshotConfig.enabled
            additionalProperties = betaBrowserScreenshotConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserScreenshotConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserScreenshotConfig =
            BetaBrowserScreenshotConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserScreenshotConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserScreenshotConfig &&
    ...
    override fun toString() =
        "BetaBrowserScreenshotConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
