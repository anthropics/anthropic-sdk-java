...
private constructor(
    ...
    private constructor(
        ...
        fun betaWebFetchToolResultErrorBlockParam():
            ...
            optionalOfNullable(betaWebFetchToolResultErrorBlockParam)

        fun betaWebFetchBlockParam(): Optional<BetaWebFetchBlockParam> =
            optionalOfNullable(betaWebFetchBlockParam)
    ...
    private constructor(
        ...
        /** Tool invocation directly from the model. */
        fun direct(): Optional<BetaDirectCaller> = optionalOfNullable(direct)

        /** Tool invocation generated by a server-side tool. */
        fun codeExecution20250825(): Optional<BetaServerToolCaller> =
            optionalOfNullable(codeExecution20250825)

        fun codeExecution20260120(): Optional<BetaServerToolCaller20260120> =
            optionalOfNullable(codeExecution20260120)
