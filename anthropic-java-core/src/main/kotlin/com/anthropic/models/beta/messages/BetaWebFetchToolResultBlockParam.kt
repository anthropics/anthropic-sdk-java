...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitBetaWebFetchToolResultErrorBlockParam(BetaWebFetchToolResultErrorBlockParam betaWebFetchToolResultErrorBlockParam) {
         *         return Optional.of(betaWebFetchToolResultErrorBlockParam.toString());
         *     }
         *
         *     // ...
         *
    ...
    private constructor(
        ...
        fun type(): Type =
            accept(
                object : Visitor<Type> {
                    override fun visitDirect(direct: BetaDirectCaller): Type = Type.DIRECT
         ...
         *     @Override
         *     public Optional<String> visitDirect(BetaDirectCaller direct) {
