...
private constructor(
    ...
    /**
     * ID of the memory store to archive (a `memstore_...` identifier). Required. Archiving is
     * one-way and idempotent; archived stores cannot be unarchived. Enumerate IDs via `GET
     * /v1/memory_stores`.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): MemoryStoreArchiveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [MemoryStoreArchiveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MemoryStoreArchiveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(memoryStoreArchiveParams: MemoryStoreArchiveParams) = apply {
            memoryStoreId = memoryStoreArchiveParams.memoryStoreId
            betas = memoryStoreArchiveParams.betas?.toMutableList()
            workspaceId = memoryStoreArchiveParams.workspaceId
            additionalHeaders = memoryStoreArchiveParams.additionalHeaders.toBuilder()
            additionalQueryParams = memoryStoreArchiveParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                memoryStoreArchiveParams.additionalBodyProperties.toMutableMap()
        }
         ...
         */
        fun build(): MemoryStoreArchiveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MemoryStoreArchiveParams &&
    ...
    override fun toString() =
        "MemoryStoreArchiveParams{memoryStoreId=$memoryStoreId, betas=$betas, workspaceId=$workspaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
