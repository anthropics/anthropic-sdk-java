...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = betaManagedAgentsVaultArchivedRunError.message
            type = betaManagedAgentsVaultArchivedRunError.type
            additionalProperties =
                betaManagedAgentsVaultArchivedRunError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsVaultArchivedRunError =
            BetaManagedAgentsVaultArchivedRunError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsVaultArchivedRunError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsVaultArchivedRunError &&
    ...
    override fun toString() =
        "BetaManagedAgentsVaultArchivedRunError{message=$message, type=$type, additionalProperties=$additionalProperties}"
}
