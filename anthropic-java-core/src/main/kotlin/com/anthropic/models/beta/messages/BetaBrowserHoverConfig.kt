...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserHoverConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserHoverConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserHoverConfig: BetaBrowserHoverConfig) = apply {
            deferLoading = betaBrowserHoverConfig.deferLoading
            enabled = betaBrowserHoverConfig.enabled
            additionalProperties = betaBrowserHoverConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserHoverConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserHoverConfig =
            BetaBrowserHoverConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserHoverConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserHoverConfig &&
    ...
    override fun toString() =
        "BetaBrowserHoverConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
