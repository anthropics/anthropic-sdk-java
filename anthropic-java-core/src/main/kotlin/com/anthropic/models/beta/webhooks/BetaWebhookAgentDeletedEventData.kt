...
private constructor(
    ...
    /** A builder for [BetaWebhookAgentDeletedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("agent.deleted")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookAgentDeletedEventData: BetaWebhookAgentDeletedEventData) =
            apply {
                id = betaWebhookAgentDeletedEventData.id
                organizationId = betaWebhookAgentDeletedEventData.organizationId
                type = betaWebhookAgentDeletedEventData.type
                workspaceId = betaWebhookAgentDeletedEventData.workspaceId
                additionalProperties =
                    betaWebhookAgentDeletedEventData.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookAgentDeletedEventData].
         *
         ...
         */
        fun build(): BetaWebhookAgentDeletedEventData =
            BetaWebhookAgentDeletedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookAgentDeletedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("agent.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("agent.deleted")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookAgentDeletedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookAgentDeletedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
