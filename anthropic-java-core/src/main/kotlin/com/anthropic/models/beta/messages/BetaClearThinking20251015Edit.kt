...
private constructor(
    ...
    private constructor(
         ...
         * import java.util.Optional;
         *
         * Optional<String> result = keep.accept(new Keep.Visitor<Optional<String>>() {
         *     @Override
         *     public Optional<String> visitBetaThinkingTurns(BetaThinkingTurns betaThinkingTurns) {
         *         return Optional.of(betaThinkingTurns.toString());
         *     }
         *
         *     // ...
         *
