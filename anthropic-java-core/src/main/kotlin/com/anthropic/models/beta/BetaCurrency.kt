...
class BetaCurrency @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [BetaCurrency]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [BetaCurrency] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        USD,
        /** An enum member indicating that [BetaCurrency] was instantiated with an unknown value. */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            USD -> Known.USD
            else -> throw AnthropicInvalidDataException("Unknown BetaCurrency: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): BetaCurrency = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaCurrency && value == other.value
    }
