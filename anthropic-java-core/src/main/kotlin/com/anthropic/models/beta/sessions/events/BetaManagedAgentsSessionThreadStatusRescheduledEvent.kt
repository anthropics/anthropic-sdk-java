...
/**
 * A session thread hit a transient error and is retrying automatically. Emitted on the thread's own
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsSessionThreadStatusRescheduledEvent.id
            agentName = betaManagedAgentsSessionThreadStatusRescheduledEvent.agentName
            processedAt = betaManagedAgentsSessionThreadStatusRescheduledEvent.processedAt
            sessionThreadId = betaManagedAgentsSessionThreadStatusRescheduledEvent.sessionThreadId
            type = betaManagedAgentsSessionThreadStatusRescheduledEvent.type
            additionalProperties =
                betaManagedAgentsSessionThreadStatusRescheduledEvent.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSessionThreadStatusRescheduledEvent =
            BetaManagedAgentsSessionThreadStatusRescheduledEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSessionThreadStatusRescheduledEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSessionThreadStatusRescheduledEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsSessionThreadStatusRescheduledEvent{id=$id, agentName=$agentName, processedAt=$processedAt, sessionThreadId=$sessionThreadId, type=$type, additionalProperties=$additionalProperties}"
}
