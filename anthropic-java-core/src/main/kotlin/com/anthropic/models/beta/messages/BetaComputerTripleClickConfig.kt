...
private constructor(
    ...
    /** A builder for [BetaComputerTripleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerTripleClickConfig: BetaComputerTripleClickConfig) = apply {
            deferLoading = betaComputerTripleClickConfig.deferLoading
            enabled = betaComputerTripleClickConfig.enabled
            additionalProperties = betaComputerTripleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerTripleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerTripleClickConfig =
            BetaComputerTripleClickConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaComputerTripleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerTripleClickConfig &&
    ...
    override fun toString() =
        "BetaComputerTripleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
