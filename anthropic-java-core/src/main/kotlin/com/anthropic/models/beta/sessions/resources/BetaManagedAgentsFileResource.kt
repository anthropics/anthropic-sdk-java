...
private constructor(
    ...
    ) : this(id, createdAt, fileId, mountPath, type, updatedAt, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaManagedAgentsFileResource: BetaManagedAgentsFileResource) = apply {
            id = betaManagedAgentsFileResource.id
            createdAt = betaManagedAgentsFileResource.createdAt
            fileId = betaManagedAgentsFileResource.fileId
            mountPath = betaManagedAgentsFileResource.mountPath
            type = betaManagedAgentsFileResource.type
            updatedAt = betaManagedAgentsFileResource.updatedAt
            additionalProperties = betaManagedAgentsFileResource.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsFileResource =
            BetaManagedAgentsFileResource(
                checkRequired("id", id),
    ...
    fun validate(): BetaManagedAgentsFileResource = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsFileResource &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, fileId, mountPath, type, updatedAt, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsFileResource{id=$id, createdAt=$createdAt, fileId=$fileId, mountPath=$mountPath, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
