...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [BetaManagedAgentsSessionThreadStatus]'s known values, as well as an
     * [_UNKNOWN] member.
     *
     * An instance of [BetaManagedAgentsSessionThreadStatus] can contain an unknown value in a
     * couple of cases:
    ...
    enum class Value {
        ...
        TERMINATED,
        /**
         * An enum member indicating that [BetaManagedAgentsSessionThreadStatus] was instantiated
        ...
        when (this) {
            ...
            TERMINATED -> Known.TERMINATED
                ...
                throw AnthropicInvalidDataException(
                    "Unknown BetaManagedAgentsSessionThreadStatus: $value"
                )
        }
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSessionThreadStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSessionThreadStatus && value == other.value
    }
