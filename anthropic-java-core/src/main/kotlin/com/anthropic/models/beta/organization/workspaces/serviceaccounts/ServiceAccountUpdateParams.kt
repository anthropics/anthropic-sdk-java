 ...
 *
 * The new `workspace_role` replaces the current one. Only explicit memberships can be updated; to
 * set a role on the implicit default-workspace membership, add the service account explicitly with
 * `POST /workspaces/{workspace_id}/service_accounts`. Archived workspaces return 400. Archived
 * service accounts cannot be updated and are rejected.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(serviceAccountUpdateParams: ServiceAccountUpdateParams) = apply {
            workspaceId = serviceAccountUpdateParams.workspaceId
    ...
    private constructor(
        ...
        companion object {
             ...
             */
            @JvmStatic
            fun of(workspaceRole: BetaNoBillingWorkspaceRole) =
    ...
    override fun toString() =
        "ServiceAccountUpdateParams{workspaceId=$workspaceId, serviceAccountId=$serviceAccountId, betas=$betas, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
