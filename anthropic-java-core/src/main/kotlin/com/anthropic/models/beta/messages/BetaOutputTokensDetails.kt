...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaOutputTokensDetails: BetaOutputTokensDetails) = apply {
            thinkingTokens = betaOutputTokensDetails.thinkingTokens
            additionalProperties = betaOutputTokensDetails.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaOutputTokensDetails =
     ...
     *   expected type.
     */
    fun validate(): BetaOutputTokensDetails = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaOutputTokensDetails &&
    ...
    override fun toString() =
        "BetaOutputTokensDetails{thinkingTokens=$thinkingTokens, additionalProperties=$additionalProperties}"
}
