...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsWriteToolConfig]. */
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("write")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaManagedAgentsWriteToolConfig: BetaManagedAgentsWriteToolConfig) =
            apply {
                enabled = betaManagedAgentsWriteToolConfig.enabled
                name = betaManagedAgentsWriteToolConfig.name
                permissionPolicy = betaManagedAgentsWriteToolConfig.permissionPolicy
                type = betaManagedAgentsWriteToolConfig.type
                additionalProperties =
                    betaManagedAgentsWriteToolConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsWriteToolConfig].
         *
         ...
         */
        fun build(): BetaManagedAgentsWriteToolConfig =
            BetaManagedAgentsWriteToolConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsWriteToolConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (enabled.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("write")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsWriteToolConfig &&
    ...
    override fun toString() =
        "BetaManagedAgentsWriteToolConfig{enabled=$enabled, name=$name, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
