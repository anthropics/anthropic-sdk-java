...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaSummarizeCompaction]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaSummarizeCompaction]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaSummarizeCompaction: BetaSummarizeCompaction) = apply {
            type = betaSummarizeCompaction.type
            instructions = betaSummarizeCompaction.instructions
            additionalProperties = betaSummarizeCompaction.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaSummarizeCompaction].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaSummarizeCompaction =
            BetaSummarizeCompaction(type, instructions, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaSummarizeCompaction = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaSummarizeCompaction &&
            type == other.type &&
    ...
    override fun toString() =
        "BetaSummarizeCompaction{type=$type, instructions=$instructions, additionalProperties=$additionalProperties}"
}
