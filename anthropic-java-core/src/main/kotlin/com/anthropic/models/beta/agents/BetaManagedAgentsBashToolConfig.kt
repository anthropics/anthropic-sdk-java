...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsBashToolConfig]. */
    class Builder internal constructor() {

        private var enabled: JsonField<Boolean>? = null
        private var name: JsonValue = JsonValue.from("bash")
        private var permissionPolicy: JsonField<PermissionPolicy>? = null
        private var type: JsonValue = JsonValue.from("bash")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaManagedAgentsBashToolConfig: BetaManagedAgentsBashToolConfig) =
            apply {
                enabled = betaManagedAgentsBashToolConfig.enabled
                name = betaManagedAgentsBashToolConfig.name
                permissionPolicy = betaManagedAgentsBashToolConfig.permissionPolicy
                type = betaManagedAgentsBashToolConfig.type
                additionalProperties =
                    betaManagedAgentsBashToolConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsBashToolConfig].
         *
         ...
         */
        fun build(): BetaManagedAgentsBashToolConfig =
            BetaManagedAgentsBashToolConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsBashToolConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (enabled.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("bash")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsBashToolConfig &&
    ...
    override fun toString() =
        "BetaManagedAgentsBashToolConfig{enabled=$enabled, name=$name, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
