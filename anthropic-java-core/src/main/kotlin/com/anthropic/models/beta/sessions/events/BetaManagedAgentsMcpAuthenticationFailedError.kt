...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            mcpServerName = betaManagedAgentsMcpAuthenticationFailedError.mcpServerName
            message = betaManagedAgentsMcpAuthenticationFailedError.message
            retryStatus = betaManagedAgentsMcpAuthenticationFailedError.retryStatus
            type = betaManagedAgentsMcpAuthenticationFailedError.type
            additionalProperties =
                betaManagedAgentsMcpAuthenticationFailedError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsMcpAuthenticationFailedError =
            BetaManagedAgentsMcpAuthenticationFailedError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsMcpAuthenticationFailedError = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val MCP_AUTHENTICATION_FAILED_ERROR = of("mcp_authentication_failed_error")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsMcpAuthenticationFailedError &&
    ...
    override fun toString() =
        "BetaManagedAgentsMcpAuthenticationFailedError{mcpServerName=$mcpServerName, message=$message, retryStatus=$retryStatus, type=$type, additionalProperties=$additionalProperties}"
}
