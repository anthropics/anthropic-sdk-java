...
private constructor(
    ...
    /**
     * The `signature` for this thinking block: an opaque value used to verify that the block was
     * generated by Claude when it is passed back to the API. Delivered in a `signature_delta` event
     * just before the block's `content_block_stop` event.
     *
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaSignatureDelta] with the required [signature] set
         * to the given value.
         */
    ...
    class Builder internal constructor() {
        ...
        /**
         * The `signature` for this thinking block: an opaque value used to verify that the block
         * was generated by Claude when it is passed back to the API. Delivered in a
