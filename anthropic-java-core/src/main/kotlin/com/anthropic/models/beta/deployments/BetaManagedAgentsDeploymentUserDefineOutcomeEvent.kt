...
import com.anthropic.models.beta.sessions.events.BetaManagedAgentsTextRubric
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            description = betaManagedAgentsDeploymentUserDefineOutcomeEvent.description
            rubric = betaManagedAgentsDeploymentUserDefineOutcomeEvent.rubric
            type = betaManagedAgentsDeploymentUserDefineOutcomeEvent.type
            maxIterations = betaManagedAgentsDeploymentUserDefineOutcomeEvent.maxIterations
            additionalProperties =
                betaManagedAgentsDeploymentUserDefineOutcomeEvent.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsDeploymentUserDefineOutcomeEvent =
            BetaManagedAgentsDeploymentUserDefineOutcomeEvent(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsDeploymentUserDefineOutcomeEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        fun type(): Type =
            accept(
                object : Visitor<Type> {
                    override fun visitFile(file: BetaManagedAgentsFileRubric): Type = Type.FILE

                    override fun visitText(text: BetaManagedAgentsTextRubric): Type = Type.TEXT
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsDeploymentUserDefineOutcomeEvent &&
    ...
    override fun toString() =
        "BetaManagedAgentsDeploymentUserDefineOutcomeEvent{description=$description, rubric=$rubric, type=$type, maxIterations=$maxIterations, additionalProperties=$additionalProperties}"
}
