...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = betaManagedAgentsSpanOutcomeEvaluationOngoingEvent.id
            iteration = betaManagedAgentsSpanOutcomeEvaluationOngoingEvent.iteration
            outcomeId = betaManagedAgentsSpanOutcomeEvaluationOngoingEvent.outcomeId
            processedAt = betaManagedAgentsSpanOutcomeEvaluationOngoingEvent.processedAt
            type = betaManagedAgentsSpanOutcomeEvaluationOngoingEvent.type
            additionalProperties =
                betaManagedAgentsSpanOutcomeEvaluationOngoingEvent.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSpanOutcomeEvaluationOngoingEvent =
            BetaManagedAgentsSpanOutcomeEvaluationOngoingEvent(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSpanOutcomeEvaluationOngoingEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSpanOutcomeEvaluationOngoingEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaManagedAgentsSpanOutcomeEvaluationOngoingEvent{id=$id, iteration=$iteration, outcomeId=$outcomeId, processedAt=$processedAt, type=$type, additionalProperties=$additionalProperties}"
}
