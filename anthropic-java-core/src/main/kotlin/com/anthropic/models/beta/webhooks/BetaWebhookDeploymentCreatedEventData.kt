...
private constructor(
     ...
     * ```java
     * JsonValue.from("deployment.created")
     * ```
     *
    ...
    /** A builder for [BetaWebhookDeploymentCreatedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("deployment.created")
        ...
        internal fun from(
            ...
            id = betaWebhookDeploymentCreatedEventData.id
            organizationId = betaWebhookDeploymentCreatedEventData.organizationId
            type = betaWebhookDeploymentCreatedEventData.type
            workspaceId = betaWebhookDeploymentCreatedEventData.workspaceId
            additionalProperties =
                betaWebhookDeploymentCreatedEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookDeploymentCreatedEventData].
         *
         ...
         */
        fun build(): BetaWebhookDeploymentCreatedEventData =
            BetaWebhookDeploymentCreatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookDeploymentCreatedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("deployment.created")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("deployment.created")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookDeploymentCreatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookDeploymentCreatedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
