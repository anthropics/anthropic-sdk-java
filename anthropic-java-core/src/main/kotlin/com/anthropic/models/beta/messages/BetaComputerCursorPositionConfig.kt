...
private constructor(
    ...
    /** A builder for [BetaComputerCursorPositionConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerCursorPositionConfig: BetaComputerCursorPositionConfig) =
            apply {
                deferLoading = betaComputerCursorPositionConfig.deferLoading
                enabled = betaComputerCursorPositionConfig.enabled
                additionalProperties =
                    betaComputerCursorPositionConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaComputerCursorPositionConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerCursorPositionConfig =
            BetaComputerCursorPositionConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaComputerCursorPositionConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerCursorPositionConfig &&
    ...
    override fun toString() =
        "BetaComputerCursorPositionConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
