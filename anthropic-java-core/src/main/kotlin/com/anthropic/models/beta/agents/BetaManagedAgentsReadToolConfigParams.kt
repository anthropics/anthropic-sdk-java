...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsReadToolConfigParams]. */
    class Builder internal constructor() {

        private var name: JsonValue = JsonValue.from("read")
        ...
        internal fun from(
            ...
            name = betaManagedAgentsReadToolConfigParams.name
            enabled = betaManagedAgentsReadToolConfigParams.enabled
            permissionPolicy = betaManagedAgentsReadToolConfigParams.permissionPolicy
            type = betaManagedAgentsReadToolConfigParams.type
            additionalProperties =
                betaManagedAgentsReadToolConfigParams.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsReadToolConfigParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaManagedAgentsReadToolConfigParams =
            BetaManagedAgentsReadToolConfigParams(
                name,
                enabled,
                permissionPolicy,
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsReadToolConfigParams = apply {
        if (validated) {
            return@apply
        }

        _name().let {
            if (it != JsonValue.from("read")) {
    ...
    internal fun validity(): Int =
        name.let { if (it == JsonValue.from("read")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsReadToolConfigParams &&
            name == other.name &&
    ...
    override fun toString() =
        "BetaManagedAgentsReadToolConfigParams{name=$name, enabled=$enabled, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
