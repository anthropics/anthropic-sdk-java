...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            message = betaManagedAgentsWorkspaceArchivedRunError.message
            type = betaManagedAgentsWorkspaceArchivedRunError.type
            additionalProperties =
                betaManagedAgentsWorkspaceArchivedRunError.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsWorkspaceArchivedRunError =
            BetaManagedAgentsWorkspaceArchivedRunError(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsWorkspaceArchivedRunError = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsWorkspaceArchivedRunError &&
    ...
    override fun toString() =
        "BetaManagedAgentsWorkspaceArchivedRunError{message=$message, type=$type, additionalProperties=$additionalProperties}"
}
