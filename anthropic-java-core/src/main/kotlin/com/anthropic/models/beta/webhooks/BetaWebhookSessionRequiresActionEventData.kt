...
private constructor(
     ...
     * ```java
     * JsonValue.from("session.requires_action")
     * ```
     *
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.requires_action")
        ...
        internal fun from(
            ...
            id = betaWebhookSessionRequiresActionEventData.id
            organizationId = betaWebhookSessionRequiresActionEventData.organizationId
            type = betaWebhookSessionRequiresActionEventData.type
            workspaceId = betaWebhookSessionRequiresActionEventData.workspaceId
            additionalProperties =
                betaWebhookSessionRequiresActionEventData.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaWebhookSessionRequiresActionEventData =
            BetaWebhookSessionRequiresActionEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionRequiresActionEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.requires_action")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.requires_action")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionRequiresActionEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionRequiresActionEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
