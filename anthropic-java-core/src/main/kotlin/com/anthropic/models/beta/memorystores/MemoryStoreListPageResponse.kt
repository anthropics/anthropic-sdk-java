...
private constructor(
    private val data: JsonField<List<BetaManagedAgentsMemoryStore>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaManagedAgentsMemoryStore>> = JsonMissing.of(),
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<BetaManagedAgentsMemoryStore>> = data
    ...
    /** A builder for [MemoryStoreListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BetaManagedAgentsMemoryStore>>? = null
        private var nextPage: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(memoryStoreListPageResponse: MemoryStoreListPageResponse) = apply {
            data = memoryStoreListPageResponse.data.map { it.toMutableList() }
            nextPage = memoryStoreListPageResponse.nextPage
         ...
         * `List<BetaManagedAgentsMemoryStore>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<BetaManagedAgentsMemoryStore>>) = apply {
         ...
         */
        fun addData(data: BetaManagedAgentsMemoryStore) = apply {
            this.data =
         ...
         */
        fun build(): MemoryStoreListPageResponse =
            MemoryStoreListPageResponse(
    ...
    fun validate(): MemoryStoreListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MemoryStoreListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "MemoryStoreListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
