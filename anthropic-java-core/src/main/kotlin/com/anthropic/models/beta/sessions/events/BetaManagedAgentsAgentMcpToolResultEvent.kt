...
private constructor(
    ...
    private val mcpToolUseId: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("mcp_tool_use_id")
        @ExcludeMissing
        mcpToolUseId: JsonField<String> = JsonMissing.of(),
    ...
    ) : this(id, mcpToolUseId, processedAt, type, content, isError, mutableMapOf())
    ...
    @JsonProperty("mcp_tool_use_id")
    @ExcludeMissing
    fun _mcpToolUseId(): JsonField<String> = mcpToolUseId
    ...
    class Builder internal constructor() {
        ...
        private var mcpToolUseId: JsonField<String>? = null
        ...
        internal fun from(
            ...
            id = betaManagedAgentsAgentMcpToolResultEvent.id
        ...
        /** The id of the `agent.mcp_tool_use` event this result corresponds to. */
        fun mcpToolUseId(mcpToolUseId: String) = mcpToolUseId(JsonField.of(mcpToolUseId))

        /**
         * Sets [Builder.mcpToolUseId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.mcpToolUseId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun mcpToolUseId(mcpToolUseId: JsonField<String>) = apply {
         ...
         */
        fun build(): BetaManagedAgentsAgentMcpToolResultEvent =
            BetaManagedAgentsAgentMcpToolResultEvent(
                checkRequired("id", id),
                checkRequired("mcpToolUseId", mcpToolUseId),
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsAgentMcpToolResultEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            (if (mcpToolUseId.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsAgentMcpToolResultEvent &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, mcpToolUseId, processedAt, type, content, isError, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaManagedAgentsAgentMcpToolResultEvent{id=$id, mcpToolUseId=$mcpToolUseId, processedAt=$processedAt, type=$type, content=$content, isError=$isError, additionalProperties=$additionalProperties}"
}
