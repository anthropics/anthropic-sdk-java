...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(memoryCreateParams: MemoryCreateParams) = apply {
            ...
            workspaceId = memoryCreateParams.workspaceId
    ...
    override fun toString() =
        "MemoryCreateParams{memoryStoreId=$memoryStoreId, view=$view, betas=$betas, workspaceId=$workspaceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
