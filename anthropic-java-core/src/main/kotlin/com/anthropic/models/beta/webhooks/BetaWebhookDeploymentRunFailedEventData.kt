...
private constructor(
     ...
     * ```java
     * JsonValue.from("deployment_run.failed")
     * ```
     *
    ...
    /** A builder for [BetaWebhookDeploymentRunFailedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("deployment_run.failed")
        ...
        internal fun from(
            ...
            id = betaWebhookDeploymentRunFailedEventData.id
            organizationId = betaWebhookDeploymentRunFailedEventData.organizationId
            type = betaWebhookDeploymentRunFailedEventData.type
            workspaceId = betaWebhookDeploymentRunFailedEventData.workspaceId
            additionalProperties =
                betaWebhookDeploymentRunFailedEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookDeploymentRunFailedEventData].
         *
         ...
         */
        fun build(): BetaWebhookDeploymentRunFailedEventData =
            BetaWebhookDeploymentRunFailedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookDeploymentRunFailedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("deployment_run.failed")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("deployment_run.failed")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookDeploymentRunFailedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookDeploymentRunFailedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
