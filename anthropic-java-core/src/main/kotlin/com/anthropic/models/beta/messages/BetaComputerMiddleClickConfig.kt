...
private constructor(
    ...
    /** A builder for [BetaComputerMiddleClickConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerMiddleClickConfig: BetaComputerMiddleClickConfig) = apply {
            deferLoading = betaComputerMiddleClickConfig.deferLoading
            enabled = betaComputerMiddleClickConfig.enabled
            additionalProperties = betaComputerMiddleClickConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaComputerMiddleClickConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerMiddleClickConfig =
            BetaComputerMiddleClickConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaComputerMiddleClickConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerMiddleClickConfig &&
    ...
    override fun toString() =
        "BetaComputerMiddleClickConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
