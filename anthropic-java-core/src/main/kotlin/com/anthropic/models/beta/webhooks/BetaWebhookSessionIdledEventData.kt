...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var type: JsonValue = JsonValue.from("session.idled")
        private var workspaceId: JsonField<String>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaWebhookSessionIdledEventData: BetaWebhookSessionIdledEventData) =
            apply {
                id = betaWebhookSessionIdledEventData.id
                organizationId = betaWebhookSessionIdledEventData.organizationId
                type = betaWebhookSessionIdledEventData.type
                workspaceId = betaWebhookSessionIdledEventData.workspaceId
                additionalProperties =
                    betaWebhookSessionIdledEventData.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaWebhookSessionIdledEventData =
            BetaWebhookSessionIdledEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionIdledEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("session.idled")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("session.idled")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionIdledEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionIdledEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
