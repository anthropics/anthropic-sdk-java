...
private constructor(
    ...
    ) : this(allowedInferenceGeos, defaultInferenceGeo, mutableMapOf())

    /**
     * Permitted inference geo values. Use 'unrestricted' to allow all geos, or a list of specific
     * geos.
     *
    ...
    /** A builder for [BetaDataResidencyUpdateConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaDataResidencyUpdateConfig: BetaDataResidencyUpdateConfig) = apply {
            allowedInferenceGeos = betaDataResidencyUpdateConfig.allowedInferenceGeos
            defaultInferenceGeo = betaDataResidencyUpdateConfig.defaultInferenceGeo
            additionalProperties = betaDataResidencyUpdateConfig.additionalProperties.toMutableMap()
        }

        /**
         * Permitted inference geo values. Use 'unrestricted' to allow all geos, or a list of
         * specific geos.
         */
        ...
        /**
         * Returns an immutable instance of [BetaDataResidencyUpdateConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaDataResidencyUpdateConfig =
            BetaDataResidencyUpdateConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaDataResidencyUpdateConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaDataResidencyUpdateConfig &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(allowedInferenceGeos, defaultInferenceGeo, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BetaDataResidencyUpdateConfig{allowedInferenceGeos=$allowedInferenceGeos, defaultInferenceGeo=$defaultInferenceGeo, additionalProperties=$additionalProperties}"
}
