...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitBetaToolSearchToolResultError(BetaToolSearchToolResultError betaToolSearchToolResultError) {
         *         return Optional.of(betaToolSearchToolResultError.toString());
         *     }
         *
         *     // ...
         *
