...
private constructor(
    ...
    /** A builder for [BetaComputerLeftClickDragConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaComputerLeftClickDragConfig: BetaComputerLeftClickDragConfig) =
            apply {
                deferLoading = betaComputerLeftClickDragConfig.deferLoading
                enabled = betaComputerLeftClickDragConfig.enabled
                additionalProperties =
                    betaComputerLeftClickDragConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaComputerLeftClickDragConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaComputerLeftClickDragConfig =
            BetaComputerLeftClickDragConfig(
                deferLoading,
                enabled,
     ...
     *   expected type.
     */
    fun validate(): BetaComputerLeftClickDragConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaComputerLeftClickDragConfig &&
    ...
    override fun toString() =
        "BetaComputerLeftClickDragConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
