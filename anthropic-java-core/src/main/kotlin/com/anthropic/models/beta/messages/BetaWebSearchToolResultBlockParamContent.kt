...
private constructor(
     ...
     * import java.util.Optional;
     *
     * Optional<String> result = betaWebSearchToolResultBlockParamContent.accept(new BetaWebSearchToolResultBlockParamContent.Visitor<Optional<String>>() {
     *     @Override
     *     public Optional<String> visitResultBlock(List<BetaWebSearchResultBlockParam> resultBlock) {
     *         return Optional.of(resultBlock.toString());
     *     }
     *
     *     // ...
     *
