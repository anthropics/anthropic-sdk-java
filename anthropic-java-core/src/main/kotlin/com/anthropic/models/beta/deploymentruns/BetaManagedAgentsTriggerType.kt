...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    /**
     * An enum containing [BetaManagedAgentsTriggerType]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [BetaManagedAgentsTriggerType] can contain an unknown value in a couple of
     * cases:
    ...
    fun known(): Known =
        when (this) {
            ...
            MANUAL -> Known.MANUAL
                ...
                throw AnthropicInvalidDataException("Unknown BetaManagedAgentsTriggerType: $value")
        }
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsTriggerType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsTriggerType && value == other.value
    }
