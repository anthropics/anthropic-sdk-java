...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ServiceAccountRetrieveParams = builder().build()
    ...
    override fun hashCode(): Int =
        Objects.hash(serviceAccountId, betas, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ServiceAccountRetrieveParams{serviceAccountId=$serviceAccountId, betas=$betas, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
