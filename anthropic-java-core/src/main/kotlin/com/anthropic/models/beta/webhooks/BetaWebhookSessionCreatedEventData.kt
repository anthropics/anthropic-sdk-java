...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaWebhookSessionCreatedEventData: BetaWebhookSessionCreatedEventData) =
            apply {
                id = betaWebhookSessionCreatedEventData.id
                organizationId = betaWebhookSessionCreatedEventData.organizationId
                type = betaWebhookSessionCreatedEventData.type
                workspaceId = betaWebhookSessionCreatedEventData.workspaceId
                additionalProperties =
                    betaWebhookSessionCreatedEventData.additionalProperties.toMutableMap()
            }
         ...
         */
        fun build(): BetaWebhookSessionCreatedEventData =
            BetaWebhookSessionCreatedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookSessionCreatedEventData = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookSessionCreatedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookSessionCreatedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
