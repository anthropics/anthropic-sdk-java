...
private constructor(
    private val data: JsonField<List<BetaUserProfile>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BetaUserProfile>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BetaUserProfile> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BetaUserProfile>> = data
    ...
    /** A builder for [UserProfileListPageResponse]. */
    class Builder internal constructor() {
        ...
        /** User profiles on this page. */
        fun data(data: List<BetaUserProfile>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BetaUserProfile>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<BetaUserProfile>>) = apply {
         ...
         */
        fun addData(data: BetaUserProfile) = apply {
            this.data =
     ...
     *   expected type.
     */
    fun validate(): UserProfileListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserProfileListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "UserProfileListPageResponse{data=$data, nextPage=$nextPage, additionalProperties=$additionalProperties}"
}
