...
private constructor(
     ...
     * ```java
     * JsonValue.from("deployment_run.succeeded")
     * ```
     *
    ...
    /** A builder for [BetaWebhookDeploymentRunSucceededEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("deployment_run.succeeded")
        ...
        internal fun from(
            ...
            id = betaWebhookDeploymentRunSucceededEventData.id
            organizationId = betaWebhookDeploymentRunSucceededEventData.organizationId
            type = betaWebhookDeploymentRunSucceededEventData.type
            workspaceId = betaWebhookDeploymentRunSucceededEventData.workspaceId
            additionalProperties =
                betaWebhookDeploymentRunSucceededEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookDeploymentRunSucceededEventData].
         *
         ...
         */
        fun build(): BetaWebhookDeploymentRunSucceededEventData =
            BetaWebhookDeploymentRunSucceededEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookDeploymentRunSucceededEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("deployment_run.succeeded")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("deployment_run.succeeded")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookDeploymentRunSucceededEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookDeploymentRunSucceededEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
