...
private constructor(
    private val toolReferences: JsonField<List<BetaToolReferenceBlock>>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        toolReferences: JsonField<List<BetaToolReferenceBlock>> = JsonMissing.of(),
        @JsonProperty("type") @ExcludeMissing type: JsonValue = JsonMissing.of(),
    ) : this(toolReferences, type, mutableMapOf())

    fun toParam(): BetaToolSearchToolSearchResultBlockParam =
     ...
     */
    fun toolReferences(): List<BetaToolReferenceBlock> =
    ...
    @JsonProperty("tool_references")
    @ExcludeMissing
    fun _toolReferences(): JsonField<List<BetaToolReferenceBlock>> = toolReferences
    ...
    class Builder internal constructor() {
        ...
        private var toolReferences: JsonField<MutableList<BetaToolReferenceBlock>>? = null
        ...
        fun toolReferences(toolReferences: List<BetaToolReferenceBlock>) =
         ...
         * `List<BetaToolReferenceBlock>` value instead. This method is primarily for setting the
         * field to an undocumented or not yet supported value.
         */
        fun toolReferences(toolReferences: JsonField<List<BetaToolReferenceBlock>>) = apply {
         ...
         */
        fun addToolReference(toolReference: BetaToolReferenceBlock) = apply {
            toolReferences =
         ...
         */
        fun build(): BetaToolSearchToolSearchResultBlock =
            BetaToolSearchToolSearchResultBlock(
    ...
    fun validate(): BetaToolSearchToolSearchResultBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaToolSearchToolSearchResultBlock &&
    ...
    override fun toString() =
        "BetaToolSearchToolSearchResultBlock{toolReferences=$toolReferences, type=$type, additionalProperties=$additionalProperties}"
}
