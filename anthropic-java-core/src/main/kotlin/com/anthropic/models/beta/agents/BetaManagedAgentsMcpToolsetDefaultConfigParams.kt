...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            enabled = betaManagedAgentsMcpToolsetDefaultConfigParams.enabled
            permissionPolicy = betaManagedAgentsMcpToolsetDefaultConfigParams.permissionPolicy
            additionalProperties =
                betaManagedAgentsMcpToolsetDefaultConfigParams.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsMcpToolsetDefaultConfigParams =
            BetaManagedAgentsMcpToolsetDefaultConfigParams(
                enabled,
                permissionPolicy,
    ...
    fun validate(): BetaManagedAgentsMcpToolsetDefaultConfigParams = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsMcpToolsetDefaultConfigParams &&
    ...
    override fun toString() =
        "BetaManagedAgentsMcpToolsetDefaultConfigParams{enabled=$enabled, permissionPolicy=$permissionPolicy, additionalProperties=$additionalProperties}"
}
