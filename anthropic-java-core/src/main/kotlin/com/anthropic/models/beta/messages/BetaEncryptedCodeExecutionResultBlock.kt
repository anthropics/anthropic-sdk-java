...
private constructor(
    ...
    fun toParam(): BetaEncryptedCodeExecutionResultBlockParam =
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            type = betaEncryptedCodeExecutionResultBlock.type
            additionalProperties =
                betaEncryptedCodeExecutionResultBlock.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaEncryptedCodeExecutionResultBlock =
            BetaEncryptedCodeExecutionResultBlock(
    ...
    fun validate(): BetaEncryptedCodeExecutionResultBlock = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaEncryptedCodeExecutionResultBlock &&
    ...
    override fun toString() =
        "BetaEncryptedCodeExecutionResultBlock{content=$content, encryptedStdout=$encryptedStdout, returnCode=$returnCode, stderr=$stderr, type=$type, additionalProperties=$additionalProperties}"
}
