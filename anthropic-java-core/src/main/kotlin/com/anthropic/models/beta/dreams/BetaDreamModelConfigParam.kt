...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaDreamModelConfigParam].
         *
        ...
        /**
         * Returns an immutable instance of [BetaDreamModelConfigParam] with the required [id] set
         * to the given value.
         */
        @JvmStatic fun of(id: String) = builder().id(id).build()
    }

    /** A builder for [BetaDreamModelConfigParam]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaDreamModelConfigParam: BetaDreamModelConfigParam) = apply {
            id = betaDreamModelConfigParam.id
            speed = betaDreamModelConfigParam.speed
        ...
        /**
         * Returns an immutable instance of [BetaDreamModelConfigParam].
         *
         ...
         */
        fun build(): BetaDreamModelConfigParam =
     ...
     *   expected type.
     */
    fun validate(): BetaDreamModelConfigParam = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaDreamModelConfigParam &&
            id == other.id &&
            speed == other.speed &&
    ...
    override fun toString() =
        "BetaDreamModelConfigParam{id=$id, speed=$speed, additionalProperties=$additionalProperties}"
}
