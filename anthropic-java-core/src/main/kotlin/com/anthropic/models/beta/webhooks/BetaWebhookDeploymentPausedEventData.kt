...
private constructor(
     ...
     * ```java
     * JsonValue.from("deployment.paused")
     * ```
     *
    ...
    /** A builder for [BetaWebhookDeploymentPausedEventData]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var organizationId: JsonField<String>? = null
        private var type: JsonValue = JsonValue.from("deployment.paused")
        ...
        internal fun from(
            ...
            id = betaWebhookDeploymentPausedEventData.id
            organizationId = betaWebhookDeploymentPausedEventData.organizationId
            type = betaWebhookDeploymentPausedEventData.type
            workspaceId = betaWebhookDeploymentPausedEventData.workspaceId
            additionalProperties =
                betaWebhookDeploymentPausedEventData.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaWebhookDeploymentPausedEventData].
         *
         ...
         */
        fun build(): BetaWebhookDeploymentPausedEventData =
            BetaWebhookDeploymentPausedEventData(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): BetaWebhookDeploymentPausedEventData = apply {
        if (validated) {
            return@apply
        }
        ...
        organizationId()
        _type().let {
            if (it != JsonValue.from("deployment.paused")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("deployment.paused")) 1 else 0 } +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaWebhookDeploymentPausedEventData &&
            id == other.id &&
    ...
    override fun toString() =
        "BetaWebhookDeploymentPausedEventData{id=$id, organizationId=$organizationId, type=$type, workspaceId=$workspaceId, additionalProperties=$additionalProperties}"
}
