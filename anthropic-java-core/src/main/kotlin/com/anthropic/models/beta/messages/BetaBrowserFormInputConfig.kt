...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BetaBrowserFormInputConfig].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserFormInputConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserFormInputConfig: BetaBrowserFormInputConfig) = apply {
            deferLoading = betaBrowserFormInputConfig.deferLoading
            enabled = betaBrowserFormInputConfig.enabled
            additionalProperties = betaBrowserFormInputConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserFormInputConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserFormInputConfig =
            BetaBrowserFormInputConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserFormInputConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserFormInputConfig &&
    ...
    override fun toString() =
        "BetaBrowserFormInputConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
