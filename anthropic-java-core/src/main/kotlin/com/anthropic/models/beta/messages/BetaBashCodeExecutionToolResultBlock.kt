...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitBetaBashCodeExecutionToolResultError(BetaBashCodeExecutionToolResultError betaBashCodeExecutionToolResultError) {
         *         return Optional.of(betaBashCodeExecutionToolResultError.toString());
         *     }
         *
         *     // ...
         *
