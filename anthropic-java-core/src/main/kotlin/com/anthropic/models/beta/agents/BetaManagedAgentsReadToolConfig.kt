...
private constructor(
    ...
    /** A builder for [BetaManagedAgentsReadToolConfig]. */
    class Builder internal constructor() {

        private var enabled: JsonField<Boolean>? = null
        private var name: JsonValue = JsonValue.from("read")
        private var permissionPolicy: JsonField<PermissionPolicy>? = null
        private var type: JsonValue = JsonValue.from("read")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(betaManagedAgentsReadToolConfig: BetaManagedAgentsReadToolConfig) =
            apply {
                enabled = betaManagedAgentsReadToolConfig.enabled
                name = betaManagedAgentsReadToolConfig.name
                permissionPolicy = betaManagedAgentsReadToolConfig.permissionPolicy
                type = betaManagedAgentsReadToolConfig.type
                additionalProperties =
                    betaManagedAgentsReadToolConfig.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BetaManagedAgentsReadToolConfig].
         *
         ...
         */
        fun build(): BetaManagedAgentsReadToolConfig =
            BetaManagedAgentsReadToolConfig(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsReadToolConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (enabled.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("read")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsReadToolConfig &&
    ...
    override fun toString() =
        "BetaManagedAgentsReadToolConfig{enabled=$enabled, name=$name, permissionPolicy=$permissionPolicy, type=$type, additionalProperties=$additionalProperties}"
}
