...
private constructor(
    ...
    fun toParam(): BetaBashCodeExecutionToolResultErrorParam =
        BetaBashCodeExecutionToolResultErrorParam.builder()
            .errorCode(
                _errorCode().map {
                    BetaBashCodeExecutionToolResultErrorParam.ErrorCode.of(it._value())
                }
            )
            .build()
    ...
    companion object {
        ...
        /**
         * Returns an immutable instance of [BetaBashCodeExecutionToolResultError] with the required
