...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            enabled = betaManagedAgentsSearchResultCitations.enabled
            additionalProperties =
                betaManagedAgentsSearchResultCitations.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): BetaManagedAgentsSearchResultCitations =
            BetaManagedAgentsSearchResultCitations(
     ...
     *   expected type.
     */
    fun validate(): BetaManagedAgentsSearchResultCitations = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaManagedAgentsSearchResultCitations &&
    ...
    override fun toString() =
        "BetaManagedAgentsSearchResultCitations{enabled=$enabled, additionalProperties=$additionalProperties}"
}
