...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BetaBrowserKeyConfig]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BetaBrowserKeyConfig]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaBrowserKeyConfig: BetaBrowserKeyConfig) = apply {
            deferLoading = betaBrowserKeyConfig.deferLoading
            enabled = betaBrowserKeyConfig.enabled
            additionalProperties = betaBrowserKeyConfig.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BetaBrowserKeyConfig].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BetaBrowserKeyConfig =
            BetaBrowserKeyConfig(deferLoading, enabled, additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): BetaBrowserKeyConfig = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BetaBrowserKeyConfig &&
    ...
    override fun toString() =
        "BetaBrowserKeyConfig{deferLoading=$deferLoading, enabled=$enabled, additionalProperties=$additionalProperties}"
}
