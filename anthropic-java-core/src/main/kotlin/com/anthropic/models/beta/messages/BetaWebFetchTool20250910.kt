...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(betaWebFetchTool20250910: BetaWebFetchTool20250910) = apply {
            ...
            urlSources = betaWebFetchTool20250910.urlSources
    ...
    override fun toString() =
        "BetaWebFetchTool20250910{name=$name, type=$type, allowedCallers=$allowedCallers, allowedDomains=$allowedDomains, blockedDomains=$blockedDomains, cacheControl=$cacheControl, citations=$citations, deferLoading=$deferLoading, maxContentTokens=$maxContentTokens, maxUses=$maxUses, strict=$strict, urlSources=$urlSources, additionalProperties=$additionalProperties}"
}
