...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(completionCreateParams: CompletionCreateParams) = apply {
            ...
            workspaceId = completionCreateParams.workspaceId
    ...
    override fun toString() =
        "CompletionCreateParams{betas=$betas, workspaceId=$workspaceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
